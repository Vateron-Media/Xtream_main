...
function loadCron() {
    ...
    if (defined('CACHE_TMP_PATH')) {
        ...
        foreach (array(STALKER_TMP_PATH, PLAYLIST_PATH, USER_TMP_PATH, MOVIES_IMAGES, CONS_TMP_PATH, CACHE_TMP_PATH, DIVERGENCE_TMP_PATH, STREAMS_TMP_PATH, SERIES_TMP_PATH, ENIGMA2_PLUGIN_DIR, FLOOD_TMP_PATH) as $rPath) {
