...
typedef int (*zend_encoding_lexer_compatibility_checker)(
...
typedef int (*zend_encoding_list_parser)(const char *encoding_list,
...
typedef int (*zend_encoding_internal_encoding_setter)(
    const zend_encoding *encoding);
...
ZEND_API size_t zend_multibyte_encoding_converter(
    ...
    const zend_encoding *encoding_from);
ZEND_API int zend_multibyte_parse_encoding_list(
    const char *encoding_list, size_t encoding_list_len,
    const zend_encoding ***return_list, size_t *return_size, int persistent);
