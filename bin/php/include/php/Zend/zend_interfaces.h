...
ZEND_API zval *zend_call_method(zval *object_pp, zend_class_entry *obj_ce,
                                ...
                                size_t function_name_len, zval *retval,
...
#define zend_call_method_with_1_params(obj, obj_ce, fn_proxy, function_name,   \
                                       retval, arg1)                           \
  zend_call_method(obj, obj_ce, fn_proxy, function_name,                       \
...
#define zend_call_method_with_2_params(obj, obj_ce, fn_proxy, function_name,   \
                                       retval, arg1, arg2)                     \
  zend_call_method(obj, obj_ce, fn_proxy, function_name,                       \
                   sizeof(function_name) - 1, retval, 2, arg1, arg2)
...
#define REGISTER_MAGIC_INTERFACE(class_name, class_name_str)                   \
  {                                                                            \
    ...
    zend_ce_##class_name->interface_gets_implemented =                         \
        zend_implement_##class_name;                                           \
  }
...
ZEND_API void zend_user_it_new_iterator(zend_class_entry *ce, zval *object,
                                        zval *iterator);
ZEND_API zend_object_iterator *
zend_user_it_get_new_iterator(zend_class_entry *ce, zval *object, int by_ref);
