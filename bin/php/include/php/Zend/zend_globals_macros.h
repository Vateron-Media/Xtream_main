...
#ifdef ZTS
#define CG(v)                                                                  \
  ZEND_TSRMG_FAST(compiler_globals_offset, zend_compiler_globals *, v)
#else
...
#ifdef ZTS
#define EG(v)                                                                  \
  ZEND_TSRMG_FAST(executor_globals_offset, zend_executor_globals *, v)
#else
...
#ifdef ZTS
#define LANG_SCNG(v)                                                           \
  ZEND_TSRMG_FAST(language_scanner_globals_offset, zend_php_scanner_globals *, \
                  v)
...
#ifdef ZTS
#define INI_SCNG(v)                                                            \
  ZEND_TSRMG_FAST(ini_scanner_globals_offset, zend_ini_scanner_globals *, v)
