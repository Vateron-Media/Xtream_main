...
static zend_always_inline size_t smart_str_alloc(smart_str *str, size_t len,
...
static zend_always_inline char *smart_str_extend_ex(smart_str *dest, size_t len,
                                                    zend_bool persistent) {
...
static zend_always_inline void smart_str_free_ex(smart_str *str,
                                                 zend_bool persistent) {
  if (str->s) {
...
static zend_always_inline void smart_str_appendc_ex(smart_str *dest, char ch,
                                                    zend_bool persistent) {
...
static zend_always_inline void smart_str_appendl_ex(smart_str *dest,
...
static zend_always_inline void smart_str_append_ex(smart_str *dest,
...
smart_str_append_smart_str_ex(smart_str *dest, const smart_str *src,
                              zend_bool persistent) {
...
static zend_always_inline void
smart_str_append_long_ex(smart_str *dest, zend_long num, zend_bool persistent) {
  char buf[32];
  char *result = zend_print_long_to_buf(buf + sizeof(buf) - 1, num);
  smart_str_appendl_ex(dest, result, buf + sizeof(buf) - 1 - result,
                       persistent);
}

static zend_always_inline void
smart_str_append_unsigned_ex(smart_str *dest, zend_ulong num,
                             zend_bool persistent) {
  char buf[32];
...
static zend_always_inline void smart_str_setl(smart_str *dest, const char *src,
                                              size_t len) {
  smart_str_free(dest);
