...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(1, ZEND_ADD, CONST | TMPVARCV,
                                 CONST | TMPVARCV) {
  USE_OPLINE
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(add_double) : result = EX_VAR(opline->result.var);
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(2, ZEND_SUB, CONST | TMPVARCV,
                                 CONST | TMPVARCV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2, *result;
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(sub_double) : result = EX_VAR(opline->result.var);
      ZVAL_DOUBLE(result, d1 - d2);
      ZEND_VM_NEXT_OPCODE();
    } else if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_LONG)) {
      d1 = Z_DVAL_P(op1);
...
ZEND_VM_COLD_CONSTCONST_HANDLER(3, ZEND_MUL, CONST | TMPVARCV, CONST | TMPVARCV,
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(mul_double) : result = EX_VAR(opline->result.var);
      ZVAL_DOUBLE(result, d1 * d2);
      ZEND_VM_NEXT_OPCODE();
    } else if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_LONG)) {
      d1 = Z_DVAL_P(op1);
...
ZEND_VM_COLD_CONSTCONST_HANDLER(4, ZEND_DIV, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(5, ZEND_MOD, CONST | TMPVARCV,
                                CONST | TMPVARCV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2, *result;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(6, ZEND_SL, CONST | TMPVARCV,
                                CONST | TMPVARCV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(7, ZEND_SR, CONST | TMPVARCV,
                                CONST | TMPVARCV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(12, ZEND_POW, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_HANDLER(8, ZEND_CONCAT, CONST | TMPVAR | CV, CONST | TMPVAR | CV,
  ...
  if ((OP1_TYPE == IS_CONST || EXPECTED(Z_TYPE_P(op1) == IS_STRING)) &&
    ...
    if (OP1_TYPE != IS_CONST && UNEXPECTED(ZSTR_LEN(op1_str) == 0)) {
      ...
      memcpy(ZSTR_VAL(str) + ZSTR_LEN(op1_str), ZSTR_VAL(op2_str),
             ZSTR_LEN(op2_str) + 1);
      ZVAL_NEW_STR(EX_VAR(opline->result.var), str);
      if (OP1_TYPE & (IS_TMP_VAR | IS_VAR)) {
        zend_string_release_ex(op1_str, 0);
...
ZEND_VM_COLD_CONSTCONST_HANDLER(16, ZEND_IS_IDENTICAL, CONST | TMP | VAR | CV,
                                CONST | TMP | VAR | CV, SPEC(COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
  zend_bool result;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(17, ZEND_IS_NOT_IDENTICAL,
...
ZEND_VM_COLD_CONSTCONST_HANDLER(18, ZEND_IS_EQUAL, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV,
                                SPEC(SMART_BRANCH, COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
  double d1, d2;
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_P(op2) == IS_LONG)) {
      if (EXPECTED(Z_LVAL_P(op1) == Z_LVAL_P(op2))) {
        ZEND_VM_C_LABEL(is_equal_true) : ZEND_VM_SMART_BRANCH_TRUE();
        ZVAL_TRUE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      } else {
        ZEND_VM_C_LABEL(is_equal_false) : ZEND_VM_SMART_BRANCH_FALSE();
        ZVAL_FALSE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      }
    ...
    if (EXPECTED(Z_TYPE_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(is_equal_double) : if (d1 == d2) {
...
ZEND_VM_COLD_CONSTCONST_HANDLER(19, ZEND_IS_NOT_EQUAL, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV,
                                SPEC(SMART_BRANCH, COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_P(op2) == IS_LONG)) {
      if (EXPECTED(Z_LVAL_P(op1) != Z_LVAL_P(op2))) {
        ZEND_VM_C_LABEL(is_not_equal_true) : ZEND_VM_SMART_BRANCH_TRUE();
        ZVAL_TRUE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      } else {
        ZEND_VM_C_LABEL(is_not_equal_false) : ZEND_VM_SMART_BRANCH_FALSE();
        ZVAL_FALSE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      }
    } else if (EXPECTED(Z_TYPE_P(op2) == IS_DOUBLE)) {
    ...
    if (EXPECTED(Z_TYPE_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(is_not_equal_double) : if (d1 != d2) {
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(20, ZEND_IS_SMALLER, CONST | TMPVARCV,
                                 CONST | TMPVARCV, SPEC(SMART_BRANCH)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
  double d1, d2;
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_LONG)) {
      if (EXPECTED(Z_LVAL_P(op1) < Z_LVAL_P(op2))) {
        ZEND_VM_C_LABEL(is_smaller_true) : ZEND_VM_SMART_BRANCH_TRUE();
        ZVAL_TRUE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      } else {
        ZEND_VM_C_LABEL(is_smaller_false) : ZEND_VM_SMART_BRANCH_FALSE();
        ZVAL_FALSE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      }
    } else if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(is_smaller_double) : if (d1 < d2) {
...
ZEND_VM_HELPER(zend_is_smaller_or_equal_helper, ANY, ANY, zval *op_1,
               zval *op_2) {
  USE_OPLINE
...
ZEND_VM_HOT_NOCONSTCONST_HANDLER(21, ZEND_IS_SMALLER_OR_EQUAL, CONST | TMPVARCV,
                                 CONST | TMPVARCV, SPEC(SMART_BRANCH)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
  ...
  if (ZEND_VM_SPEC && OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST) {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_LONG)) {
      if (EXPECTED(Z_LVAL_P(op1) <= Z_LVAL_P(op2))) {
        ZEND_VM_C_LABEL(is_smaller_or_equal_true) : ZEND_VM_SMART_BRANCH_TRUE();
        ZVAL_TRUE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      } else {
    ...
    if (EXPECTED(Z_TYPE_INFO_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(is_smaller_or_equal_double) : if (d1 <= d2) {
  ...
  ZEND_VM_DISPATCH_TO_HELPER(zend_is_smaller_or_equal_helper, op_1, op1, op_2,
                             op2);
}

ZEND_VM_COLD_CONSTCONST_HANDLER(170, ZEND_SPACESHIP, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(9, ZEND_BW_OR, CONST | TMPVARCV,
                                CONST | TMPVARCV, SPEC(COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(10, ZEND_BW_AND, CONST | TMPVARCV,
                                CONST | TMPVARCV, SPEC(COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(11, ZEND_BW_XOR, CONST | TMPVARCV,
                                CONST | TMPVARCV, SPEC(COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(15, ZEND_BOOL_XOR, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV, SPEC(COMMUTATIVE)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_HANDLER(28, ZEND_ASSIGN_OBJ_OP, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, OP) {
  USE_OPLINE
  ...
  do {
    ...
    ZEND_VM_C_LABEL(assign_op_object)
        : /* here we are sure we are dealing with an object */
          cache_slot =
              (OP2_TYPE == IS_CONST) ? CACHE_ADDR((opline + 1)->extended_value)
                                     : NULL;
    if (EXPECTED((zptr = Z_OBJ_HT_P(object)->get_property_ptr_ptr(
                      object, property, BP_VAR_RW, cache_slot)) != NULL)) {
        ...
        do {
          if (UNEXPECTED(Z_ISREF_P(zptr))) {
            ...
            if (UNEXPECTED(ZEND_REF_HAS_TYPE_SOURCES(ref))) {
              zend_binary_assign_op_typed_ref(ref,
                                              value OPLINE_CC EXECUTE_DATA_CC);
              break;
            }
          }
          ...
          if (OP2_TYPE == IS_CONST) {
            ...
            prop_info = zend_object_fetch_property_type_info(Z_OBJ_P(object),
                                                             orig_zptr);
          }
          if (UNEXPECTED(prop_info)) {
            /* special case for typed properties */
            zend_binary_assign_op_typed_prop(prop_info, zptr,
                                             value OPLINE_CC EXECUTE_DATA_CC);
          } else {
      ...
      zend_assign_op_overloaded_property(object, property, cache_slot,
                                         value OPLINE_CC EXECUTE_DATA_CC);
    }
  } while (0);
...
ZEND_VM_HANDLER(29, ZEND_ASSIGN_STATIC_PROP_OP, ANY, ANY, OP) {
  /* This helper actually never will receive IS_VAR as second op, and has the
   * same handling for VAR and TMP in the first op, but for interoperability
   * with the other binary_assign_op helpers, it is necessary to "include" it */
  ...
  if (UNEXPECTED(zend_fetch_static_property_address(
                     &prop, &prop_info, (opline + 1)->extended_value, BP_VAR_RW,
                     0 OPLINE_CC EXECUTE_DATA_CC) != SUCCESS)) {
  ...
  do {
    ...
    if (UNEXPECTED(prop_info->type)) {
      /* special case for typed properties */
      zend_binary_assign_op_typed_prop(prop_info, prop,
                                       value OPLINE_CC EXECUTE_DATA_CC);
    } else {
...
ZEND_VM_HANDLER(27, ZEND_ASSIGN_DIM_OP, VAR | CV,
                CONST | TMPVAR | UNUSED | NEXT | CV, OP) {
  USE_OPLINE
  ...
  if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
    ZEND_VM_C_LABEL(assign_dim_op_array) : SEPARATE_ARRAY(container);
    ZEND_VM_C_LABEL(assign_dim_op_new_array)
        : dim = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
    if (OP2_TYPE == IS_UNUSED) {
      var_ptr = zend_hash_next_index_insert(Z_ARRVAL_P(container),
      ...
      if (OP2_TYPE == IS_CONST) {
        var_ptr = zend_fetch_dimension_address_inner_RW_CONST(
            Z_ARRVAL_P(container), dim EXECUTE_DATA_CC);
      } else {
        var_ptr = zend_fetch_dimension_address_inner_RW(Z_ARRVAL_P(container),
                                                        dim EXECUTE_DATA_CC);
      }
      if (UNEXPECTED(!var_ptr)) {
        ZEND_VM_C_GOTO(assign_dim_op_ret_null);
    ...
    if (EXPECTED(Z_TYPE_P(container) == IS_OBJECT)) {
      ...
      if (OP1_TYPE == IS_CV &&
          UNEXPECTED(Z_TYPE_INFO_P(container) == IS_UNDEF)) {
        ZVAL_UNDEFINED_OP1();
      }
      ...
      ZEND_VM_C_LABEL(assign_dim_op_ret_null) : FREE_UNFETCHED_OP_DATA();
      if (UNEXPECTED(RETURN_VALUE_USED(opline))) {
        ZVAL_NULL(EX_VAR(opline->result.var));
      }
    }
...
ZEND_VM_HANDLER(132, ZEND_PRE_INC_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *object;
  zval *property;
  ...
  do {
    ...
    ZEND_VM_C_LABEL(pre_incdec_object)
        : /* here we are sure we are dealing with an object */
          cache_slot =
              (OP2_TYPE == IS_CONST) ? CACHE_ADDR(opline->extended_value)
                                     : NULL;
    if (EXPECTED((zptr = Z_OBJ_HT_P(object)->get_property_ptr_ptr(
                      object, property, BP_VAR_RW, cache_slot)) != NULL)) {
      if (UNEXPECTED(Z_ISERROR_P(zptr))) {
        ...
        if (OP2_TYPE == IS_CONST) {
          ...
          prop_info =
              zend_object_fetch_property_type_info(Z_OBJ_P(object), zptr);
        }
        zend_pre_incdec_property_zval(zptr,
                                      prop_info OPLINE_CC EXECUTE_DATA_CC);
      }
    } else {
      zend_pre_incdec_overloaded_property(object, property,
                                          cache_slot OPLINE_CC EXECUTE_DATA_CC);
    }
  } while (0);
...
ZEND_VM_HANDLER(133, ZEND_PRE_DEC_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  ZEND_VM_DISPATCH_TO_HANDLER(ZEND_PRE_INC_OBJ);
}

ZEND_VM_HANDLER(134, ZEND_POST_INC_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *object;
  ...
  do {
    ...
    if (EXPECTED((zptr = Z_OBJ_HT_P(object)->get_property_ptr_ptr(
      ...
      zend_post_incdec_overloaded_property(
          object, property, cache_slot OPLINE_CC EXECUTE_DATA_CC);
    }
  } while (0);
...
ZEND_VM_HANDLER(135, ZEND_POST_DEC_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
...
ZEND_VM_HANDLER(38, ZEND_PRE_INC_STATIC_PROP, ANY, ANY, CACHE_SLOT) {
  ...
  if (zend_fetch_static_property_address(
          &prop, &prop_info, opline->extended_value, BP_VAR_RW,
          0 OPLINE_CC EXECUTE_DATA_CC) != SUCCESS) {
    UNDEF_RESULT();
    HANDLE_EXCEPTION();
  }

  zend_pre_incdec_property_zval(
      prop, prop_info->type ? prop_info : NULL OPLINE_CC EXECUTE_DATA_CC);
...
ZEND_VM_HANDLER(40, ZEND_POST_INC_STATIC_PROP, ANY, ANY, CACHE_SLOT) {
  ...
  zend_post_incdec_property_zval(
      prop, prop_info->type ? prop_info : NULL OPLINE_CC EXECUTE_DATA_CC);
...
ZEND_VM_HELPER(zend_post_inc_helper, VAR | CV, ANY) {
  ...
  do {
    if (UNEXPECTED(Z_TYPE_P(var_ptr) == IS_REFERENCE)) {
      ...
      if (UNEXPECTED(ZEND_REF_HAS_TYPE_SOURCES(ref))) {
        zend_incdec_typed_ref(ref, EX_VAR(opline->result.var)
...
ZEND_VM_HELPER(zend_fetch_var_address_helper, CONST | TMPVAR | CV, UNUSED,
               int type) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *varname;
  ...
  target_symbol_table =
      zend_get_target_symbol_table(opline->extended_value EXECUTE_DATA_CC);
  ...
  if (retval == NULL) {
    ...
    if (type == BP_VAR_W) {
      retval =
          zend_hash_add_new(target_symbol_table, name, &EG(uninitialized_zval));
    } else if (type == BP_VAR_IS) {
      retval = &EG(uninitialized_zval);
    } else {
      zend_error(E_NOTICE, "Undefined variable: %s", ZSTR_VAL(name));
      if (type == BP_VAR_RW) {
        retval = zend_hash_update(target_symbol_table, name,
                                  &EG(uninitialized_zval));
      } else {
        retval = &EG(uninitialized_zval);
      }
...
ZEND_VM_HELPER(zend_fetch_static_prop_helper, ANY, ANY, int type) {
  ...
  if (UNEXPECTED(
          zend_fetch_static_property_address(
              &prop, NULL, opline->extended_value & ~ZEND_FETCH_OBJ_FLAGS, type,
              opline->extended_value &
                  ZEND_FETCH_OBJ_FLAGS OPLINE_CC EXECUTE_DATA_CC) != SUCCESS)) {
...
/* No specialization for op_types (CONST|TMPVAR|CV,
...
/* No specialization for op_types (CONST|TMPVAR|CV,
 * UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(174, ZEND_FETCH_STATIC_PROP_W, ANY, CLASS_FETCH,
                FETCH_REF | DIM_OBJ_WRITE | CACHE_SLOT) {
...
/* No specialization for op_types (CONST|TMPVAR|CV,
 * UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(177, ZEND_FETCH_STATIC_PROP_FUNC_ARG, ANY, CLASS_FETCH,
...
/* No specialization for op_types (CONST|TMPVAR|CV,
 * UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(178, ZEND_FETCH_STATIC_PROP_UNSET, ANY, CLASS_FETCH,
                CACHE_SLOT) {
...
ZEND_VM_COLD_CONSTCONST_HANDLER(81, ZEND_FETCH_DIM_R, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
    ...
    if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
      ZEND_VM_C_LABEL(fetch_dim_r_array)
          : value = zend_fetch_dimension_address_inner(
                Z_ARRVAL_P(container), dim, OP2_TYPE, BP_VAR_R EXECUTE_DATA_CC);
      ...
      zend_fetch_dimension_address_read_R_slow(container,
                                               dim OPLINE_CC EXECUTE_DATA_CC);
    }
  } else {
    zend_fetch_dimension_address_read_R(container, dim,
                                        OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  }
  FREE_OP2();
  FREE_OP1();
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
...
ZEND_VM_HANDLER(84, ZEND_FETCH_DIM_W, VAR | CV,
  ...
  zend_fetch_dimension_address_W(container, GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R),
                                 OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
...
ZEND_VM_HANDLER(87, ZEND_FETCH_DIM_RW, VAR | CV,
                CONST | TMPVAR | UNUSED | NEXT | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *container;
  ...
  zend_fetch_dimension_address_RW(container, GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R),
                                  OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
    zval *result = EX_VAR(opline->result.var);
...
ZEND_VM_COLD_CONSTCONST_HANDLER(90, ZEND_FETCH_DIM_IS, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *container;
  ...
  zend_fetch_dimension_address_read_IS(container,
...
ZEND_VM_COLD_CONSTCONST_HANDLER(93, ZEND_FETCH_DIM_FUNC_ARG,
                                CONST | TMP | VAR | CV,
                                CONST | TMPVAR | UNUSED | NEXT | CV) {
#if !ZEND_VM_SPEC
  USE_OPLINE
...
ZEND_VM_HANDLER(96, ZEND_FETCH_DIM_UNSET, VAR | CV, CONST | TMPVAR | CV) {
  ...
  zend_fetch_dimension_address_UNSET(container,
                                     GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R),
                                     OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
...
ZEND_VM_HOT_OBJ_HANDLER(82, ZEND_FETCH_OBJ_R,
    ...
    if (OP2_TYPE == IS_CONST) {
      cache_slot =
          CACHE_ADDR(opline->extended_value &
                     ~ZEND_FETCH_REF /* FUNC_ARG fetch may contain it */);
        ...
        if (EXPECTED(IS_VALID_PROPERTY_OFFSET(prop_offset))) {
              ...
              if (EXPECTED(Z_TYPE(p->val) != IS_UNDEF) &&
                  (EXPECTED(p->key == Z_STR_P(offset)) ||
                   (EXPECTED(p->h == ZSTR_H(Z_STR_P(offset))) &&
                    EXPECTED(p->key != NULL) &&
                    EXPECTED(
                        zend_string_equal_content(p->key, Z_STR_P(offset)))))) {
                retval = &p->val;
                if (!ZEND_VM_SPEC || (OP1_TYPE & (IS_TMP_VAR | IS_VAR)) != 0) {
                  ZEND_VM_C_GOTO(fetch_obj_r_copy);
                } else {
          ...
          if (EXPECTED(retval)) {
            ...
            CACHE_PTR_EX(cache_slot + 1,
                         (void *)ZEND_ENCODE_DYN_PROP_OFFSET(idx));
            if (!ZEND_VM_SPEC || (OP1_TYPE & (IS_TMP_VAR | IS_VAR)) != 0) {
              ZEND_VM_C_GOTO(fetch_obj_r_copy);
            } else {
              ZEND_VM_C_GOTO(fetch_obj_r_fast_copy);
               ...
               UNEXPECTED(Z_TYPE_INFO_P(offset) == IS_UNDEF)) {
      ZVAL_UNDEFINED_OP2();
    }

    retval = zobj->handlers->read_property(
        container, offset, BP_VAR_R, cache_slot, EX_VAR(opline->result.var));
  ...
  ZEND_VM_C_LABEL(fetch_obj_r_finish) : FREE_OP2();
  FREE_OP1();
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
}

ZEND_VM_HANDLER(85, ZEND_FETCH_OBJ_W, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, FETCH_REF | DIM_OBJ_WRITE | CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  ...
  zend_fetch_property_address(
      ...
      ((OP2_TYPE == IS_CONST)
           ? CACHE_ADDR(opline->extended_value & ~ZEND_FETCH_OBJ_FLAGS)
           : NULL),
      BP_VAR_W, opline->extended_value & ZEND_FETCH_OBJ_FLAGS,
      1 OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
    FREE_VAR_PTR_AND_EXTRACT_RESULT_IF_NECESSARY(free_op1, result);
  }
...
ZEND_VM_HANDLER(88, ZEND_FETCH_OBJ_RW, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *property, *container, *result;
  ...
  zend_fetch_property_address(
      result, container, OP1_TYPE, property, OP2_TYPE,
      ((OP2_TYPE == IS_CONST) ? CACHE_ADDR(opline->extended_value) : NULL),
      BP_VAR_RW, 0, 1 OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
    FREE_VAR_PTR_AND_EXTRACT_RESULT_IF_NECESSARY(free_op1, result);
  }
...
ZEND_VM_COLD_CONST_HANDLER(91, ZEND_FETCH_OBJ_IS,
                           CONST | TMPVAR | UNUSED | THIS | CV,
                           CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1;
  ...
  do {
    ...
    retval = zobj->handlers->read_property(
        container, offset, BP_VAR_IS, cache_slot, EX_VAR(opline->result.var));
  ...
  ZEND_VM_C_LABEL(fetch_obj_is_finish) : FREE_OP2();
  FREE_OP1();
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
}
...
ZEND_VM_COLD_CONST_HANDLER(94, ZEND_FETCH_OBJ_FUNC_ARG,
                           ...
                           CONST | TMPVAR | CV, FETCH_REF | CACHE_SLOT) {
#if !ZEND_VM_SPEC
  USE_OPLINE
#endif
...
ZEND_VM_HANDLER(97, ZEND_FETCH_OBJ_UNSET, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  ...
  zend_fetch_property_address(
      result, container, OP1_TYPE, property, OP2_TYPE,
      ((OP2_TYPE == IS_CONST) ? CACHE_ADDR(opline->extended_value) : NULL),
      BP_VAR_UNSET, 0, 1 OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  if (OP1_TYPE == IS_VAR) {
    FREE_VAR_PTR_AND_EXTRACT_RESULT_IF_NECESSARY(free_op1, result);
  }
...
ZEND_VM_HANDLER(98, ZEND_FETCH_LIST_R, CONST | TMPVARCV, CONST | TMPVAR | CV) {
  ...
  SAVE_OPLINE();
  container = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
  zend_fetch_dimension_address_LIST_r(container,
                                      GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R),
                                      OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  FREE_OP2();
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
...
ZEND_VM_HANDLER(155, ZEND_FETCH_LIST_W, VAR, CONST | TMPVAR | CV) {
  ...
  if (OP1_TYPE == IS_VAR && Z_TYPE_P(EX_VAR(opline->op1.var)) != IS_INDIRECT &&
      UNEXPECTED(!Z_ISREF_P(container))) {
    zend_error(E_NOTICE,
               "Attempting to set reference to non referenceable value");
    zend_fetch_dimension_address_LIST_r(container, dim,
                                        OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  } else {
    zend_fetch_dimension_address_W(container, dim,
                                   OP2_TYPE OPLINE_CC EXECUTE_DATA_CC);
  }
...
ZEND_VM_HANDLER(24, ZEND_ASSIGN_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT,
                SPEC(OP_DATA = CONST | TMP | VAR | CV)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2, free_op_data;
  ...
  ZEND_VM_C_LABEL(assign_object)
    ...
    if (EXPECTED(IS_VALID_PROPERTY_OFFSET(prop_offset))) {
      ...
      if (Z_TYPE_P(property_val) != IS_UNDEF) {
        zend_property_info *prop_info =
            (zend_property_info *)CACHED_PTR_EX(cache_slot + 2);

        if (UNEXPECTED(prop_info != NULL)) {
          value = zend_assign_to_typed_prop(prop_info, property_val,
                                            value EXECUTE_DATA_CC);
          ZEND_VM_C_GOTO(free_and_exit_assign_obj);
        } else {
          ZEND_VM_C_LABEL(fast_assign_obj)
              : value = zend_assign_to_variable(
                    property_val, value, OP_DATA_TYPE, EX_USES_STRICT_TYPES());
          if (UNEXPECTED(RETURN_VALUE_USED(opline))) {
      ...
      if (EXPECTED(zobj->properties != NULL)) {
        ...
        property_val =
            zend_hash_find_ex(zobj->properties, Z_STR_P(property), 1);
        if (property_val) {
  ...
  value = Z_OBJ_HT_P(object)->write_property(
  ...
  FREE_OP_DATA();
  ZEND_VM_C_LABEL(exit_assign_obj) : FREE_OP2();
  FREE_OP1_VAR_PTR();
  /* assign_obj has two opcodes! */
  ZEND_VM_NEXT_OPCODE_EX(1, 2);
}
...
/* No specialization for op_types (CONST|TMPVAR|CV, UNUSED|CONST|VAR) */
ZEND_VM_HANDLER(25, ZEND_ASSIGN_STATIC_PROP, ANY, ANY, CACHE_SLOT,
                SPEC(OP_DATA = CONST | TMP | VAR | CV)) {
  USE_OPLINE
  zend_free_op free_op_data;
  zval *prop, *value;
  ...
  if (zend_fetch_static_property_address(
          &prop, &prop_info, opline->extended_value, BP_VAR_W,
          0 OPLINE_CC EXECUTE_DATA_CC) != SUCCESS) {
    FREE_UNFETCHED_OP_DATA();
    UNDEF_RESULT();
    HANDLE_EXCEPTION();
  ...
  if (UNEXPECTED(prop_info->type)) {
    ...
    value = zend_assign_to_variable(prop, value, OP_DATA_TYPE,
...
ZEND_VM_HANDLER(23, ZEND_ASSIGN_DIM, VAR | CV,
                CONST | TMPVAR | UNUSED | NEXT | CV,
                SPEC(OP_DATA = CONST | TMP | VAR | CV)) {
  USE_OPLINE
  zend_free_op free_op1;
  ...
  if (EXPECTED(Z_TYPE_P(object_ptr) == IS_ARRAY)) {
    ...
    if (OP2_TYPE == IS_UNUSED) {
      ...
      dim = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
      if (OP2_TYPE == IS_CONST) {
        variable_ptr = zend_fetch_dimension_address_inner_W_CONST(
            Z_ARRVAL_P(object_ptr), dim EXECUTE_DATA_CC);
      } else {
        variable_ptr = zend_fetch_dimension_address_inner_W(
            Z_ARRVAL_P(object_ptr), dim EXECUTE_DATA_CC);
      }
      if (UNEXPECTED(variable_ptr == NULL)) {
        ZEND_VM_C_GOTO(assign_dim_error);
    ...
    if (EXPECTED(Z_TYPE_P(object_ptr) == IS_OBJECT)) {
      ...
      zend_assign_to_object_dim(object_ptr, dim,
                                value OPLINE_CC EXECUTE_DATA_CC);
      ...
      if (OP2_TYPE == IS_UNUSED) {
        ...
        dim = GET_OP2_ZVAL_PTR(BP_VAR_R);
        value = GET_OP_DATA_ZVAL_PTR_DEREF(BP_VAR_R);
        zend_assign_to_string_offset(object_ptr, dim,
                                     value OPLINE_CC EXECUTE_DATA_CC);
        FREE_OP_DATA();
      }
      ...
      dim = GET_OP2_ZVAL_PTR(BP_VAR_R);
      ZEND_VM_C_LABEL(assign_dim_error) : FREE_UNFETCHED_OP_DATA();
      if (UNEXPECTED(RETURN_VALUE_USED(opline))) {
        ZVAL_NULL(EX_VAR(opline->result.var));
      }
    }
...
ZEND_VM_HANDLER(22, ZEND_ASSIGN, VAR | CV, CONST | TMP | VAR | CV,
                SPEC(RETVAL)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *value;
...
ZEND_VM_HANDLER(30, ZEND_ASSIGN_REF, VAR | CV, VAR | CV, SRC) {
  ...
  if (OP1_TYPE == IS_VAR && UNEXPECTED(Z_ISERROR_P(variable_ptr))) {
    ...
    zend_throw_error(
        NULL, "Cannot assign by reference to an array dimension of an object");
    variable_ptr = &EG(uninitialized_zval);
...
ZEND_VM_HANDLER(32, ZEND_ASSIGN_OBJ_REF, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT | SRC,
                SPEC(OP_DATA = VAR | CV)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2, free_op_data;
    ...
    if (OP1_TYPE == IS_UNUSED) {
      if (OP2_TYPE == IS_CONST) {
        zend_assign_to_property_reference_this_const(
            container, property, value_ptr OPLINE_CC EXECUTE_DATA_CC);
      } else {
        zend_assign_to_property_reference_this_var(
            container, property, value_ptr OPLINE_CC EXECUTE_DATA_CC);
      }
    } else {
      if (OP2_TYPE == IS_CONST) {
        ...
        zend_assign_to_property_reference_var_var(
            container, property, value_ptr OPLINE_CC EXECUTE_DATA_CC);
      }
    }
  } else {
    zend_assign_to_property_reference(container, OP1_TYPE, property, OP2_TYPE,
                                      value_ptr OPLINE_CC EXECUTE_DATA_CC);
  }
...
ZEND_VM_HANDLER(33, ZEND_ASSIGN_STATIC_PROP_REF, ANY, ANY, CACHE_SLOT | SRC) {
  ...
  if (zend_fetch_static_property_address(
          &prop, &prop_info, opline->extended_value & ~ZEND_RETURNS_FUNCTION,
          BP_VAR_W, 0 OPLINE_CC EXECUTE_DATA_CC) != SUCCESS) {
    FREE_UNFETCHED_OP_DATA();
    UNDEF_RESULT();
    HANDLE_EXCEPTION();
  }
  ...
  if (OP_DATA_TYPE == IS_VAR && UNEXPECTED(Z_ISERROR_P(value_ptr))) {
    ...
    if (UNEXPECTED(!zend_wrong_assign_to_variable_reference(
            prop, value_ptr OPLINE_CC EXECUTE_DATA_CC))) {
      prop = &EG(uninitialized_zval);
    }
  } else if (UNEXPECTED(prop_info->type)) {
    prop = zend_assign_to_typed_property_reference(prop_info, prop,
                                                   value_ptr EXECUTE_DATA_CC);
  } else {
...
ZEND_VM_HOT_HELPER(zend_leave_helper, ANY, ANY) {
  ...
  if (EXPECTED((call_info &
                (ZEND_CALL_CODE | ZEND_CALL_TOP | ZEND_CALL_HAS_SYMBOL_TABLE |
                 ZEND_CALL_FREE_EXTRA_ARGS | ZEND_CALL_ALLOCATED)) == 0)) {
    ...
    } else /* if (call_kind == ZEND_CALL_TOP_CODE) */
    {
      ...
      while (old_execute_data) {
        if (old_execute_data->func &&
            (ZEND_CALL_INFO(old_execute_data) & ZEND_CALL_HAS_SYMBOL_TABLE)) {
...
ZEND_VM_COLD_CONSTCONST_HANDLER(53, ZEND_FAST_CONCAT, CONST | TMPVAR | CV,
                                CONST | TMPVAR | CV) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op1, *op2;
...
ZEND_VM_HANDLER(109, ZEND_FETCH_CLASS, UNUSED | CLASS_FETCH,
                CONST | TMPVAR | UNUSED | CV, CACHE_SLOT) {
  zend_free_op free_op2;
  zval *class_name;
  USE_OPLINE
  ...
  if (OP2_TYPE == IS_UNUSED) {
    ...
    if (UNEXPECTED(ce == NULL)) {
      ...
      ce = zend_fetch_class_by_name(Z_STR_P(class_name),
                                    Z_STR_P(class_name + 1), opline->op1.num);
      CACHE_PTR(opline->extended_value, ce);
    }
    Z_CE_P(EX_VAR(opline->result.var)) = ce;
  } else {
    class_name = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
    ZEND_VM_C_LABEL(try_class_name) : if (Z_TYPE_P(class_name) == IS_OBJECT) {
      Z_CE_P(EX_VAR(opline->result.var)) = Z_OBJCE_P(class_name);
    }
    else if (Z_TYPE_P(class_name) == IS_STRING) {
      Z_CE_P(EX_VAR(opline->result.var)) =
          zend_fetch_class(Z_STR_P(class_name), opline->op1.num);
    }
    else if ((OP2_TYPE & (IS_VAR | IS_CV)) &&
             Z_TYPE_P(class_name) == IS_REFERENCE) {
...
ZEND_VM_HOT_OBJ_HANDLER(112, ZEND_INIT_METHOD_CALL,
                        CONST | TMPVAR | UNUSED | THIS | CV,
                        CONST | TMPVAR | CV, NUM | CACHE_SLOT) {
  USE_OPLINE
  zval *function_name;
  zend_free_op free_op1, free_op2;
  zval *object;
      ...
      if ((OP2_TYPE & (IS_VAR | IS_CV)) && Z_ISREF_P(function_name)) {
        ...
        if (EXPECTED(Z_TYPE_P(function_name) == IS_STRING)) {
          break;
                 ...
                 UNEXPECTED(Z_TYPE_P(function_name) == IS_UNDEF)) {
        ZVAL_UNDEFINED_OP2();
        if (UNEXPECTED(EG(exception) != NULL)) {
          FREE_OP1();
          HANDLE_EXCEPTION();
  ...
  if (OP2_TYPE == IS_CONST &&
    ...
    fbc = obj->handlers->get_method(
        &obj, Z_STR_P(function_name),
        ((OP2_TYPE == IS_CONST) ? (RT_CONSTANT(opline, opline->op2) + 1)
                                : NULL));
    ...
    if (OP2_TYPE == IS_CONST && EXPECTED(fbc->type <= ZEND_USER_FUNCTION) &&
        EXPECTED(!(fbc->common.fn_flags &
                   (ZEND_ACC_CALL_VIA_TRAMPOLINE | ZEND_ACC_NEVER_CACHE))) &&
    ...
    if (EXPECTED(fbc->type == ZEND_USER_FUNCTION) &&
        UNEXPECTED(!RUN_TIME_CACHE(&fbc->op_array))) {
  ...
  call = zend_vm_stack_push_call_frame(call_info, fbc, opline->extended_value,
                                       obj);
...
ZEND_VM_HANDLER(113, ZEND_INIT_STATIC_METHOD_CALL,
                UNUSED | CLASS_FETCH | CONST | VAR,
                CONST | TMPVAR | UNUSED | CONSTRUCTOR | CV, NUM | CACHE_SLOT) {
  USE_OPLINE
  zval *function_name;
  zend_class_entry *ce;
  uint32_t call_info;
  ...
  if (OP1_TYPE == IS_CONST && OP2_TYPE == IS_CONST &&
      EXPECTED((fbc = CACHED_PTR(opline->result.num + sizeof(void *))) !=
               NULL)) {
    /* nothing to do */
  } else if (OP1_TYPE != IS_CONST && OP2_TYPE == IS_CONST &&
  ...
  call =
      zend_vm_stack_push_call_frame(call_info, fbc, opline->extended_value, ce);
  call->prev_execute_data = EX(call);
  EX(call) = call;
...
ZEND_VM_HOT_HANDLER(59, ZEND_INIT_FCALL_BY_NAME, ANY, CONST, NUM | CACHE_SLOT) {
  ...
  call = _zend_vm_stack_push_call_frame(ZEND_CALL_NESTED_FUNCTION, fbc,
...
ZEND_VM_HANDLER(128, ZEND_INIT_DYNAMIC_CALL, ANY, CONST | TMPVAR | CV, NUM) {
  ...
  ZEND_VM_C_LABEL(try_function_name)
      : if (OP2_TYPE != IS_CONST &&
            EXPECTED(Z_TYPE_P(function_name) == IS_STRING)) {
    call = zend_init_dynamic_call_string(Z_STR_P(function_name),
                                         opline->extended_value);
  }
  else if (OP2_TYPE != IS_CONST &&
    ...
    call = zend_init_dynamic_call_array(Z_ARRVAL_P(function_name),
                                        opline->extended_value);
  }
  else if ((OP2_TYPE & (IS_VAR | IS_CV)) &&
           EXPECTED(Z_TYPE_P(function_name) == IS_REFERENCE)) {
    function_name = Z_REFVAL_P(function_name);
...
ZEND_VM_HANDLER(118, ZEND_INIT_USER_CALL, CONST, CONST | TMPVAR | CV, NUM) {
  ...
  if (zend_is_callable_ex(function_name, NULL, 0, NULL, &fcc, &error)) {
    ...
    if (EXPECTED(func->type == ZEND_USER_FUNCTION) &&
        UNEXPECTED(!RUN_TIME_CACHE(&func->op_array))) {
      init_func_run_time_cache(&func->op_array);
    }
  } else {
    zend_internal_type_error(
        EX_USES_STRICT_TYPES(),
        "%s() expects parameter 1 to be a valid callback, %s",
        Z_STRVAL_P(RT_CONSTANT(opline, opline->op1)), error);
    efree(error);
    FREE_OP2();
    if (UNEXPECTED(EG(exception))) {
      HANDLE_EXCEPTION();
  ...
  call = zend_vm_stack_push_call_frame(call_info, func, opline->extended_value,
...
ZEND_VM_HOT_HANDLER(61, ZEND_INIT_FCALL, NUM, CONST, NUM | CACHE_SLOT) {
  ...
  call = _zend_vm_stack_push_call_frame_ex(opline->op1.num,
                                           ZEND_CALL_NESTED_FUNCTION, fbc,
                                           opline->extended_value, NULL);
  call->prev_execute_data = EX(call);
  EX(call) = call;
...
ZEND_VM_HOT_HANDLER(131, ZEND_DO_FCALL_BY_NAME, ANY, ANY, SPEC(RETVAL)) {
  ...
  if (EXPECTED(fbc->type == ZEND_USER_FUNCTION)) {
    ...
    ZEND_VM_C_LABEL(fcall_by_name_end) : zend_vm_stack_free_args(call);
    zend_vm_stack_free_call_frame(call);
...
ZEND_VM_HOT_HANDLER(60, ZEND_DO_FCALL, ANY, ANY, SPEC(RETVAL)) {
  ...
  if (UNEXPECTED((fbc->common.fn_flags &
    ...
    if (UNEXPECTED((fbc->common.fn_flags & ZEND_ACC_ABSTRACT) != 0)) {
      ...
      ZEND_VM_C_LABEL(fcall_except) : UNDEF_RESULT();
      if (!RETURN_VALUE_USED(opline)) {
        ret = &retval;
        ZVAL_UNDEF(ret);
      }
  ...
  if (EXPECTED(fbc->type == ZEND_USER_FUNCTION)) {
    ...
    ZEND_VM_C_LABEL(fcall_end) : zend_vm_stack_free_args(call);
    if (!RETURN_VALUE_USED(opline)) {
      i_zval_ptr_dtor(ret);
    }
...
ZEND_VM_COLD_CONST_HANDLER(124, ZEND_VERIFY_RETURN_TYPE,
...
/* prevents "undefined variable opline" errors */
    ...
    if (UNEXPECTED(!ZEND_TYPE_IS_CLASS(ret_info->type) &&
                   ...
                   !ZEND_SAME_FAKE_TYPE(ZEND_TYPE_CODE(ret_info->type),
                                        Z_TYPE_P(retval_ptr)) &&
...
ZEND_VM_COLD_CONST_HANDLER(111, ZEND_RETURN_BY_REF, CONST | TMP | VAR | CV, ANY,
                           SRC) {
  USE_OPLINE
  zval *retval_ptr;
  zend_free_op free_op1;
...
ZEND_VM_HANDLER(139, ZEND_GENERATOR_CREATE, ANY, ANY) {
  ...
  if (EXPECTED(return_value)) {
    ...
    if (EXPECTED(num_args <= EX(func)->op_array.num_args)) {
      used_stack = (ZEND_CALL_FRAME_SLOT + EX(func)->op_array.last_var +
                    EX(func)->op_array.T) *
                   sizeof(zval);
      gen_execute_data = (zend_execute_data *)emalloc(used_stack);
      used_stack =
          (ZEND_CALL_FRAME_SLOT + EX(func)->op_array.last_var) * sizeof(zval);
    } else {
      used_stack =
          (ZEND_CALL_FRAME_SLOT + num_args + EX(func)->op_array.last_var +
           EX(func)->op_array.T - EX(func)->op_array.num_args) *
          sizeof(zval);
      gen_execute_data = (zend_execute_data *)emalloc(used_stack);
    }
...
ZEND_VM_HANDLER(107, ZEND_CATCH, CONST, JMP_ADDR, LAST_CATCH | CACHE_SLOT) {
  ...
  {
    /* Always perform a strict assignment. There is a reasonable expectation
     * that if you write "catch (Exception $e)" then $e will actually be
     * instanceof Exception. As such, we should not permit coercion to string
     * here. */
    zval tmp;
...
ZEND_VM_HOT_SEND_HANDLER(116, ZEND_SEND_VAL_EX, CONST | TMP, NUM,
                         SPEC(QUICK_ARG)) {
  USE_OPLINE
  zval *value, *arg;
  zend_free_op free_op1;
...
ZEND_VM_HOT_SEND_HANDLER(50, ZEND_SEND_VAR_NO_REF_EX, VAR, NUM,
                         SPEC(QUICK_ARG)) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *varptr, *arg;
...
ZEND_VM_HANDLER(165, ZEND_SEND_UNPACK, ANY, ANY) {
  ...
  ZEND_VM_C_LABEL(send_again) : if (EXPECTED(Z_TYPE_P(args) == IS_ARRAY)) {
    HashTable *ht = Z_ARRVAL_P(args);
    zval *arg, *top;
    zend_string *name;

    zend_vm_stack_extend_call_frame(&EX(call), arg_num - 1,
        ...
        if (ARG_MUST_BE_SENT_BY_REF(EX(call)->func, arg_num)) {
          zend_error(E_WARNING,
                     ...
                     EX(call)->func->common.scope
                         ? ZSTR_VAL(EX(call)->func->common.scope->name)
                         : "",
                     EX(call)->func->common.scope ? "::" : "",
...
ZEND_VM_HANDLER(119, ZEND_SEND_ARRAY, ANY, ANY, NUM) {
  ...
  if (UNEXPECTED(Z_TYPE_P(args) != IS_ARRAY)) {
    ...
    zend_internal_type_error(
        EX_USES_STRICT_TYPES(),
        "call_user_func_array() expects parameter 2 to be array, %s given",
        zend_get_type_by_const(Z_TYPE_P(args)));
    ...
    ZEND_VM_C_LABEL(send_array) : ht = Z_ARRVAL_P(args);
    if (OP2_TYPE != IS_UNUSED) {
      zend_free_op free_op2;
      ...
      if (skip < count && len > 0) {
        ...
        ZEND_HASH_FOREACH_VAL(ht, arg) {
          ...
          if (skip > 0) {
            ...
            if (Z_ISREF_P(arg) && !(EX(call)->func->common.fn_flags &
...
ZEND_VM_HOT_HANDLER(64, ZEND_RECV_INIT, NUM, CONST, CACHE_SLOT) {
  ...
  if (arg_num > EX_NUM_ARGS()) {
    ...
    if (Z_OPT_TYPE_P(default_value) == IS_CONSTANT_AST) {
      ...
      if (Z_TYPE_P(cache_val) != IS_UNDEF) {
        ...
        if (UNEXPECTED(zval_update_constant_ex(
                           param, EX(func)->op_array.scope) != SUCCESS)) {
    ...
    ZEND_VM_C_LABEL(recv_init_check_type)
        : if (UNEXPECTED((EX(func)->op_array.fn_flags &
                          ZEND_ACC_HAS_TYPE_HINTS) != 0)) {
      zval *default_value = RT_CONSTANT(opline, opline->op2);

      SAVE_OPLINE();
      if (UNEXPECTED(!zend_verify_recv_arg_type(
              EX(func), arg_num, param, default_value,
              CACHE_ADDR(opline->extended_value)))) {
        HANDLE_EXCEPTION();
      }
    }
...
ZEND_VM_HANDLER(164, ZEND_RECV_VARIADIC, NUM, UNUSED | CACHE_SLOT) {
  ...
  if (arg_num <= arg_count) {
    ...
    ZEND_HASH_FILL_PACKED(Z_ARRVAL_P(params)) {
      ...
      if (UNEXPECTED((EX(func)->op_array.fn_flags & ZEND_ACC_HAS_TYPE_HINTS) !=
                     0)) {
        ZEND_ADD_CALL_FLAG(execute_data, ZEND_CALL_FREE_EXTRA_ARGS);
        do {
          zend_verify_variadic_arg_type(EX(func), arg_num, param, NULL,
                                        CACHE_ADDR(opline->op2.num));
...
ZEND_VM_HANDLER(48, ZEND_CASE, TMPVAR, CONST | TMPVAR | CV) {
  ...
  if (EXPECTED(Z_TYPE_P(op1) == IS_LONG)) {
    if (EXPECTED(Z_TYPE_P(op2) == IS_LONG)) {
      if (EXPECTED(Z_LVAL_P(op1) == Z_LVAL_P(op2))) {
        ZEND_VM_C_LABEL(case_true) : ZEND_VM_SMART_BRANCH_TRUE();
        ZVAL_TRUE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      } else {
        ZEND_VM_C_LABEL(case_false) : ZEND_VM_SMART_BRANCH_FALSE();
        ZVAL_FALSE(EX_VAR(opline->result.var));
        ZEND_VM_NEXT_OPCODE();
      }
    } else if (EXPECTED(Z_TYPE_P(op2) == IS_DOUBLE)) {
    ...
    if (EXPECTED(Z_TYPE_P(op2) == IS_DOUBLE)) {
      d1 = Z_DVAL_P(op1);
      d2 = Z_DVAL_P(op2);
      ZEND_VM_C_LABEL(case_double) : if (d1 == d2) {
...
ZEND_VM_HANDLER(68, ZEND_NEW, UNUSED | CLASS_FETCH | CONST | VAR,
                UNUSED | CACHE_SLOT, NUM) {
  USE_OPLINE
  zval *result;
  ...
  if (constructor == NULL) {
    ...
    /* If there are no arguments, skip over the DO_FCALL opcode. We check if the
     * next opcode is DO_FCALL in case EXT instructions are used. */
    ...
    call = zend_vm_stack_push_call_frame(ZEND_CALL_FUNCTION,
                                         (zend_function *)&zend_pass_function,
                                         opline->extended_value, NULL);
  } else {
    if (EXPECTED(constructor->type == ZEND_USER_FUNCTION) &&
        UNEXPECTED(!RUN_TIME_CACHE(&constructor->op_array))) {
      init_func_run_time_cache(&constructor->op_array);
    }
    /* We are not handling overloaded classes right now */
    call = zend_vm_stack_push_call_frame(
        ZEND_CALL_FUNCTION | ZEND_CALL_RELEASE_THIS | ZEND_CALL_HAS_THIS,
        constructor, opline->extended_value, Z_OBJ_P(result));
    Z_ADDREF_P(result);
  }
...
ZEND_VM_COLD_CONST_HANDLER(110, ZEND_CLONE, CONST | TMPVAR | UNUSED | THIS | CV,
                           ANY) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *obj;
  ...
  if (clone && !(clone->common.fn_flags & ZEND_ACC_PUBLIC)) {
    ...
    if (clone->common.scope != scope) {
      if (UNEXPECTED(clone->common.fn_flags & ZEND_ACC_PRIVATE) ||
          UNEXPECTED(!zend_check_protected(zend_get_function_root_class(clone),
                                           scope))) {
...
ZEND_VM_HOT_HANDLER(99, ZEND_FETCH_CONSTANT, UNUSED | CONST_FETCH, CONST,
                    CACHE_SLOT) {
  USE_OPLINE
  zend_constant *c;
  ...
  SAVE_OPLINE();
  zend_quick_get_constant(RT_CONSTANT(opline, opline->op2) + 1,
                          opline->op1.num OPLINE_CC EXECUTE_DATA_CC);
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
}

ZEND_VM_HANDLER(181, ZEND_FETCH_CLASS_CONSTANT,
                VAR | CONST | UNUSED | CLASS_FETCH, CONST, CACHE_SLOT) {
  zend_class_entry *ce, *scope;
  ...
  do {
    ...
    zv = zend_hash_find_ex(&ce->constants_table,
                           Z_STR_P(RT_CONSTANT(opline, opline->op2)), 1);
    if (EXPECTED(zv != NULL)) {
      c = Z_PTR_P(zv);
      scope = EX(func)->op_array.scope;
      if (!zend_verify_const_access(c, scope)) {
        zend_throw_error(NULL, "Cannot access %s const %s::%s",
                         zend_visibility_string(Z_ACCESS_FLAGS(c->value)),
                         ZSTR_VAL(ce->name),
      ...
      zend_throw_error(NULL, "Undefined class constant '%s'",
                       Z_STRVAL_P(RT_CONSTANT(opline, opline->op2)));
      ZVAL_UNDEF(EX_VAR(opline->result.var));
      HANDLE_EXCEPTION();
    }
...
ZEND_VM_HANDLER(72, ZEND_ADD_ARRAY_ELEMENT, CONST | TMP | VAR | CV,
                CONST | TMPVAR | UNUSED | NEXT | CV, REF) {
  USE_OPLINE
  zend_free_op free_op1;
  ...
  if (OP2_TYPE != IS_UNUSED) {
    ...
    ZEND_VM_C_LABEL(add_again) : if (EXPECTED(Z_TYPE_P(offset) == IS_STRING)) {
      str = Z_STR_P(offset);
      if (OP2_TYPE != IS_CONST) {
      ...
      ZEND_VM_C_LABEL(str_index)
          : zend_hash_update(Z_ARRVAL_P(EX_VAR(opline->result.var)), str,
                             expr_ptr);
    }
    else if (EXPECTED(Z_TYPE_P(offset) == IS_LONG)) {
      hval = Z_LVAL_P(offset);
      ZEND_VM_C_LABEL(num_index)
          : zend_hash_index_update(Z_ARRVAL_P(EX_VAR(opline->result.var)), hval,
                                   expr_ptr);
    }
    else if ((OP2_TYPE & (IS_VAR | IS_CV)) &&
             EXPECTED(Z_TYPE_P(offset) == IS_REFERENCE)) {
    ...
    if (!zend_hash_next_index_insert(Z_ARRVAL_P(EX_VAR(opline->result.var)),
                                     expr_ptr)) {
      zend_cannot_add_element();
      zval_ptr_dtor_nogc(expr_ptr);
    }
...
ZEND_VM_HANDLER(147, ZEND_ADD_ARRAY_UNPACK, ANY, ANY) {
  ...
  ZEND_VM_C_LABEL(add_unpack_again) : if (EXPECTED(Z_TYPE_P(op1) == IS_ARRAY)) {
...
ZEND_VM_HANDLER(71, ZEND_INIT_ARRAY, CONST | TMP | VAR | CV | UNUSED,
                CONST | TMPVAR | UNUSED | NEXT | CV, ARRAY_INIT | REF) {
  zval *array;
  uint32_t size;
  USE_OPLINE
...
ZEND_VM_COLD_CONST_HANDLER(51, ZEND_CAST, CONST | TMP | VAR | CV, ANY, TYPE) {
  ...
  default:
    ...
    if (opline->extended_value == IS_ARRAY) {
      if (OP1_TYPE == IS_CONST || Z_TYPE_P(expr) != IS_OBJECT ||
          Z_OBJCE_P(expr) == zend_ce_closure) {
        if (Z_TYPE_P(expr) != IS_NULL) {
          ZVAL_ARR(result, zend_new_array(1));
          expr = zend_hash_index_add_new(Z_ARRVAL_P(result), 0, expr);
          if (OP1_TYPE == IS_CONST) {
            if (UNEXPECTED(Z_OPT_REFCOUNTED_P(expr)))
              Z_ADDREF_P(expr);
          } else {
        ...
        if (obj_ht) {
          ...
          ZVAL_ARR(
              ...
              zend_proptable_to_symtable(
                  obj_ht, (Z_OBJCE_P(expr)->default_properties_count ||
...
ZEND_VM_HANDLER(73, ZEND_INCLUDE_OR_EVAL, CONST | TMPVAR | CV, ANY, EVAL) {
  ...
  if (UNEXPECTED(EG(exception) != NULL)) {
    ...
    call = zend_vm_stack_push_call_frame(
        (Z_TYPE_INFO(EX(This)) & ZEND_CALL_HAS_THIS) | ZEND_CALL_NESTED_CODE |
...
ZEND_VM_HANDLER(75, ZEND_UNSET_DIM, VAR | CV, CONST | TMPVAR | CV) {
  ...
  do {
    if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
      ...
      ZEND_VM_C_LABEL(unset_dim_array) : SEPARATE_ARRAY(container);
      ...
      ZEND_VM_C_LABEL(offset_again)
        ...
        ZEND_VM_C_LABEL(str_index_dim) : if (ht == &EG(symbol_table)) {
        ...
        hval = Z_LVAL_P(offset);
        ZEND_VM_C_LABEL(num_index_dim) : zend_hash_index_del(ht, hval);
      }
      else if ((OP2_TYPE & (IS_VAR | IS_CV)) &&
               EXPECTED(Z_TYPE_P(offset) == IS_REFERENCE)) {
        offset = Z_REFVAL_P(offset);
    ...
    if (EXPECTED(Z_TYPE_P(container) == IS_OBJECT)) {
      ...
      Z_OBJ_HT_P(container)->unset_dimension(container, offset);
               ...
               UNEXPECTED(Z_TYPE_P(container) == IS_STRING)) {
...
ZEND_VM_HANDLER(76, ZEND_UNSET_OBJ, VAR | UNUSED | THIS | CV,
                CONST | TMPVAR | CV, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *container;
  ...
  do {
    ...
    Z_OBJ_HT_P(container)->unset_property(
        container, offset,
        ((OP2_TYPE == IS_CONST) ? CACHE_ADDR(opline->extended_value) : NULL));
  } while (0);
...
ZEND_VM_HANDLER(77, ZEND_FE_RESET_R, CONST | TMP | VAR | CV, JMP_ADDR) {
  ...
  if (EXPECTED(Z_TYPE_P(array_ptr) == IS_ARRAY)) {
    ...
    if (!Z_OBJCE_P(array_ptr)->get_iterator) {
      ...
      zend_bool is_empty =
          zend_fe_reset_iterator(array_ptr, 0 OPLINE_CC EXECUTE_DATA_CC);
...
ZEND_VM_COLD_CONST_HANDLER(125, ZEND_FE_RESET_RW, CONST | TMP | VAR | CV,
                           JMP_ADDR) {
  USE_OPLINE
  zend_free_op free_op1;
  ...
  if (EXPECTED(Z_TYPE_P(array_ptr) == IS_ARRAY)) {
    ...
    Z_FE_ITER_P(EX_VAR(opline->result.var)) =
        zend_hash_iterator_add(Z_ARRVAL_P(array_ptr), 0);
    ...
    if (!Z_OBJCE_P(array_ptr)->get_iterator) {
      ...
      Z_FE_ITER_P(EX_VAR(opline->result.var)) =
          zend_hash_iterator_add(properties, 0);
      FREE_OP1_VAR_PTR();
      ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
    } else {
      zend_bool is_empty =
          zend_fe_reset_iterator(array_ptr, 1 OPLINE_CC EXECUTE_DATA_CC);
    ...
    if ((iter = zend_iterator_unwrap(array)) == NULL) {
      ...
      while (1) {
        ...
        if (EXPECTED(value_type != IS_UNDEF)) {
          ...
          } else if (EXPECTED(Z_OBJCE_P(array)->default_properties_count ==
                              0) ||
                     !p->key ||
                     zend_check_property_access(Z_OBJ_P(array), p->key, 1) ==
                         SUCCESS) {
            break;
          }
        }
      ...
      if (RETURN_VALUE_USED(opline)) {
        if (UNEXPECTED(!p->key)) {
          ...
          zend_unmangle_property_name_ex(p->key, &class_name, &prop_name,
                                         &prop_name_len);
          ZVAL_STRINGL(EX_VAR(opline->result.var), prop_name, prop_name_len);
        }
      }
      EG(ht_iterators)
      [Z_FE_ITER_P(array)].pos = pos + 1;
    } else {
...
ZEND_VM_HANDLER(126, ZEND_FE_FETCH_RW, VAR, ANY, JMP_ADDR) {
  ...
  if (EXPECTED(Z_TYPE_P(array) == IS_ARRAY)) {
    pos =
        zend_hash_iterator_pos_ex(Z_FE_ITER_P(EX_VAR(opline->op1.var)), array);
    fe_ht = Z_ARRVAL_P(array);
    p = fe_ht->arData + pos;
    while (1) {
      if (UNEXPECTED(pos >= fe_ht->nNumUsed)) {
    ...
    EG(ht_iterators)
    [Z_FE_ITER_P(EX_VAR(opline->op1.var))].pos = pos + 1;
          ...
          if (UNEXPECTED(value_type == IS_INDIRECT)) {
            ...
            if (EXPECTED(value_type != IS_UNDEF) &&
              ...
              if ((value_type & Z_TYPE_MASK) != IS_REFERENCE) {
                zend_property_info *prop_info =
                    zend_get_typed_property_info_for_slot(Z_OBJ_P(array),
                                                          value);
                if (UNEXPECTED(prop_info)) {
...
ZEND_VM_HOT_HANDLER(154, ZEND_ISSET_ISEMPTY_CV, CV, UNUSED, ISSET,
                    SPEC(ISSET)) {
  USE_OPLINE
  zval *value;
...
/* No specialization for op_types (CONST|TMPVAR|CV,
 * UNUSED|CLASS_FETCH|CONST|VAR) */
ZEND_VM_HANDLER(180, ZEND_ISSET_ISEMPTY_STATIC_PROP, ANY, CLASS_FETCH,
                ISSET | CACHE_SLOT) {
  USE_OPLINE
  zval *value;
  int result;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(115, ZEND_ISSET_ISEMPTY_DIM_OBJ,
  ...
  if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
    ...
    ZEND_VM_C_LABEL(isset_dim_obj_array) : ht = Z_ARRVAL_P(container);
    ZEND_VM_C_LABEL(isset_again)
      ...
      hval = Z_LVAL_P(offset);
      ZEND_VM_C_LABEL(num_index_prop) : value = zend_hash_index_find(ht, hval);
    }
  ...
  ZEND_VM_C_LABEL(isset_dim_obj_exit) : FREE_OP2();
  FREE_OP1();
  ZEND_VM_SMART_BRANCH(result, 1);
  ZVAL_BOOL(EX_VAR(opline->result.var), result);
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
...
ZEND_VM_COLD_CONST_HANDLER(148, ZEND_ISSET_ISEMPTY_PROP_OBJ,
                           CONST | TMPVAR | UNUSED | THIS | CV,
                           CONST | TMPVAR | CV, ISSET | CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *container;
  int result;
  ...
  result = (opline->extended_value & ZEND_ISEMPTY) ^
           Z_OBJ_HT_P(container)->has_property(
               container, offset, (opline->extended_value & ZEND_ISEMPTY),
               ((OP2_TYPE == IS_CONST)
                    ? CACHE_ADDR(opline->extended_value & ~ZEND_ISEMPTY)
                    : NULL));

  ZEND_VM_C_LABEL(isset_object_finish) : FREE_OP2();
  FREE_OP1();
  ZEND_VM_SMART_BRANCH(result, 1);
  ZVAL_BOOL(EX_VAR(opline->result.var), result);
  ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
...
ZEND_VM_HANDLER(194, ZEND_ARRAY_KEY_EXISTS, CV | TMPVAR | CONST,
                CV | TMPVAR | CONST) {
  USE_OPLINE
  ...
  if (EXPECTED(Z_TYPE_P(subject) == IS_ARRAY)) {
    ZEND_VM_C_LABEL(array_key_exists_array) : ht = Z_ARRVAL_P(subject);
  ...
  if (EG(error_reporting)) {
    do {
      ...
      if (!EG(error_reporting_ini_entry)) {
        zval *zv = zend_hash_find_ex(EG(ini_directives),
                                     ZSTR_KNOWN(ZEND_STR_ERROR_REPORTING), 1);
        if (zv) {
      ...
      if (!EG(error_reporting_ini_entry)->modified) {
        ...
        if (EXPECTED(zend_hash_add_ptr(EG(modified_ini_directives),
                     ...
                     NULL)) {
          EG(error_reporting_ini_entry)->orig_value =
              EG(error_reporting_ini_entry)->value;
          EG(error_reporting_ini_entry)->orig_modifiable =
...
ZEND_VM_COLD_CONST_HANDLER(152, ZEND_JMP_SET, CONST | TMP | VAR | CV,
                           JMP_ADDR) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *value;
...
ZEND_VM_COLD_CONST_HANDLER(169, ZEND_COALESCE, CONST | TMP | VAR | CV,
                           JMP_ADDR) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *value;
...
ZEND_VM_COLD_HANDLER(101, ZEND_EXT_STMT, ANY, ANY) {
  ...
  if (!EG(no_extensions)) {
    ...
    zend_llist_apply_with_argument(
        &zend_extensions,
        (llist_apply_with_arg_func_t)zend_extension_statement_handler,
        execute_data);
    ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
  }
  ZEND_VM_NEXT_OPCODE();
...
ZEND_VM_COLD_HANDLER(102, ZEND_EXT_FCALL_BEGIN, ANY, ANY) {
  ...
  if (!EG(no_extensions)) {
    ...
    zend_llist_apply_with_argument(
        &zend_extensions,
        (llist_apply_with_arg_func_t)zend_extension_fcall_begin_handler,
        execute_data);
    ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
  }
  ZEND_VM_NEXT_OPCODE();
...
ZEND_VM_COLD_HANDLER(103, ZEND_EXT_FCALL_END, ANY, ANY) {
  ...
  if (!EG(no_extensions)) {
    ...
    zend_llist_apply_with_argument(
        &zend_extensions,
        (llist_apply_with_arg_func_t)zend_extension_fcall_end_handler,
        execute_data);
    ZEND_VM_NEXT_OPCODE_CHECK_EXCEPTION();
  }
  ZEND_VM_NEXT_OPCODE();
...
ZEND_VM_HANDLER(145, ZEND_DECLARE_CLASS_DELAYED, CONST, CONST) {
  ...
  if (ce == NULL) {
    ...
    if (zv) {
      SAVE_OPLINE();
      ce = Z_CE_P(zv);
      zv = zend_hash_set_bucket_key(EG(class_table), (Bucket *)zv,
                                    Z_STR_P(lcname));
      if (UNEXPECTED(!zv)) {
        zend_error_noreturn(
            E_COMPILE_ERROR,
            "Cannot declare %s %s, because the name is already in use",
            zend_get_object_type(ce), ZSTR_VAL(ce->name));
      } else {
        if (zend_do_link_class(ce, Z_STR_P(RT_CONSTANT(opline, opline->op2))) ==
            FAILURE) {
          /* Reload bucket pointer, the hash table may have been reallocated */
          zv = zend_hash_find(EG(class_table), Z_STR_P(lcname));
          zend_hash_set_bucket_key(EG(class_table), (Bucket *)zv,
                                   Z_STR_P(lcname + 1));
          HANDLE_EXCEPTION();
        }
      }
...
ZEND_VM_HANDLER(146, ZEND_DECLARE_ANON_CLASS, ANY, ANY, CACHE_SLOT) {
  ...
  if (UNEXPECTED(ce == NULL)) {
    ...
    if (!(ce->ce_flags & ZEND_ACC_LINKED)) {
      SAVE_OPLINE();
      if (zend_do_link_class(ce, (OP2_TYPE == IS_CONST)
                                     ? Z_STR_P(RT_CONSTANT(opline, opline->op2))
                                     : NULL) == FAILURE) {
        HANDLE_EXCEPTION();
      }
...
ZEND_VM_HANDLER(138, ZEND_INSTANCEOF, TMPVAR | CV,
                UNUSED | CLASS_FETCH | CONST | VAR, CACHE_SLOT) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *expr;
  zend_bool result;
  ...
  ZEND_VM_C_LABEL(try_instanceof) : if (Z_TYPE_P(expr) == IS_OBJECT) {
    zend_class_entry *ce;
...
ZEND_VM_HELPER(zend_dispatch_try_catch_finally_helper, ANY, ANY,
               uint32_t try_catch_offset, uint32_t op_num) {
  ...
  while (try_catch_offset != (uint32_t)-1) {
    ...
    if (op_num < try_catch->catch_op && ex) {
      ...
      /* Go to finally block */
      zval *fast_call =
          EX_VAR(EX(func)->op_array.opcodes[try_catch->finally_end].op1.var);
      ...
      if (Z_OPLINE_NUM_P(fast_call) != (uint32_t)-1 &&
          (EX(func)->op_array.opcodes[Z_OPLINE_NUM_P(fast_call)].op2_type &
           (IS_TMP_VAR | IS_VAR))) {
        zval *return_value = EX_VAR(
            EX(func)->op_array.opcodes[Z_OPLINE_NUM_P(fast_call)].op2.var);
...
ZEND_VM_HANDLER(149, ZEND_HANDLE_EXCEPTION, ANY, ANY) {
  ...
  if ((throw_op->opcode == ZEND_FREE || throw_op->opcode == ZEND_FE_FREE) &&
    ...
    const zend_live_range *range =
        find_live_range(&EX(func)->op_array, throw_op_num, throw_op->op1.var);
  ...
  if (throw_op->result_type & (IS_VAR | IS_TMP_VAR)) {
    ...
    case ZEND_ROPE_INIT:
    case ZEND_ROPE_ADD:
      break; /* exception while building structures, live range handling will
                free those */
  ...
  ZEND_VM_DISPATCH_TO_HELPER(zend_dispatch_try_catch_finally_helper,
                             try_catch_offset, current_try_catch_offset, op_num,
                             throw_op_num);
}
...
ZEND_VM_HANDLER(143, ZEND_DECLARE_CONST, CONST, CONST) {
  ...
  if (Z_OPT_CONSTANT(c.value)) {
    if (UNEXPECTED(zval_update_constant_ex(
                       &c.value, EX(func)->op_array.scope) != SUCCESS)) {
...
ZEND_VM_HANDLER(142, ZEND_DECLARE_LAMBDA_FUNCTION, CONST, UNUSED, CACHE_SLOT) {
  ...
  if (UNEXPECTED(func == NULL)) {
    zfunc = zend_hash_find_ex(EG(function_table),
                              Z_STR_P(RT_CONSTANT(opline, opline->op1)), 1);
...
ZEND_VM_HANDLER(166, ZEND_YIELD_FROM, CONST | TMP | VAR | CV, ANY) {
  ...
  if (Z_TYPE_P(val) == IS_ARRAY) {
    ...
    FREE_OP1_IF_VAR();
  } else if (OP1_TYPE != IS_CONST && Z_TYPE_P(val) == IS_OBJECT &&
             Z_OBJCE_P(val)->get_iterator) {
    ...
    if (ce == zend_ce_generator) {
      ...
      if (Z_ISUNDEF(new_gen->retval)) {
        ...
        zend_throw_error(NULL,
                         "Generator passed to yield from was aborted without "
                         "proper return and is unable to continue");
        zval_ptr_dtor(val);
        UNDEF_RESULT();
        HANDLE_EXCEPTION();
      } else {
      ...
      if (UNEXPECTED(!iter) || UNEXPECTED(EG(exception))) {
        if (!EG(exception)) {
          zend_throw_error(NULL, "Object of type %s did not create an Iterator",
                           ZSTR_VAL(ce->name));
        }
        UNDEF_RESULT();
        HANDLE_EXCEPTION();
    ...
    zend_throw_error(
        NULL, "Can use \"yield from\" only with arrays and Traversables");
    FREE_OP1();
    UNDEF_RESULT();
    HANDLE_EXCEPTION();
  }
   ...
   * when the expression is a Generator, it will be overwritten in
   * zend_generator_resume() */
  if (RETURN_VALUE_USED(opline)) {
    ZVAL_NULL(EX_VAR(opline->result.var));
  }

  /* This generator has no send target (though the generator we delegate to
   * might have one) */
  generator->send_target = NULL;
...
ZEND_VM_HANDLER(159, ZEND_DISCARD_EXCEPTION, ANY, ANY) {
  ...
  if (Z_OPLINE_NUM_P(fast_call) != (uint32_t)-1 &&
      (EX(func)->op_array.opcodes[Z_OPLINE_NUM_P(fast_call)].op2_type &
       (IS_TMP_VAR | IS_VAR))) {
    zval *return_value =
        EX_VAR(EX(func)->op_array.opcodes[Z_OPLINE_NUM_P(fast_call)].op2.var);
...
ZEND_VM_HANDLER(163, ZEND_FAST_RET, ANY, TRY_CATCH) {
  ...
  if (Z_OPLINE_NUM_P(fast_call) != (uint32_t)-1) {
    const zend_op *fast_ret =
        EX(func)->op_array.opcodes + Z_OPLINE_NUM_P(fast_call);
...
ZEND_VM_HOT_HANDLER(168, ZEND_BIND_GLOBAL, CV, CONST, CACHE_SLOT) {
  ...
  if (EXPECTED(idx < EG(symbol_table).nNumUsed * sizeof(Bucket))) {
    ...
    if (EXPECTED(Z_TYPE(p->val) != IS_UNDEF) &&
        (EXPECTED(p->key == varname) ||
         (EXPECTED(p->h == ZSTR_H(varname)) && EXPECTED(p->key != NULL) &&
  ...
  if (UNEXPECTED(value == NULL)) {
    value =
        zend_hash_add_new(&EG(symbol_table), varname, &EG(uninitialized_zval));
...
ZEND_VM_COLD_CONST_HANDLER(121, ZEND_STRLEN, CONST | TMPVAR | CV, ANY) {
  ...
  if (EXPECTED(Z_TYPE_P(value) == IS_STRING)) {
    ...
    do {
      ...
      if (!EG(exception)) {
        zend_internal_type_error(
            strict, "strlen() expects parameter 1 to be string, %s given",
...
ZEND_VM_HOT_NOCONST_HANDLER(123, ZEND_TYPE_CHECK, CONST | TMPVAR | CV, ANY,
                            TYPE_MASK) {
  USE_OPLINE
  zval *value;
  int result = 0;
...
ZEND_VM_HOT_HANDLER(122, ZEND_DEFINED, CONST, ANY, CACHE_SLOT) {
  ...
  if (EXPECTED(c != NULL)) {
    if (!IS_SPECIAL_CACHE_VAL(c)) {
      ZEND_VM_C_LABEL(defined_true) : ZEND_VM_SMART_BRANCH_TRUE();
      ZVAL_TRUE(EX_VAR(opline->result.var));
      ZEND_VM_NEXT_OPCODE();
    } else if (EXPECTED(zend_hash_num_elements(EG(zend_constants)) ==
                        DECODE_SPECIAL_CACHE_NUM(c))) {
      ZEND_VM_C_LABEL(defined_false) : ZEND_VM_SMART_BRANCH_FALSE();
      ZVAL_FALSE(EX_VAR(opline->result.var));
      ZEND_VM_NEXT_OPCODE();
    }
  }
  if (zend_quick_check_constant(RT_CONSTANT(opline, opline->op1)
                                    OPLINE_CC EXECUTE_DATA_CC) != SUCCESS) {
    CACHE_PTR(
        opline->extended_value,
        ENCODE_SPECIAL_CACHE_NUM(zend_hash_num_elements(EG(zend_constants))));
...
ZEND_VM_HANDLER(157, ZEND_FETCH_CLASS_NAME, UNUSED | CLASS_FETCH, ANY) {
  ...
  if (UNEXPECTED(scope == NULL)) {
    ...
    zend_throw_error(NULL, "Cannot use \"%s\" when no class scope is active",
                     ...
                     : fetch_type == ZEND_FETCH_CLASS_PARENT ? "parent"
                                                             : "static");
    ZVAL_UNDEF(EX_VAR(opline->result.var));
    HANDLE_EXCEPTION();
  }
  ...
  case ZEND_FETCH_CLASS_PARENT:
    if (UNEXPECTED(scope->parent == NULL)) {
      SAVE_OPLINE();
      zend_throw_error(
          NULL, "Cannot use \"parent\" when current class scope has no parent");
      ZVAL_UNDEF(EX_VAR(opline->result.var));
      HANDLE_EXCEPTION();
    }
...
ZEND_VM_HANDLER(158, ZEND_CALL_TRAMPOLINE, ANY, ANY) {
  ...
  uint32_t call_info = EX_CALL_INFO() & (ZEND_CALL_NESTED | ZEND_CALL_TOP |
  ...
  call->func = (fbc->op_array.fn_flags & ZEND_ACC_STATIC)
                   ? fbc->op_array.scope->__callstatic
                   : fbc->op_array.scope->__call;
  ZEND_ASSERT(zend_vm_calc_used_stack(2, call->func) <=
              (size_t)(((char *)EG(vm_stack_end)) - (char *)call));
  ...
  if (EXPECTED(fbc->type == ZEND_USER_FUNCTION)) {
    ...
    ZEND_VM_C_LABEL(call_trampoline_end) : zend_vm_stack_free_args(call);
    if (ret == &retval) {
      zval_ptr_dtor(ret);
    }
  }
...
ZEND_VM_HANDLER(182, ZEND_BIND_LEXICAL, TMP, CV, REF) {
  ...
  zend_closure_bind_var_ex(
      closure, (opline->extended_value & ~(ZEND_BIND_REF | ZEND_BIND_IMPLICIT)),
      var);
  ZEND_VM_NEXT_OPCODE();
}
...
ZEND_VM_HANDLER(183, ZEND_BIND_STATIC, CV, UNUSED, REF) {
  ...
  if (!ht) {
    ZEND_ASSERT(EX(func)->op_array.fn_flags &
                (ZEND_ACC_IMMUTABLE | ZEND_ACC_PRELOADED));
  ...
  value =
      (zval *)((char *)ht->arData + (opline->extended_value &
                                     ~(ZEND_BIND_REF | ZEND_BIND_IMPLICIT)));

  if (opline->extended_value & ZEND_BIND_REF) {
    if (Z_TYPE_P(value) == IS_CONSTANT_AST) {
      SAVE_OPLINE();
      if (UNEXPECTED(zval_update_constant_ex(value, EX(func)->op_array.scope) !=
                     SUCCESS)) {
        ZVAL_NULL(variable_ptr);
        HANDLE_EXCEPTION();
      }
...
ZEND_VM_COLD_CONSTCONST_HANDLER(187, ZEND_SWITCH_LONG, CONST | TMPVARCV, CONST,
                                JMP_ADDR) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op, *jump_zv;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(188, ZEND_SWITCH_STRING, CONST | TMPVARCV,
                                CONST, JMP_ADDR) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *op, *jump_zv;
...
ZEND_VM_COLD_CONSTCONST_HANDLER(189, ZEND_IN_ARRAY, CONST | TMP | VAR | CV,
                                CONST, NUM) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *op1;
...
ZEND_VM_COLD_CONST_HANDLER(190, ZEND_COUNT, CONST | TMPVAR | CV, UNUSED) {
  ...
  while (1) {
    if (Z_TYPE_P(op1) == IS_ARRAY) {
      ...
      /* If There's no handler and it doesn't implement Countable then add a
       * warning */
      count = 1;
    } else if ((OP1_TYPE & (IS_VAR | IS_CV)) != 0 &&
               Z_TYPE_P(op1) == IS_REFERENCE) {
      op1 = Z_REFVAL_P(op1);
      continue;
    ...
    zend_error(E_WARNING,
               "%s(): Parameter must be an array or an object that implements "
               "Countable",
               opline->extended_value ? "sizeof" : "count");
    break;
  }
...
ZEND_VM_COLD_CONST_HANDLER(191, ZEND_GET_CLASS, UNUSED | CONST | TMPVAR | CV,
                           UNUSED) {
  USE_OPLINE
  ...
  if (OP1_TYPE == IS_UNUSED) {
    ...
    while (1) {
      if (Z_TYPE_P(op1) == IS_OBJECT) {
        ...
        zend_error(E_WARNING,
                   "get_class() expects parameter 1 to be object, %s given",
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_JMP, (OP_JMP_ADDR(op, op->op1) > op),
                              ZEND_JMP_FORWARD, JMP_ADDR, ANY) {
  USE_OPLINE
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_ADD,
                              ...
                              ZEND_ADD_LONG_NO_OVERFLOW, CONST | TMPVARCV,
                              CONST | TMPVARCV,
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_ADD,
                              (op1_info == MAY_BE_LONG &&
                               op2_info == MAY_BE_LONG),
                              ZEND_ADD_LONG, CONST | TMPVARCV, CONST | TMPVARCV,
                              SPEC(NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_ADD, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_ADD_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_SUB,
                              (res_info == MAY_BE_LONG &&
                               op1_info == MAY_BE_LONG &&
                               op2_info == MAY_BE_LONG),
                              ZEND_SUB_LONG_NO_OVERFLOW, CONST | TMPVARCV,
                              CONST | TMPVARCV, SPEC(NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_SUB, (op1_info == MAY_BE_LONG && op2_info == MAY_BE_LONG),
    ZEND_SUB_LONG, CONST | TMPVARCV, CONST | TMPVARCV, SPEC(NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_SUB, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_SUB_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV, SPEC(NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_MUL,
                              (res_info == MAY_BE_LONG &&
                               op1_info == MAY_BE_LONG &&
                               op2_info == MAY_BE_LONG),
                              ZEND_MUL_LONG_NO_OVERFLOW, CONST | TMPVARCV,
                              CONST | TMPVARCV,
                              SPEC(NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_MUL,
                              (op1_info == MAY_BE_LONG &&
                               op2_info == MAY_BE_LONG),
                              ZEND_MUL_LONG, CONST | TMPVARCV, CONST | TMPVARCV,
                              SPEC(NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2, *result;
  zend_long overflow;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_MUL, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_MUL_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2, *result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_EQUAL, (op1_info == MAY_BE_LONG && op2_info == MAY_BE_LONG),
    ZEND_IS_EQUAL_LONG, CONST | TMPVARCV, CONST | TMPVARCV,
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_EQUAL, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_IS_EQUAL_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(SMART_BRANCH, NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2;
  int result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_NOT_EQUAL, (op1_info == MAY_BE_LONG && op2_info == MAY_BE_LONG),
    ZEND_IS_NOT_EQUAL_LONG, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(SMART_BRANCH, NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2;
  int result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_NOT_EQUAL, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_IS_NOT_EQUAL_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(SMART_BRANCH, NO_CONST_CONST, COMMUTATIVE)) {
  USE_OPLINE
  zval *op1, *op2;
  int result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_SMALLER, (op1_info == MAY_BE_LONG && op2_info == MAY_BE_LONG),
    ZEND_IS_SMALLER_LONG, CONST | TMPVARCV, CONST | TMPVARCV,
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_IS_SMALLER, (op1_info == MAY_BE_DOUBLE && op2_info == MAY_BE_DOUBLE),
    ZEND_IS_SMALLER_DOUBLE, CONST | TMPVARCV, CONST | TMPVARCV,
    SPEC(SMART_BRANCH, NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2;
  int result;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_IS_SMALLER_OR_EQUAL,
                              (op1_info == MAY_BE_LONG &&
                               op2_info == MAY_BE_LONG),
                              ZEND_IS_SMALLER_OR_EQUAL_LONG, CONST | TMPVARCV,
                              CONST | TMPVARCV,
                              SPEC(SMART_BRANCH, NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_IS_SMALLER_OR_EQUAL,
                              (op1_info == MAY_BE_DOUBLE &&
                               op2_info == MAY_BE_DOUBLE),
                              ZEND_IS_SMALLER_OR_EQUAL_DOUBLE, CONST | TMPVARCV,
                              CONST | TMPVARCV,
                              SPEC(SMART_BRANCH, NO_CONST_CONST)) {
  USE_OPLINE
  zval *op1, *op2;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_PRE_INC, (res_info == MAY_BE_LONG && op1_info == MAY_BE_LONG),
    ZEND_PRE_INC_LONG_NO_OVERFLOW, CV, ANY, SPEC(RETVAL)) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_PRE_INC, (op1_info == MAY_BE_LONG),
                              ZEND_PRE_INC_LONG, CV, ANY, SPEC(RETVAL)) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_PRE_DEC, (res_info == MAY_BE_LONG && op1_info == MAY_BE_LONG),
    ZEND_PRE_DEC_LONG_NO_OVERFLOW, CV, ANY, SPEC(RETVAL)) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_PRE_DEC, (op1_info == MAY_BE_LONG),
                              ZEND_PRE_DEC_LONG, CV, ANY, SPEC(RETVAL)) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_POST_INC,
                              (res_info == MAY_BE_LONG &&
                               op1_info == MAY_BE_LONG),
                              ZEND_POST_INC_LONG_NO_OVERFLOW, CV, ANY) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_POST_INC, (op1_info == MAY_BE_LONG),
                              ZEND_POST_INC_LONG, CV, ANY) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_POST_DEC,
                              (res_info == MAY_BE_LONG &&
                               op1_info == MAY_BE_LONG),
                              ZEND_POST_DEC_LONG_NO_OVERFLOW, CV, ANY) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_POST_DEC, (op1_info == MAY_BE_LONG),
                              ZEND_POST_DEC_LONG, CV, ANY) {
  USE_OPLINE
  zval *var_ptr;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_QM_ASSIGN, (op1_info == MAY_BE_LONG),
                              ZEND_QM_ASSIGN_LONG, CONST | TMPVARCV, ANY) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *value;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_QM_ASSIGN, (op1_info == MAY_BE_DOUBLE),
                              ZEND_QM_ASSIGN_DOUBLE, CONST | TMPVARCV, ANY) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *value;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ...
    ((op->op1_type == IS_CONST)
         ? !Z_REFCOUNTED_P(RT_CONSTANT(op, op->op1))
         : (!(op1_info & ((MAY_BE_ANY | MAY_BE_UNDEF) -
                          (MAY_BE_NULL | MAY_BE_FALSE | MAY_BE_TRUE |
                           MAY_BE_LONG | MAY_BE_DOUBLE))))),
    ZEND_QM_ASSIGN_NOREF, CONST | TMPVARCV, ANY) {
  USE_OPLINE
  zend_free_op free_op1;
  zval *value;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(
    ZEND_FETCH_DIM_R,
    (!(op2_info & (MAY_BE_UNDEF | MAY_BE_NULL | MAY_BE_STRING | MAY_BE_ARRAY |
                   MAY_BE_OBJECT | MAY_BE_RESOURCE | MAY_BE_REF))),
    ZEND_FETCH_DIM_R_INDEX, CONST | TMPVAR | CV, CONST | TMPVARCV,
    SPEC(NO_CONST_CONST)) {
  USE_OPLINE
  zend_free_op free_op1, free_op2;
  zval *container, *dim, *value;
  ...
  if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
    ...
    ht = Z_ARRVAL_P(container);
    ZEND_HASH_INDEX_FIND(ht, offset, value,
    ...
    if (OP1_TYPE & (IS_TMP_VAR | IS_VAR)) {
      ...
      ZEND_VM_NEXT_OPCODE();
             ...
             EXPECTED(Z_TYPE_P(container) == IS_REFERENCE)) {
    container = Z_REFVAL_P(container);
    if (EXPECTED(Z_TYPE_P(container) == IS_ARRAY)) {
    ...
    ZEND_VM_C_LABEL(fetch_dim_r_index_slow) : SAVE_OPLINE();
    if (OP2_TYPE == IS_CONST && Z_EXTRA_P(dim) == ZEND_EXTRA_VALUE) {
      dim++;
    }
    zend_fetch_dimension_address_read_R_slow(container,
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_SEND_VAR,
                              ...
                              ZEND_SEND_VAR_SIMPLE, CV | VAR, NUM) {
  USE_OPLINE
  zval *varptr, *arg;
  zend_free_op free_op1;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_SEND_VAR_EX,
                              op->op2.num <= MAX_ARG_FLAG_NUM &&
                                  (op1_info & (MAY_BE_UNDEF | MAY_BE_REF)) == 0,
                              ZEND_SEND_VAR_EX_SIMPLE, CV | VAR, NUM) {
  USE_OPLINE
  zval *varptr, *arg;
  zend_free_op free_op1;
  uint32_t arg_num = opline->op2.num;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_SEND_VAL,
                              op->op1_type == IS_CONST &&
                                  !Z_REFCOUNTED_P(RT_CONSTANT(op, op->op1)),
                              ZEND_SEND_VAL_SIMPLE, CONST, NUM) {
  USE_OPLINE
  zval *value, *arg;
  zend_free_op free_op1;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_SEND_VAL_EX,
                              op->op2.num <= MAX_ARG_FLAG_NUM &&
                                  op->op1_type == IS_CONST &&
                                  !Z_REFCOUNTED_P(RT_CONSTANT(op, op->op1)),
                              ZEND_SEND_VAL_EX_SIMPLE, CONST, NUM) {
  USE_OPLINE
  zval *value, *arg;
  zend_free_op free_op1;
  uint32_t arg_num = opline->op2.num;
...
ZEND_VM_HOT_TYPE_SPEC_HANDLER(ZEND_FE_FETCH_R,
                              op->op2_type == IS_CV &&
                                  (op1_info & (MAY_BE_UNDEF | MAY_BE_ANY |
                                               MAY_BE_REF)) == MAY_BE_ARRAY,
                              ZEND_FE_FETCH_R_SIMPLE, VAR, CV, JMP_ADDR,
                              SPEC(RETVAL)) {
  USE_OPLINE
  zval *array;
