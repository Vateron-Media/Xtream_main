...
static zend_always_inline int zend_ulong_ntz(zend_ulong num) {
  ...
  return __builtin_ctzl(num);
    ...
    defined(PHP_HAVE_BUILTIN_CTZLL)
...
static inline zend_bool zend_bitset_equal(zend_bitset set1, zend_bitset set2,
                                          uint32_t len) {
  return memcmp(set1, set2, len * ZEND_BITSET_ELM_SIZE) == 0;
}

static inline void zend_bitset_copy(zend_bitset set1, zend_bitset set2,
                                    uint32_t len) {
  memcpy(set1, set2, len * ZEND_BITSET_ELM_SIZE);
}

static inline void zend_bitset_intersection(zend_bitset set1, zend_bitset set2,
                                            uint32_t len) {
  uint32_t i;
...
static inline void zend_bitset_union(zend_bitset set1, zend_bitset set2,
                                     uint32_t len) {
  uint32_t i;
...
static inline void zend_bitset_difference(zend_bitset set1, zend_bitset set2,
                                          uint32_t len) {
  uint32_t i;
...
static inline void zend_bitset_union_with_intersection(zend_bitset set1,
                                                       zend_bitset set2,
                                                       zend_bitset set3,
                                                       zend_bitset set4,
                                                       uint32_t len) {
...
static inline void zend_bitset_union_with_difference(zend_bitset set1,
                                                     zend_bitset set2,
                                                     zend_bitset set3,
                                                     zend_bitset set4,
                                                     uint32_t len) {
...
static inline zend_bool zend_bitset_subset(zend_bitset set1, zend_bitset set2,
                                           uint32_t len) {
  uint32_t i;
