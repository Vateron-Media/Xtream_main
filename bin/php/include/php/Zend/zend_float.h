...
#define XPFPA_DECLARE unsigned int _xpfpa_fpu_oldcw, _xpfpa_fpu_cw;
...
#define XPFPA_DECLARE unsigned int _xpfpa_fpu_oldcw;
...
#define XPFPA_DECLARE fpu_control_t _xpfpa_fpu_oldcw, _xpfpa_fpu_cw;

#define XPFPA_HAVE_CW 1
#define XPFPA_CW_DATATYPE fpu_control_t
...
#define XPFPA_SWITCH_DOUBLE()                                                  \
  do {                                                                         \
    ...
    _xpfpa_fpu_cw =                                                            \
        (_xpfpa_fpu_oldcw & ~_FPU_EXTENDED & ~_FPU_SINGLE) | _FPU_DOUBLE;      \
...
#define XPFPA_SWITCH_SINGLE()                                                  \
  do {                                                                         \
    _FPU_GETCW(_xpfpa_fpu_oldcw);                                              \
    _xpfpa_fpu_cw =                                                            \
        (_xpfpa_fpu_oldcw & ~_FPU_EXTENDED & ~_FPU_DOUBLE) | _FPU_SINGLE;      \
    _FPU_SETCW(_xpfpa_fpu_cw);                                                 \
  } while (0)
#define XPFPA_SWITCH_DOUBLE_EXTENDED()                                         \
  do {                                                                         \
    _FPU_GETCW(_xpfpa_fpu_oldcw);                                              \
    _xpfpa_fpu_cw =                                                            \
        (_xpfpa_fpu_oldcw & ~_FPU_SINGLE & ~_FPU_DOUBLE) | _FPU_EXTENDED;      \
    _FPU_SETCW(_xpfpa_fpu_cw);                                                 \
  } while (0)
...
#define XPFPA_DECLARE fp_prec_t _xpfpa_fpu_oldprec;

#define XPFPA_HAVE_CW 1
#define XPFPA_CW_DATATYPE fp_prec_t
