...
SAPI_API void sapi_add_request_header(char *var, unsigned int var_len,
...
SAPI_API int sapi_add_header_ex(char *header_line, size_t header_line_len,
...
SAPI_API int
sapi_register_default_post_reader(void (*default_post_reader)(void));
...
SAPI_API void
sapi_get_default_content_type_header(sapi_header_struct *default_header);
