...
typedef void (*php_rfc1867_get_detect_order_t)(const zend_encoding ***list,
                                               size_t *list_size);
typedef void (*php_rfc1867_set_input_encoding_t)(const zend_encoding *encoding);
typedef char *(*php_rfc1867_getword_t)(const zend_encoding *encoding,
                                       char **line, char stop);
typedef char *(*php_rfc1867_getword_conf_t)(const zend_encoding *encoding,
                                            char *str);
typedef char *(*php_rfc1867_basename_t)(const zend_encoding *encoding,
                                        char *str);
...
extern PHPAPI int (*php_rfc1867_callback)(unsigned int event, void *event_data,
                                          void **extra);
...
SAPI_API void php_rfc1867_set_multibyte_callbacks(
    ...
    php_rfc1867_getword_t getword, php_rfc1867_getword_conf_t getword_conf,
