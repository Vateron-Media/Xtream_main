...
CREDIT_LINE("DB-LIB (MS SQL, Sybase)",
...
CREDIT_LINE("fileinfo", "Ilia Alshanetsky, Pierre Alain Joye, Scott MacVicar, "
...
CREDIT_LINE("Internationalization",
            "Ed Batutis, Vladimir Iordanov, Dmitry Lakhtyuk, Stanislav "
...
CREDIT_LINE("Opcache", "Andi Gutmans, Zeev Suraski, Stanislav Malyshev, Dmitry "
                       "Stogov, Xinchen Hui");
CREDIT_LINE("OpenSSL",
