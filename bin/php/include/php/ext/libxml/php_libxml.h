...
PHP_LIBXML_API int php_libxml_increment_node_ptr(php_libxml_node_object *object,
                                                 xmlNodePtr node,
                                                 void *private_data);
PHP_LIBXML_API int
php_libxml_decrement_node_ptr(php_libxml_node_object *object);
PHP_LIBXML_API int php_libxml_increment_doc_ref(php_libxml_node_object *object,
                                                xmlDocPtr docp);
...
PHP_LIBXML_API zval *
php_libxml_register_export(zend_class_entry *ce,
...
PHP_LIBXML_API void
php_libxml_node_decrement_resource(php_libxml_node_object *object);
