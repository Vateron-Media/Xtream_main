...
struct st_mysqlnd_plugin__plugin_area_getters {
  void **(*get_connection_area)(const MYSQLND *conn,
                                const unsigned int plugin_id);
  void **(*get_connection_data_area)(const MYSQLND_CONN_DATA *conn,
                                     const unsigned int plugin_id);
  void **(*get_result_area)(const MYSQLND_RES *result,
                            const unsigned int plugin_id);
  void **(*get_unbuffered_area)(const MYSQLND_RES_UNBUFFERED *result,
                                const unsigned int plugin_id);
  void **(*get_result_buffered_area)(const MYSQLND_RES_BUFFERED_ZVAL *result,
                                     const unsigned int plugin_id);
  void **(*get_result_buffered_aread_c)(const MYSQLND_RES_BUFFERED_C *result,
                                        const unsigned int plugin_id);
  void **(*get_stmt_area)(const MYSQLND_STMT *stmt,
                          const unsigned int plugin_id);
  void **(*get_protocol_decoder_area)(
      const MYSQLND_PROTOCOL_PAYLOAD_DECODER_FACTORY *factory,
      const unsigned int plugin_id);
...
PHPAPI extern struct st_mysqlnd_plugin__plugin_area_getters
...
#define mysqlnd_plugin_get_plugin_result_buffered_data_zval(res, p_id)         \
  mysqlnd_plugin_area_getters.get_result_buffered_area((res), (p_id))
#define mysqlnd_plugin_get_plugin_result_buffered_data_c(res, p_id)            \
  mysqlnd_plugin_area_getters.get_result_buffered_aread_c((res), (p_id))
...
struct st_mysqlnd_plugin_methods_xetters {
  ...
  struct st_mnd_unbuffered_result_xetters {
    ...
    void (*set)(MYSQLND_CLASS_METHODS_TYPE(mysqlnd_result_unbuffered) *
                methods);
  } unbuffered_result;
...
PHPAPI extern struct st_mysqlnd_plugin_methods_xetters
...
#define mysqlnd_conn_get_methods()                                             \
  mysqlnd_plugin_methods_xetters.connection.get()
...
#define mysqlnd_result_set_methods(m)                                          \
  mysqlnd_plugin_methods_xetters.result.set((m))
...
#define mysqlnd_stmt_get_methods()                                             \
  mysqlnd_plugin_methods_xetters.statement.get()
#define mysqlnd_stmt_set_methods(m)                                            \
  mysqlnd_plugin_methods_xetters.statement.set((m))

#define mysqlnd_protocol_get_methods()                                         \
  mysqlnd_plugin_methods_xetters.protocol.get()
#define mysqlnd_protocol_set_methods(m)                                        \
  mysqlnd_plugin_methods_xetters.protocol.set((m))
...
#define mysqlnd_command_get_methods()                                          \
  mysqlnd_plugin_methods_xetters.command.get()
#define mysqlnd_command_set_methods(m)                                         \
  mysqlnd_plugin_methods_xetters.command.set((m))

#define mysqlnd_error_info_get_methods()                                       \
  mysqlnd_plugin_methods_xetters.error_info.get()
