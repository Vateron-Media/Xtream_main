...
#define float8get(V, M)                                                        \
  {                                                                            \
    ((float8get_union *)&(V))->m[0] = *((zend_long *)(M));                     \
    ((float8get_union *)&(V))->m[1] = *(((zend_long *)(M)) + 1);               \
  }
#define float8store(T, V)                                                      \
  {                                                                            \
    *((zend_long *)(T)) = ((float8get_union *)&(V))->m[0];                     \
...
/* If we haven't defined sint2korr, which is because the platform is not x86 or
 * it's WIN64 */
#ifndef sint2korr
#define sint2korr(A)                                                           \
  (int16_t)(((int16_t)((zend_uchar)(A)[0])) + ((int16_t)((int16_t)(A)[1]) << 8))
#define sint3korr(A)                                                           \
  ((int32_t)((((zend_uchar)(A)[2]) & 128)                                      \
                 ? (((uint32_t)255L << 24) |                                   \
                    (((uint32_t)(zend_uchar)(A)[2]) << 16) |                   \
                 ...
                 : (((uint32_t)(zend_uchar)(A)[2]) << 16) |                    \
                       ...
                       ((uint32_t)(zend_uchar)(A)[0])))
#define sint4korr(A)                                                           \
  (int32_t)(((uint32_t)((A)[0])) + (((uint32_t)((A)[1]) << 8)) +               \
