...
#define PHP_MBREGEX_FUNCTION_ENTRIES                                           \
  ...
  PHP_DEP_FALIAS(mbregex_encoding, mb_regex_encoding,                          \
  ...
  PHP_DEP_FALIAS(mbereg_search_pos, mb_ereg_search_pos,                        \
                 arginfo_mb_ereg_search_pos)                                   \
  PHP_DEP_FALIAS(mbereg_search_regs, mb_ereg_search_regs,                      \
                 arginfo_mb_ereg_search_regs)                                  \
  PHP_DEP_FALIAS(mbereg_search_init, mb_ereg_search_init,                      \
                 arginfo_mb_ereg_search_init)                                  \
  PHP_DEP_FALIAS(mbereg_search_getregs, mb_ereg_search_getregs,                \
                 arginfo_mb_ereg_search_getregs)                               \
  PHP_DEP_FALIAS(mbereg_search_getpos, mb_ereg_search_getpos,                  \
                 arginfo_mb_ereg_search_getpos)                                \
  PHP_DEP_FALIAS(mbereg_search_setpos, mb_ereg_search_setpos,                  \
