...
$rTables = array("admin_settings", "blocked_ips", "blocked_user_agents", "bouquets", "enigma2_devices", "epg", "mag_devices", "member_groups", "packages", "reg_users", "rtmp_ips", "series", "series_episodes", "settings", "stream_categories", "stream_subcategories", "streaming_servers", "streams", "streams_options", "streams_servers", "subreseller_setup", "tickets", "tickets_replies", "transcoding_profiles", "users", "watch_categories", "watch_folders", "watch_settings");
