                                                ...
                                                <tr id="group-<?= $rGroup["group_id"] ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input disabled data-id="<?= $rGroup["group_id"] ?>" data-name="is_admin" type="checkbox" class="custom-control-input" id="is_admin_<?= $rGroup["group_id"] ?>" name="is_admin" <?php if ($rGroup["is_admin"]) {
                                                                                                                                                                                                                                                echo " checked";
                                                                                                                                                                                                                                            } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input disabled data-id="<?= $rGroup["group_id"] ?>" data-name="is_reseller" type="checkbox" class="custom-control-input" id="is_reseller_<?= $rGroup["group_id"] ?>" name="is_reseller" <?php if ($rGroup["is_reseller"]) {
                                                                                                                                                                                                                                                            echo " checked";
                                                                                                                                                                                                                                                        } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input disabled data-id="<?= $rGroup["group_id"] ?>" data-name="is_banned" type="checkbox" class="custom-control-input" id="is_banned_<?= $rGroup["group_id"] ?>" name="is_banned" <?php if ($rGroup["is_banned"]) {
                                                                                                                                                                                                                                                    echo " checked";
                                                                                                                                                                                                                                                } ?>>
