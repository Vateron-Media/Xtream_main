                                    ...
                                    <div class="tab-pane" id="bouquet-details">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="bouquet_name"
                                                            name="bouquet_name" value="<?php if (isset($rBouquetArr)) {
                                        ...
                                        <ul class="list-inline wizard mb-0">
                                            <li class="next list-inline-item float-right">
                                                ...
                                                <?php } else { ?>
                                                    <input name="submit_bouquet" type="submit" class="btn btn-primary"
                                                        value="<?= $_["add"] ?>" />
                                                <?php } ?>
                                            </li>
                                        </ul>
                                    ...
                                    <?php if (isset($rBouquetArr)) { ?>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" id="radios_search"
                                                                value="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="tab-pane" id="review">
                                            ...
                                            <ul class="list-inline wizard mb-0">
                                                ...
                                                <li class="next list-inline-item float-right">
                                                    <input name="submit_bouquet" type="submit" class="btn btn-primary"
                                                        value="<?php if (isset($rBouquetArr)) {
                                                            echo $_["edit"];
                                                        } else {
                                                            echo $_["add"];
                                                        } ?>" />
