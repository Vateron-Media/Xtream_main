...
if (isset(CoreUtilities::$request["submit_movie"])) {
    ...
    $categoriesIDs = CoreUtilities::$request["category_id"];
    ...
    if (!empty($_FILES['m3u_file']['tmp_name'])) {
        ...
        $rImportArray = array("stream_source" => array(CoreUtilities::$request["stream_source"]), "stream_icon" => $rArray["stream_icon"], "stream_display_name" => $rArray["stream_display_name"], "movie_properties" => array(), "async" => false);
        if (strlen(CoreUtilities::$request["tmdb_id"]) > 0) {
            $rTMDBURL = "https://www.themoviedb.org/movie/" . CoreUtilities::$request["tmdb_id"];
        } else {
            $rTMDBURL = "";
        }
    ...
    if (count($rImportStreams) > 0) {
        ...
        if (isset($_FILES["m3u_file"])) {
            ...
            exit;
        } elseif (!isset(CoreUtilities::$request["id"])) {
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li>
                                <a href="./movies.php<?php if (isset(CoreUtilities::$request["category"])) {
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form<?php if (isset(CoreUtilities::$request["import"])) {
                            echo " enctype=\"multipart/form-data\"";
                        } ?> action="./movie.php<?php if (isset(CoreUtilities::$request["import"])) {
                              echo "?import";
                          } elseif (isset(CoreUtilities::$request["id"])) {
                                                    ...
                                                    <div class="form-group row mb-4 stream-url">
                                                        ...
                                                        <div class="col-md-8 input-group">
                                                            <input type="text" id="stream_source" name="stream_source"
                                                                class="form-control" value="<?= $rMovieSource ?>" required
                                                                data-parsley-trigger="change">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-8 input-group">
                                                                <input type="text" id="import_folder" name="import_folder"
                                                                    class="form-control" value="<?= $rMovieSource ?>">
                                                                <div class="input-group-append">
                                                                    <a href="#file-browser" id="filebrowser"
                                                                        class="btn btn-primary waves-effect waves-light"><i
                                                                            class="mdi mdi-folder-open-outline"></i></a>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        <input type="text" class="form-control" id="movie_image"
                                                            name="movie_image" value="<?php if (isset($rMovie)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        <input type="text" class="form-control" id="backdrop_path"
                                                            name="backdrop_path" value="<?php if (isset($rMovie)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="director"
                                                            name="director" value="<?php if (isset($rMovie)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="releasedate"
                                                            name="releasedate" value="<?php if (isset($rMovie)) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="episode_run_time"
                                                            name="episode_run_time" value="<?php if (isset($rMovie)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="youtube_trailer"
                                                            name="youtube_trailer" value="<?php if (isset($rMovie)) {
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input name="read_native" id="read_native" type="checkbox" <?php if (isset($rMovie)) {
                                                    ...
                                                    <?php if (!isset(CoreUtilities::$request["import"])) { ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control" id="custom_sid"
                                                                name="custom_sid" value="<?php if (isset($rMovie)) {
                                                    ...
                                                    <div class="form-group row mb-4 stream-url">
                                                        <label class="col-md-4 col-form-label"
                                                            ...
                                                            <i data-toggle="tooltip" data-placement="top" title=""
                                                                ...
                                                                class="mdi mdi-information"></i></label>
                                                        <div class="col-md-8 input-group">
                                                            <input type="text" id="movie_subtitles" name="movie_subtitles"
                                                                class="form-control" value="<?php if (isset($rMovie)) {
                                    ...
                                    <div class="tab-pane" id="load-balancing">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="restart_on_edit"><?php if (isset($rMovie)) {
                                        ...
                                        <ul class="list-inline wizard mb-0">
                                            ...
                                            <li class="list-inline-item float-right">
                                                <input name="submit_movie" type="submit" class="btn btn-primary" value="<?php if (isset($rMovie)) {
                                                    echo "Edit";
                                                } else {
                                                    echo "Add";
                                                } ?>" />
                                            ...
                                            <div class="col-md-8 input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-warning waves-effect waves-light" type="button"
                                                        onClick="clearSearch()"><i class="mdi mdi-close"></i></button>
                                                    <button class="btn btn-primary waves-effect waves-light" type="button"
                                                        id="doSearch"><i class="mdi mdi-magnify"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
