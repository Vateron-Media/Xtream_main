                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="epg_name"
                                                            name="epg_name" value="<?php if (isset($rEPGArr)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="epg_file"
                                                            name="epg_file" value="<?php if (isset($rEPGArr)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="days_keep"
                                                            name="days_keep" value="<?php if (isset($rEPGArr)) {
