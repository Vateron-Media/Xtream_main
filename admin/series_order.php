                                    ...
                                    <?php foreach ($rSeasons as $rSeasonNum => $rSeasonArray) { ?>
                                        <div class="tab-pane" id="season-<?= $rSeasonNum ?>">
                                            <div class="row">
                                                <div class="col-12">
                                                    <p class="sub-header">
                                                        <?= $_["to_re-order"] ?> <i class="mdi mdi-chevron-up"></i>
                                                        <?= $_["and"] ?> <i class="mdi mdi-chevron-down"></i>
                                            ...
                                            <ul class="list-inline wizard mb-0 add-margin-top-20">
                                                <li class="list-inline-item">
                                                    <a href="javascript: void(0);" onClick="MoveUp(<?= $rSeasonNum ?>)"
                                                        class="btn btn-purple"><i class="mdi mdi-chevron-up"></i></a>
                                                    <a href="javascript: void(0);" onClick="MoveDown(<?= $rSeasonNum ?>)"
                                                        class="btn btn-purple"><i class="mdi mdi-chevron-down"></i></a>
                                                    <a href="javascript: void(0);" onClick="AtoZ(<?= $rSeasonNum ?>)"
