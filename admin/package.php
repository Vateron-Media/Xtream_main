                        ...
                        <form action="./package.php<?php if (isset(ipTV_lib::$request["id"])) {
                            ...
                            <div id="basicwizard">
                                <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                    <li class="nav-item">
                                        <a href="#package-details" data-toggle="tab"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="package_name"><?= $_["package_name"] ?></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="package_name"
                                                            name="package_name" value="<?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="is_trial"><?= $_["is_trial"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="is_trial" id="is_trial" type="checkbox" <?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="trial_credits"><?= $_["trial_credits"] ?></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="trial_credits"
                                                            name="trial_credits" onkeypress="return isNumberKey(event)"
                                                            value="<?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="trial_duration"><?= $_["trial_duration"] ?></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="trial_duration"
                                                            name="trial_duration" value="<?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="trial_duration_in"><?= $_["trial_duration_in"] ?></label>
                                                    <div class="col-md-2">
                                                        <select name="trial_duration_in" id="trial_duration_in"
                                                            class="form-control select2" data-toggle="select2">
                                                            <?php foreach (array($_["hours"] => "hours", $_["days"] => "Days") as $rText => $rOption) { ?>
                                                                <option <?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="is_official"><?= $_["is_official"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="is_official" id="is_official" type="checkbox" <?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="official_credits"><?= $_["official_credits"] ?></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="official_credits"
                                                            name="official_credits"
                                                            onkeypress="return isNumberKey(event)" value="<?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="official_duration"><?= $_["official_duration"] ?></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="official_duration"
                                                            name="official_duration" value="<?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="official_duration_in"><?= $_["official_duration_in"] ?></label>
                                                    <div class="col-md-2">
                                                        <select name="official_duration_in" id="official_duration_in"
                                                            class="form-control select2" data-toggle="select2">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="can_gen_mag"><?= $_["can_generate_mag"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="can_gen_mag" id="can_gen_mag" type="checkbox" <?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="only_mag"><?= $_["mag_only"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="only_mag" id="only_mag" type="checkbox" <?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="can_gen_e2"><?= $_["can_generate_enigma"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="can_gen_e2" id="can_gen_e2" type="checkbox" <?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="only_e2"><?= $_["enigma_only"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="only_e2" id="only_e2" type="checkbox" <?php if (isset($rPackage)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="lock_device"><?= $_["lock_stb_device"] ?></label>
                                                    <div class="col-md-2">
                                                        <input name="lock_device" id="lock_device" type="checkbox" <?php if (isset($rPackage)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        for="is_restreamer"><?= $_["can_restream"] ?></label>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="max_connections"
                                                            name="max_connections" value="<?php if (isset($rPackage)) {
                                                        ...
                                                        <?php foreach (getOutputs() as $rOutput) { ?>
                                                            <div class="checkbox form-check-inline">
                                                                <input data-size="large" type="checkbox"
                                                                    ...
                                                                    name="output_formats[]"
                                                                    value="<?= $rOutput["access_output_id"] ?>" <?php if (isset($rPackage)) {
                                                                ...
                                                                <label
                                                                    for="output_formats_<?= $rOutput["access_output_id"] ?>">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="custom-control custom-checkbox mt-1">
                                                                <input type="checkbox"
                                                                    ...
                                                                    id="group-<?= $rGroup["group_id"] ?>"
                                                                    data-id="<?= $rGroup["group_id"] ?>" name="groups[]"
                                                                    value="<?= $rGroup["group_id"] ?>" <?php if (isset($rPackage)) {
                                                                          if (in_array($rGroup["group_id"], json_decode($rPackage["groups"], true))) {
                                                                              echo " checked";
                                                                          }
                                                                      } ?>>
                                                                <label class="custom-control-label"
                                                                    for="group-<?= $rGroup["group_id"] ?>"><?= $rGroup["group_name"] ?></label>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                        ...
                                        <ul class="list-inline wizard mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                <a href="javascript: void(0);" onClick="selectAll()"
                                                    class="btn btn-secondary"><?= $_["select_all"] ?></a>
                                                <a href="javascript: void(0);" onClick="selectNone()"
                                                    class="btn btn-secondary"><?= $_["deselect_all"] ?></a>
                                            </li>
                                            <li class="next list-inline-item float-right">
                                                <a href="javascript: void(0);"
                                                    class="btn btn-secondary"><?= $_["next"] ?></a>
                                    ...
                                    <div class="tab-pane" id="bouquets">
                                        ...
                                        <ul class="list-inline wizard mb-0">
                                            ...
                                            <li class="list-inline-item float-right">
                                                ...
                                                <input name="submit_package" type="submit" class="btn btn-primary"
                                                    value="<?php if (isset($rPackage)) {
                                                        echo $_["edit"];
                                                    } else {
                                                        echo $_["add"];
