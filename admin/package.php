                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="./packages.php">
                                            <li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> <?= $_["back_to_packages"] ?></li>
                                        </a>
                                    </ol>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="is_restreamer" id="is_restreamer" type="checkbox" <?php if (isset($rPackage)) {
