                                    ...
                                    <form id="station_form">
                                        <div class="form-group row mb-4">
                                            <?php if ($rPermissions["is_reseller"]) { ?>
                                                ...
                                                <div class="col-md-3">
                                                    <select id="station_category_id" class="form-control"
                                                        data-toggle="select2">
                                                ...
                                                <div class="col-md-3">
                                                    <select id="station_server_id" class="form-control"
                                                        data-toggle="select2">
                                                ...
                                                <div class="col-md-2">
                                                    <select id="station_show_entries" class="form-control"
                                                        data-toggle="select2">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="col-md-2">
                                                    <select id="station_filter" class="form-control" data-toggle="select2">
                                                        <option value="" <?php if (!isset($_GET["filter"])) {
                                                            echo " selected";
                                                        } ?>><?= $_["no_filter"] ?></option>
                                                        <option value="1" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 1)) {
                                                            echo " selected";
                                                        } ?>><?= $_["online"] ?></option>
                                                        <option value="2" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 2)) {
                                                            echo " selected";
                                                        } ?>><?= $_["down"] ?></option>
                                                        <option value="3" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 3)) {
                                                            echo " selected";
                                                        } ?>><?= $_["stopped"] ?></option>
                                                        <option value="4" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 4)) {
                                                            echo " selected";
                                                        } ?>><?= $_["starting"] ?></option>
                                                        <option value="5" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 5)) {
                                                            echo " selected";
                                                        } ?>><?= $_["on_demand"] ?></option>
                                                        <option value="6" <?php if ((isset($_GET["filter"])) && ($_GET["filter"] == 6)) {
                                                            echo " selected";
                                                        } ?>><?= $_["direct"] ?></option>
                                                    </select>
                                                </div>
