...
if (isset(CoreUtilities::$request["submit_series"])) {
    ...
    if (strlen(CoreUtilities::$request["backdrop_path"]) == 0) {
        $rArray["backdrop_path"] = array();
    } else {
        $rArray["backdrop_path"] = array(CoreUtilities::$request["backdrop_path"]);
    }
    unset(CoreUtilities::$request["backdrop_path"]);
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="./serie.php<?php if (isset(CoreUtilities::$request["id"])) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        <input type="text" class="form-control" id="backdrop_path"
                                                            name="backdrop_path" value="<?php if (isset($rSeries)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="director"
                                                            name="director" value="<?php if (isset($rSeries)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="releaseDate"
                                                            name="releaseDate" value="<?php if (isset($rSeries)) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="episode_run_time"
                                                            name="episode_run_time" value="<?php if (isset($rSeries)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="youtube_trailer"
                                                            name="youtube_trailer" value="<?php if (isset($rSeries)) {
