                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="./groups.php">
                                            <li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> <?= $_["back_to_groups"] ?></li>
                                        </a>
                                    </ol>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="./group.php<?php if (isset($_GET["id"])) {
                                                                    echo "?id=" . $_GET["id"];
                                                                } ?>" method="POST" id="group_form" data-parsley-validate="">
                                        <?php if (isset($rGroup)) { ?>
                                                ...
                                                <div class="tab-pane" id="group-details">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" id="group_name" name="group_name" value="<?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="is_admin" id="is_admin" type="checkbox" <?php if (isset($rGroup)) {
                                                                                                                                if ($rGroup["is_admin"]) {
                                                                                                                                    echo "checked ";
                                                                                                                                }
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="is_reseller" id="is_reseller" type="checkbox" <?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="is_banned" id="is_banned" type="checkbox" <?php if (isset($rGroup)) {
                                                                                                                                if ($rGroup["is_banned"]) {
                                                                                                                                    echo "checked ";
                                                                                                                                }
                                                                                                                            } ?>data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    ...
                                                    <ul class="list-inline wizard mb-0">
                                                        <li class="list-inline-item float-right">
                                                            <input name="submit_group" type="submit" class="btn btn-primary" value="<?php if (isset($rGroup)) {
                                                                                                                                        echo $_["edit"];
                                                                                                                                    } else {
                                                                                                                                        echo $_["add"];
                                                                                                                                    } ?>" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control" id="total_allowed_gen_trials" name="total_allowed_gen_trials" value="<?php if (isset($rGroup)) {
                                                                    ...
                                                                    <select name="total_allowed_gen_in" id="total_allowed_gen_in" class="form-control select2" data-toggle="select2">
                                                                        <?php foreach (array("Day", "Month") as $rOption) { ?>
                                                                            <option <?php if (isset($rGroup)) {
                                                                                    ...
                                                                                    } ?>value="<?= strtolower($rOption) ?>"><?= $rOption ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="create_sub_resellers" id="create_sub_resellers" type="checkbox" <?php if (isset($rGroup)) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control" id="create_sub_resellers_price" name="create_sub_resellers_price" value="<?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="allow_change_pass" id="allow_change_pass" type="checkbox" <?php if (isset($rGroup)) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="allow_download" id="allow_download" type="checkbox" <?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="reset_stb_data" id="reset_stb_data" type="checkbox" <?php if (isset($rGroup)) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="reseller_client_connection_logs" id="reseller_client_connection_logs" type="checkbox" <?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="delete_users" id="delete_users" type="checkbox" <?php if (isset($rGroup)) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control" id="minimum_trial_credits" name="minimum_trial_credits" value="<?php if (isset($rGroup)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="reseller_can_select_bouquets" id="reseller_can_select_bouquets" type="checkbox" <?php if (isset($rGroup)) {
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="allow_import" id="allow_import" type="checkbox" <?php if (isset($rGroup)) {
