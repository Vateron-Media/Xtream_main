                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" id="series_name"
                                                                name="series_name" value="<?= $rSeries["title"] ?>"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control text-center"
                                                                id="season_num" name="season_num" placeholder="" value="<?php if (isset($rEpisode)) {
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control text-center" id="episode"
                                                                name="episode" placeholder="" value="<?php if (isset($rEpisode)) {
                                                    ...
                                                    <div class="form-group row mb-4 stream-url">
                                                        ...
                                                        <div class="col-md-8 input-group">
                                                            <input type="text" id="stream_source" name="stream_source"
                                                                class="form-control" value="<?= $rEpisodeSource ?>" required
                                                                data-parsley-trigger="change">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control text-center"
                                                                ...
                                                                placeholder="<?= $_["season"] ?>" value="" required
                                                                data-parsley-trigger="change">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-4 stream-url">
                                                        ...
                                                        <div class="col-md-8 input-group">
                                                            <input type="text" id="season_folder" name="season_folder"
                                                                readonly class="form-control" value="" required
                                                                data-parsley-trigger="change">
                                                            <div class="input-group-append">
                                                                <a href="#file-browser" id="filebrowser"
                                                                    class="btn btn-primary waves-effect waves-light"><i
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        <div class="col-md-6">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="addName1" name="addName1" checked>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input"
                                                                    id="addName2" name="addName2" checked>
                                                                <label class="custom-control-label"
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        <input type="text" class="form-control" id="movie_image"
                                                            name="movie_image" value="<?php if (isset($rEpisode)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="releasedate"
                                                            name="releasedate" value="<?php if (isset($rEpisode)) {
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="episode_run_time"
                                                            name="episode_run_time" value="<?php if (isset($rEpisode)) {
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control" id="custom_sid"
                                                                name="custom_sid" value="<?php if (isset($rEpisode)) {
                                                    ...
                                                    <div class="form-group row mb-4">
                                                        ...
                                                        <div class="col-md-8 input-group">
                                                            <input type="text" id="movie_subtitles" name="movie_subtitles"
                                                                class="form-control" value="<?php if (isset($rEpisode)) {
                                    ...
                                    <div class="tab-pane" id="load-balancing">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="restart_on_edit"><?php if (isset($rEpisode)) {
