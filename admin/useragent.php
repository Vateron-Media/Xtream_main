                        ...
                        <form action="./useragent.php<?php if (isset(ipTV_lib::$request["id"])) {
                            ...
                            <div id="basicwizard">
                                <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                    <li class="nav-item">
                                        <a href="#useragent-details" data-toggle="tab"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="user_agent"><?= $_["user-agent"] ?></label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="user_agent"
                                                            name="user_agent" value="<?php if (isset($rUAArr)) {
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="exact_match"><?= $_["exact_match"] ?></label>
                                                    <div class="col-md-2">
