                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="server_name"
                                                            name="server_name" value="" required
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="server_ip"
                                                            name="server_ip" value="" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                        for="ssh_port"><?= $_["ssh_port"] ?></label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="ssh_port"
                                                            name="ssh_port" value="22" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="http_broadcast_port"
                                                            name="http_broadcast_port" value="25461" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="25463" required data-parsley-trigger="change">
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                        for="rtmp_port"><?= $_["rtmp_port"] ?></label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="rtmp_port"
                                                            name="rtmp_port" value="25462" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
