                        ...
                        <form action="./bouquet_order.php?id=<?= CoreUtilities::$request["id"] ?>" method="POST"
                            ...
                            <div id="basicwizard">
                                <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                    <li class="nav-item">
                                        <a href="#bouquet-stream" data-toggle="tab"
                                    ...
                                    <li class="nav-item">
                                        <a href="#bouquet-series" data-toggle="tab"
                                            class="nav-link rounded-0 pt-2 pb-2">
                                    ...
                                    <li class="nav-item">
                                        <a href="#bouquet-stations" data-toggle="tab"
                                            class="nav-link rounded-0 pt-2 pb-2">
                                        ...
                                        <ul class="list-inline wizard mb-0 add-margin-top-20">
                                            <li class="list-inline-item">
                                                ...
                                                <a href="javascript: void(0);" onClick="MoveTop('stream')"
                                                    class="btn btn-pink"><i class="mdi mdi-chevron-triple-up"></i></a>
                                                <a href="javascript: void(0);" onClick="MoveBottom('stream')"
                                                    class="btn btn-pink"><i class="mdi mdi-chevron-triple-down"></i></a>
                                        ...
                                        <ul class="list-inline wizard mb-0 add-margin-top-20">
                                            <li class="list-inline-item">
                                                ...
                                                <a href="javascript: void(0);" onClick="MoveTop('series')"
                                                    class="btn btn-pink"><i class="mdi mdi-chevron-triple-up"></i></a>
                                                <a href="javascript: void(0);" onClick="MoveBottom('series')"
                                                    class="btn btn-pink"><i class="mdi mdi-chevron-triple-down"></i></a>
