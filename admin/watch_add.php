                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8 input-group">
                                                        <input type="text" id="selected_path" name="selected_path"
                                                            class="form-control" value="<?php if (isset($rFolder)) {
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4" id="category_movie" <?php if (isset($rFolder)) {
                                                    ...
                                                    <div class="col-md-8">
                                                        <select name="category_id_movie" id="category_id_movie"
                                                ...
                                                <div class="form-group row mb-4" id="category_series" <?php if (isset($rFolder)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        ...
                                                        <i data-toggle="tooltip" data-placement="top" title=""
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-8">
                                                        <select name="category_id_series" id="category_id_series"
                                                            class="form-control select2" data-toggle="select2">
                                                            <option <?php if (isset($rFolder)) {
                                                                if (intval($rFolder["category_id"]) == 0) {
                                                                    echo "selected ";
                                                ...
                                                <div class="form-group row mb-4" id="fb_category_movie" <?php if (isset($rFolder)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        ...
                                                        <i data-toggle="tooltip" data-placement="top" title=""
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-8">
                                                        <select name="fb_category_id_movie" id="fb_category_id_movie"
                                                            class="form-control select2" data-toggle="select2">
                                                            <option <?php if (isset($rFolder)) {
                                                ...
                                                <div class="form-group row mb-4" id="fb_category_series" <?php if (isset($rFolder)) {
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        ...
                                                        <i data-toggle="tooltip" data-placement="top" title=""
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-8">
                                                        <select name="fb_category_id_series" id="fb_category_id_series"
                                                            class="form-control select2" data-toggle="select2">
                                                            <option <?php if (isset($rFolder)) {
                                                                if (intval($rFolder["fb_category_id"]) == 0) {
                                                                    echo "selected ";
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        ...
                                                        <i data-toggle="tooltip" data-placement="top" title=""
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-8">
                                                        <select name="allowed_extensions[]" id="allowed_extensions"
                                                            class="form-control select2-multiple" data-toggle="select2"
