                        ...
                        <table id="datatable"
                            ...
                            <tbody>
                                <?php foreach (getSecurityCenter() as $rIP) {
                                    ?>
                                        <tr id="ip-<?= $rIP["id"] ?>">
                                            <td class="text-center"><a href="./user.php?id=<?= $rIP["id"] ?>"><?= $rIP["id"] ?>
                                            </td>
                                            ...
                                            <td class="text-center"><a href="./user.php?id=<?= $rIP["id"] ?>"><button
                                                        type="button"
                                ...
                                <?php foreach (getLeakedLines() as $rIP) {
                                    ?>
                                        <tr id="ip-<?= $rIP["id"] ?>">
                                            ...
                                            <td class="text-center"><a href="./user.php?id=<?= $rIP["user_id"] ?>"><button
                                                        type="button"
                                                        class="btn btn-outline-danger waves-effect waves-light btn-xs"><i
                                                            class="far fa-eye"></i></button></a></td>
                                            <!--<td class="text-center"><?php
