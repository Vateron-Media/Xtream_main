        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><?= $_["stream_logs"] ?> </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control text-center date" id="range" name="range"
                                    ...
                                    placeholder="<?= $_["all_dates"] ?>">
                            </div>
                            <label class="col-md-1 col-form-label text-center" for="show_entries"><?= $_["show"] ?>
                            </label>
                            <div class="col-md-1">
