                                ...
                                <?php foreach ($rServers as $rServer) {
                                    ...
                                    <tr id="server-<?= $rServer["id"] ?>">
                                        ...
                                        <td class="text-center" data-toggle="tooltip" data-placement="top" title=""
                                            data-original-title="<?= $rServerText ?>"><i
                                            ...
                                            <?php if (hasPermissions("adv", "edit_server")) { ?>
                                                <div class="btn-group">
                                                    <button type="button" data-toggle="tooltip" data-placement="top" title=""
                                                        ...
                                                        data-id="<?= $rServer["id"] ?>"><i class="mdi mdi-restart"></i></button>
                                                    <button type="button" data-toggle="tooltip" data-placement="top" title=""
                                                    ...
                                                    <button type="button" data-toggle="tooltip" data-placement="top" title=""
                                                        data-original-title="<?= $_["stop_all_streams"] ?>"
                                                        class="btn btn-light waves-effect waves-light btn-xs"
...
<div class="modal fade bs-server-modal-center" tabindex="-1" role="dialog" aria-labelledby="restartServicesLabel"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row mb-4">
                    <label class="col-md-3 col-form-label" for="root_password"><?= $_["ssh_password"] ?></label>
                    <div class="col-md-5">
