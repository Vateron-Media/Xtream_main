...
$_ = array(
  ...
  "detect_restream_block_user" => "XtreamCodes Detect - Ban Lines",
  "desc_detect_restream_block_user" => "Ban lines of non-restreamers who are trying to use XtreamCodes to restream.",
