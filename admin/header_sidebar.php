            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                            ...
                            <a href="./flood_login.php" class="dropdown-item notify-item"><span class="mdi mdi-account-alert mdi-18px"> <span>Logins Flood</span></a>
                            <?php }
                ...
                <div class="logo-box">
                    <a href="<?php if ($rPermissions["is_admin"]) { ?>dashboard.php<?php } else { ?>reseller.php<?php } ?>" class="logo text-center">
                        ...
                        <span class="logo-sm">
                            <img src="<?=$rSettings["logo_url_sidebar"]?>" alt="" height="26">
                        </span>
                    </a>
                </div>
                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        <ul class="metismenu" id="side-menu">
                            <li>
                                <a href="./<?php if ($rPermissions["is_admin"]) { ?>dashboard.php<?php } else { ?>reseller.php<?php } ?>"><i class="mdi mdi-view-dashboard-outline mdi-18px text-purple"></i><span><?=$_["dashboard"]?></span></a>
                            </li>
                            <?php if (($rPermissions["is_reseller"]) && ($rPermissions["reseller_client_connection_logs"])) { ?>
                            <li>
								<a href="#"><i class="mdi mdi-information-outline mdi-18px text-danger"></i><span><?=$_["logs"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="./live_connections.php"><span class="mdi mdi-account-network-outline mdi-18px"></span> <?=$_["live_connections"]?></a></li>
                            ...
                            <li>
                                <a href="#"><i class="mdi mdi-server-network mdi-18px text-warning"></i><span><?=$_["servers"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
									<?php if (hasPermissions("adv", "add_server")) { ?>
                                    <li><a href="./server.php"><span class="mdi mdi-upload-network-outline mdi-18px"></span> <?=$_["add_existing_lb"]?></a></li>
                                    <li><a href="./install_server.php"><span class="mdi mdi-plus-network-outline mdi-18px"> <?=$_["install_load_balancer"]?></a></li>
									<?php }
									if (hasPermissions("adv", "servers")) { ?>
                                    <li><a href="./servers.php"><span class="mdi mdi-server-network mdi-18px"></span> <?=$_["manage_servers"]?></a></li>
									<?php } 
									if (hasPermissions("adv", "servers")) { ?>
							...
							<li>
                                <a href="#"> <i class="mdi mdi-account-multiple-outline mdi-18px text-primary"></i><span><?=$_["reg_users"]?></span> <span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (hasPermissions("adv", "add_reguser")) { ?>
                                    <li><a href="./reg_user.php"><span class="mdi mdi-account-multiple-plus-outline mdi-18px"> <?=$_["add_registered_user"]?></a></li>
									<?php }
							...
							<li>
                                <a href="#"> <i class="mdi mdi-account-outline mdi-18px text-pink"></i><span><?=$_["users"]?> </span><span class="arrow-down"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (hasPermissions("adv", "add_user")) { ?>
                                    <li><a href="./user.php"><span class="mdi mdi-account-plus-outline mdi-18px"></span> <?=$_["add_user"]?></a></li>
									<?php }
									if (hasPermissions("adv", "users")) { ?>
                                    <li><a href="./users.php"><span class="mdi mdi-account-multiple-outline mdi-18px"> <?=$_["manage_users"]?></a></li>
									<?php }
									if ((hasPermissions("adv", "add_mag")) OR (hasPermissions("adv", "manage_mag"))) { ?>
                                    <div class="separator"></div>
                                    <?php }
									 if (hasPermissions("adv", "add_mag")) { ?>
                                    <li><a href="./user.php?mag"><span class="mdi mdi-account-plus-outline mdi-18px"></span> <?=$_["add_mag"]?></a></li>
                                    <!--<li><a href="./mag.php"><?=$_["link_mag"]?></a></li>-->
									<?php }
									if (hasPermissions("adv", "manage_mag")) { ?>
                                    <li><a href="./mags.php"><span class="mdi mdi-account-multiple-outline mdi-18px"> <?=$_["manage_mag_devices"]?></a></li>
									<?php }
									if (hasPermissions("adv", "add_mag")) { ?>
									<li><a href="./mag.php"><span class="mdi mdi-account-switch mdi-18px"> <?=$_["link_mag"]?></a></li>
									<?php }
                                    if ((hasPermissions("adv", "add_e2")) OR (hasPermissions("adv", "manage_e2"))) { ?>
                                    <div class="separator"></div>
                                    <?php }
									if (hasPermissions("adv", "add_e2")) { ?>
                                    <li><a href="./user.php?e2"><span class="mdi mdi-account-plus-outline mdi-18px"></span> <?=$_["add_enigma"]?></a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="./reg_user.php"><span class="mdi mdi-account-multiple-plus-outline mdi-18px"> <?=$_["add_subreseller"]?></a></li>
                                    <?php } else { ?>
                                    <li><a href="./subreseller.php"><span class="mdi mdi-account-multiple-plus-outline mdi-18px"> <?=$_["add_subreseller"]?></a></li>
                                    <?php } ?>
                            ...
                            <li>
                                <a href="#"> <i class="mdi mdi-video-outline mdi-18px text-success"></i><span><?=$_["vod"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
									<?php if (hasPermissions("adv", "add_movie")) { ?>
                                            <li><a href="./movie.php"><span class="mdi mdi-plus mdi-18px"> <?=$_["add_movie"]?></a></li>
											<?php }
											if (hasPermissions("adv", "movies")) { ?>
                                            <li><a href="./movies.php"><span class="mdi mdi-movie mdi-18px"> <?=$_["manage_movies"]?></a></li>
											<?php }
                                            ...
                                            <li><a href="./serie.php"><span class="mdi mdi-plus mdi-18px"> <?=$_["add_series"]?></a></li>
											<?php }
											if (hasPermissions("adv", "series")) { ?>
                                            <li><a href="./series.php"><span class="mdi mdi-youtube-tv mdi-18px"> <?=$_["manage_series"]?></a></li>
											<?php }
											if (hasPermissions("adv", "episodes")) { ?>
                                            <li><a href="./episodes.php"><span class="mdi mdi-youtube-tv mdi-18px"> <?=$_["manage_episodes"]?></a></li>
											<?php }
                                            ...
                                            <li><a href="./radio.php"><span class="mdi mdi-plus mdi-18px"> <?=$_["add_station"]?></a></li>
											<?php }
                            ...
                            <li>
                                <a href="#"> <i class="mdi mdi-play-circle-outline mdi-18px text-info"></i><span><?=$_["streams"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
									<?php if (hasPermissions("adv", "add_stream")) { ?>
                                    <li><a href="./stream.php"><span class="mdi mdi-plus mdi-18px"> <?=$_["add_stream"]?></a></li>
									<?php }
									if (hasPermissions("adv", "streams")) { ?>
                                    <li><a href="./streams.php"><span class="mdi mdi-play-circle-outline mdi-18px"> <?=$_["manage_streams"]?></a></li>
									<?php }
                            ...
                            <li>
                                <a href="#"> <i class="mdi mdi-flower-tulip-outline text-purple"></i><span><?=$_["bouquets"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
									<?php if (hasPermissions("adv", "add_bouquet")) { ?>
                                    <li><a href="./bouquet.php"><span class="mdi mdi-plus mdi-18px"> <?=$_["add_bouquet"]?></a></li>
									<?php }
									if (hasPermissions("adv", "bouquets")) { ?>
                                    <li><a href="./bouquets.php"><span class="mdi mdi-flower-tulip-outline mdi-18px"> <?=$_["manage_bouquets"]?></a></li>
                                    <?php }
                            ...
                            <li>
                                <a href="#"> <i class="mdi mdi-play-circle-outline mdi-18px text-info"></i><span><?=$_["content"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
							...
							<li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="./live_connections.php"><span class="mdi mdi-account-network-outline mdi-18px"> <?=$_["live_connections"]?></a></li>
									<?php }
									if (hasPermissions("adv", "connection_logs")) { ?>
                                    <li><a href="./user_activity.php"><span class="mdi mdi-file-document-outline mdi-18px"> <?=$_["activity_logs"]?></a></li>
                                    <li><a href="./user_ips.php"><span class="mdi mdi-ip mdi-18px"> <?=$_["line_ip_usage"]?></a></li>
									<?php }
                                    ...
                                    <li><a href="./client_logs.php"><span class="mdi mdi-account-search mdi-18px"> <?=$_["client_logs"]?></a></li>
									<?php }
									if (hasPermissions("adv", "reg_userlog")) { ?>
                                    <li><a href="./reg_user_logs.php"><span class="mdi mdi-account-details mdi-18px"> <?=$_["reseller_logs"]?></a></li>
                                    <?php }
									if (hasPermissions("adv", "stream_errors")) { ?>
                                    <li><a href="./stream_logs.php"><span class="mdi mdi-file-document-outline mdi-18px"> <?=$_["stream_logs"]?></a></li>
									<?php }
                            ...
                            <?php }if ((hasPermissions("adv", "add_user")) OR (hasPermissions("adv", "users")) OR (hasPermissions("adv", "mass_edit_users")) OR (hasPermissions("adv", "import_streams")) OR (hasPermissions("adv", "streams")) OR (hasPermissions("adv", "mass_edit_streams")) OR (hasPermissions("adv", "manage_events")) OR (hasPermissions("adv", "import_movies")) OR (hasPermissions("adv", "movies")) OR (hasPermissions("adv", "series")) OR (hasPermissions("adv", "radio")) OR (hasPermissions("adv", "mass_sedits_vod")) OR (hasPermissions("adv", "mass_sedits")) OR (hasPermissions("adv", "mass_edits_radio")) OR (hasPermissions("adv", "stream_tools")) OR (hasPermissions("adv", "fingerprint")) OR (hasPermissions("adv", "mass_delete"))) { ?>
							<li>
                                <a href="#"> <i class="mdi mdi-progress-wrench mdi-18px text-primary"></i><span><?=$_["tools"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
								    <?php if (hasPermissions("adv", "mass_edit_users")) { ?>
                                    <li><a href="./user_mass.php"><span class="mdi mdi-account-edit mdi-18px"> <?=$_["mass_edit_users"]?></a></li>
									<?php }
									if (hasPermissions("adv", "mass_edit_streams")) { ?>
                                    <li><a href="./stream_mass.php"><span class="mdi mdi-border-color mdi-18px"> <?=$_["mass_edit_streams"]?></a></li>
									<?php }
									if (hasPermissions("adv", "mass_sedits_vod")) { ?>
                                    <li><a href="./movie_mass.php"><span class="mdi mdi-border-color mdi-18px"> <?=$_["mass_edit_movies"]?></a></li>
									<?php }
									if (hasPermissions("adv", "mass_sedits")) { ?>
                                    <li><a href="./series_mass.php"><span class="mdi mdi-border-color mdi-18px"> <?=$_["mass_edit_series"]?></a></li>
                                    <li><a href="./episodes_mass.php"><span class="mdi mdi-border-color mdi-18px"> <?=$_["mass_edit_episodes"]?></a></li>
									<?php }
									if (hasPermissions("adv", "mass_edit_radio")) { ?>
                                    <li><a href="./radio_mass.php"><span class="mdi mdi-border-color mdi-18px"> <?=$_["mass_edit_stations"]?></a></li>
									<?php }
								    if (hasPermissions("adv", "mass_delete")) { ?>
                                    <li><a href="./mass_delete.php"><span class="mdi mdi-delete-outline mdi-18px"> <?=$_["mass_delete"]?></a></li>
									<?php }
									if (hasPermissions("adv", "fingerprint")) { ?>
                                    <li><a href="./fingerprint.php"><span class="mdi mdi-fingerprint mdi-18px"> <?=$_["fingerprint"]?></a></li>
									<?php }
									if (hasPermissions("adv", "stream_tools")) { ?>
									<li><a href="./stream_tools.php"><span class="mdi mdi-wrench-outline mdi-rotate-90 mdi-18px"> <?=$_["stream_tools"]?></a></li>
									<?php }
									if (hasPermissions("adv", "import_movies")) { ?>
                                    <li><a href="./movie.php?import"><span class="mdi mdi-file-plus mdi-18px"> <?=$_["import_movies"]?></a></li>
									<?php }
									if (hasPermissions("adv", "import_streams")) { ?>
                                    <li><a href="./stream.php?import"><span class="mdi mdi-file-plus mdi-18px"> <?=$_["import_streams"]?></a></li>
									<?php } ?>
                                </ul>
                            </li>
							<?php }
                            ...
                            <li>
                                <a href="#"> <i class="mdi mdi-email-outline mdi-18px text-warning"></i><span><?=$_["support"]?></span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="./ticket.php"><span class="mdi mdi-message-text-outline mdi-18px"> <?=$_["create_ticket"]?></a></li>
                                    <li><a href="./tickets.php"><span class="mdi mdi-message-settings-variant mdi-18px"> <?=$_["manage_tickets"]?></a></li>
							...
							<li>
                                <a href="#"> <i class="mdi mdi-apps mdi-18px text-success"></i><span>Apps Iptv </span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="./duplexplay.php"><span class="mdi mdi-account-star mdi-18px"> DUPLEX IPTV</a></li> 
									...
									<li><a href="./siptvextreme.php"><span class="mdi mdi-account-star mdi-18px"> IPTV EXTREME</a></li>
                            ...
                            <li>
                                <a href="./tickets.php"> <i class="mdi mdi-email-outline mdi-18px text-pink"></i><span><?=$_["tickets"]?></span></a>
                            </li>
							<li>
                                <a href="#"> <i class="mdi mdi-apps mdi-18px text-success"></i><span>Apps Iptv </span><span class="arrow-right"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li>
                                <a href="./reseller_mannuals.php"> <i class="mdi mdi-book-open-page-variant mdi-18px text-info"></i><span><?=$_["mannuals"]?></span></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
