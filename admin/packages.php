                                                ...
                                                <tr id="package-<?= $rPackage["id"] ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="is_trial" type="checkbox" class="custom-control-input" id="is_trial_<?= $rPackage["id"] ?>" name="is_trial" <?php if ($rPackage["is_trial"]) {
                                                                                                                                                                                                                                    echo " checked";
                                                                                                                                                                                                                                } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="is_official" type="checkbox" class="custom-control-input" id="is_official_<?= $rPackage["id"] ?>" name="is_official" <?php if ($rPackage["is_official"]) {
                                                                                                                                                                                                                                                echo " checked";
                                                                                                                                                                                                                                            } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="can_gen_mag" type="checkbox" class="custom-control-input" id="can_gen_mag_<?= $rPackage["id"] ?>" name="can_gen_mag" <?php if ($rPackage["can_gen_mag"]) {
                                                                                                                                                                                                                                                echo " checked";
                                                                                                                                                                                                                                            } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="only_mag" type="checkbox" class="custom-control-input" id="only_mag_<?= $rPackage["id"] ?>" name="only_mag" <?php if ($rPackage["only_mag"]) {
                                                                                                                                                                                                                                    echo " checked";
                                                                                                                                                                                                                                } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="can_gen_e2" type="checkbox" class="custom-control-input" id="can_gen_e2_<?= $rPackage["id"] ?>" name="can_gen_e2" <?php if ($rPackage["can_gen_e2"]) {
                                                                                                                                                                                                                                            echo " checked";
                                                                                                                                                                                                                                        } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input <?php if (!hasPermissions("adv", "edit_package")) {
                                                                        echo "disabled ";
                                                                    } ?>data-id="<?= $rPackage["id"] ?>" data-name="only_e2" type="checkbox" class="custom-control-input" id="only_e2_<?= $rPackage["id"] ?>" name="only_e2" <?php if ($rPackage["only_e2"]) {
                                                                                                                                                                                                                                    echo " checked";
                                                                                                                                                                                                                                } ?>>
