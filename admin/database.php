...
$ACCESS_PWD= $_INFO["db_pass"]; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>$_INFO["db_user"],#required
'pwd'=>$_INFO["db_pass"], #required
'db'=>$_INFO["db_name"],  #optional, default DB
'host'=>$_INFO["host"],#optional
'port'=>$_INFO["db_port"],#optional
