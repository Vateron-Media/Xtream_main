...
if (isset($_POST["submit_settings"])) {
    foreach ($_POST as $rKey => $rValue) {
        ...
        if ($rSplit[0] == "genre") {
            ...
            $ipTV_db_admin->query("UPDATE `watch_categories` SET `category_id` = " . intval($rValue) . ", `bouquets` = '" . $ipTV_db_admin->escape($rBouquets) . "' WHERE `genre_id` = " . intval($rGenreID) . " AND `type` = 1;");
        }
    }
    foreach ($_POST as $rKey => $rValue) {
        $rSplit = explode("_", $rKey);
        if ($rSplit[0] == "genretv") {
            ...
            $ipTV_db_admin->query("UPDATE `watch_categories` SET `category_id` = " . intval($rValue) . ", `bouquets` = '" . $ipTV_db_admin->escape($rBouquets) . "' WHERE `genre_id` = " . intval($rGenreID) . " AND `type` = 2;");
        }
    }
                                            ...
                                            <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#categories" data-toggle="tab"
                                                        ...
                                                        <span class="d-none d-sm-inline"><?= $_["movie_categories"] ?>
                                                        </span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#categories-tv" data-toggle="tab"
                                                        class="nav-link rounded-0 pt-2 pb-2">
                                                        <i class="mdi mdi-youtube-tv mr-1"></i>
                                                        <span class="d-none d-sm-inline"><?= $_["tv_categories"] ?>
                                                        </span>
                                                    </a>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane" id="setup">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <input name="read_native" id="read_native"
                                                                        type="checkbox" <?php if ($rWatchSettings["read_native"] == 1) {
                                                                            echo "checked ";
                                                                ...
                                                                <label class="col-md-4 col-form-label"
                                                                    for="movie_symlink"><?= $_["create_symlink"] ?> <i
                                                                        ...
                                                                        title=""
                                                                        data-original-title="<?= $_["generate_a_symlink"] ?>"
                                                                        class="mdi mdi-information"></i></label>
                                                                <div class="col-md-2">
                                                                    <input name="movie_symlink" id="movie_symlink"
                                                                        type="checkbox" <?php if ($rWatchSettings["movie_symlink"] == 1) {
                                                                            echo "checked ";
                                                                        } ?>data-plugin="switchery"
                                                                        class="js-switch" data-color="#039cfd" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                <label class="col-md-4 col-form-label"
                                                                    for="auto_encode"><?= $_["auto_encode"] ?> <i
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title=""
                                                                        data-original-title="<?= $_["start_encoding_as_soon"] ?>"
                                                                        class="mdi mdi-information"></i></label>
                                                                <div class="col-md-2">
                                                                    <input name="auto_encode" id="auto_encode"
                                                                        type="checkbox" <?php if ($rWatchSettings["auto_encode"] == 1) {
                                                                            echo "checked ";
                                                                        } ?>data-plugin="switchery"
                                                                        class="js-switch" data-color="#039cfd" />
                                                                </div>
                                                                <label class="col-md-4 col-form-label"
                                                                    for="ffprobe_input"><?= $_["probe_input"] ?> <i
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title=""
                                                                        data-original-title="<?= $_["use_ffmpeg_to_probe_input_files"] ?>"
                                                                        class="mdi mdi-information"></i></label>
                                                                <div class="col-md-2">
                                                                    <input name="ffprobe_input" id="ffprobe_input"
                                                                        type="checkbox" <?php if ($rWatchSettings["ffprobe_input"] == 1) {
                                                                            echo "checked ";
                                                                        } ?>data-plugin="switchery"
                                                                        class="js-switch" data-color="#039cfd" />
                                                                </div>
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                <label class="col-md-4 col-form-label"
                                                                    for="scan_seconds"><?= $_["scan_frequency"] ?> <i
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title=""
                                                                        data-original-title="<?= $_["scan_a_folder"] ?>"
                                                                        class="mdi mdi-information"></i></label>
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control"
                                                                        id="scan_seconds" name="scan_seconds"
                                                                        value="<?php echo htmlspecialchars($rWatchSettings["scan_seconds"]); ?>"
                                                                        required
                                                                        data-parsley-trigger="<?= $_["change"] ?>">
                                                                </div>
                                                                <label class="col-md-4 col-form-label"
                                                                    for="percentage_match"><?= $_["match_percentage"] ?>
                                                                    <i data-toggle="tooltip" data-placement="top"
                                                                        title=""
                                                                        data-original-title="<?= $_["tmdb_match_tolerance"] ?>"
                                                                        class="mdi mdi-information"></i></label>
                                                                <div class="col-md-2">
                                                                    <input type="text" class="form-control"
                                                                        id="percentage_match" name="percentage_match"
                                                                        value="<?php echo htmlspecialchars($rWatchSettings["percentage_match"]); ?>"
                                                                        required
                                                                        data-parsley-trigger="<?= $_["change"] ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            if ($ipTV_db_admin->num_rows() > 0) {
                                                                foreach ($ipTV_db_admin->get_rows() as $rRow) { ?>
                                                                    <div class="form-group row mb-4">
                                                                        ...
                                                                        <label class="col-md-2 col-form-label"
                                                                            for="bouquet_<?= $rRow["genre_id"] ?>"><?= $_["add_to_bouquets"] ?>
                                                                        </label>
                                                                        <div class="col-md-4">
                                                            ...
                                                            if ($ipTV_db_admin->num_rows() > 0) {
                                                                foreach ($ipTV_db_admin->get_rows() as $rRow) { ?>
                                                                    <div class="form-group row mb-4">
                                                                        ...
                                                                        <label class="col-md-2 col-form-label"
                                                                            for="bouquettv_<?= $rRow["genre_id"] ?>"><?= $_["add_to_bouquets"] ?></label>
                                                                        <div class="col-md-4">
