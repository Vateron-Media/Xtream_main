                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input name="movie_symlink" id="movie_symlink" type="checkbox"
                                                            <?php if ($rWatchSettings["movie_symlink"] == 1) {
                                                                echo "checked ";
                                                            } ?>data-plugin="switchery" class="js-switch"
                                                            data-color="#039cfd" />
                                                    </div>
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input name="ffprobe_input" id="ffprobe_input" type="checkbox"
                                                            <?php if ($rWatchSettings["ffprobe_input"] == 1) {
                                                                echo "checked ";
                                                            } ?>data-plugin="switchery" class="js-switch"
                                                            data-color="#039cfd" />
                                                    </div>
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label"
                                                        for="scan_seconds"><?= $_["scan_frequency"] ?> <i
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="scan_seconds"
                                                            name="scan_seconds"
                                                    ...
                                                    <label class="col-md-4 col-form-label"
                                                        ...
                                                        <i data-toggle="tooltip" data-placement="top" title=""
                                                            ...
                                                            class="mdi mdi-information"></i></label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control" id="percentage_match"
