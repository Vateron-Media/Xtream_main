                            ...
                            <div class="tab-content b-0 mb-0 pt-0">
                                    ...
                                    <form action="./mass_delete.php" method="POST" id="stream_form">
                                        ...
                                        <ul class="list-inline wizard mb-0" style="margin-top:20px;">
                                            <li class="list-inline-item float-right">
                                                <input name="submit_streams" type="submit" class="btn btn-primary"
                                    ...
                                    <form action="./mass_delete.php" method="POST" id="movie_form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-6">
                                                <input type="text" class="form-control" id="movie_search" value=""
                                        ...
                                        <ul class="list-inline wizard mb-0" style="margin-top:20px;">
                                            <li class="list-inline-item float-right">
                                                <input name="submit_movies" type="submit" class="btn btn-primary"
                                ...
                                <div class="tab-pane" id="episodes-selection">
                                    <form action="./mass_delete.php" method="POST" id="episodes_form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-6">
                                                <input type="text" class="form-control" id="episode_search" value=""
                                        ...
                                        <ul class="list-inline wizard mb-0" style="margin-top:20px;">
                                            <li class="list-inline-item float-right">
                                                <input name="submit_episodes" type="submit" class="btn btn-primary"
                                ...
                                <div class="tab-pane" id="user-selection">
                                    <form action="./mass_delete.php" method="POST" id="user_form">
                                        ...
                                        <ul class="list-inline wizard mb-0" style="margin-top:20px;">
                                            <li class="list-inline-item float-right">
                                                <input name="submit_users" type="submit" class="btn btn-primary"
