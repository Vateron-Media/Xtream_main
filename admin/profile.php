                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="video_bitrate" name="video_bitrate"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="audio_bitrate" name="audio_bitrate"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="min_tolerance" name="min_tolerance"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="max_tolerance" name="max_tolerance"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="buffer_size" name="buffer_size"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control"
                                                                        id="audio_channels" name="audio_channels"
                                                                        value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control"
                                                                        id="remove_parts" name="remove_parts"
                                                                        value="<?php if (isset($rProfileArr)) {
