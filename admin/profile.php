                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="./profiles.php">
                                            <li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> <?= $_["back_to_profiles"] ?></li>
                                        </a>
                                    </ol>
                                </div>
                                                ...
                                                <div class="tab-pane" id="profile-details">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="profile_name" name="profile_name" value="<?php if (isset($rProfileArr)) {
                                                                    ...
                                                                    <select id="preset" name="preset" class="form-control" data-toggle="select2">
                                                                        <?php foreach (array("" => "Default", "ultrafast" => "Ultra Fast", "superfast" => "Super Fast", "veryfast" => "Very Fast", "faster" => "Faster", "fast" => "Fast", "slow" => "Slow", "slower" => "Slower", "veryslow" => "Very Slow", "placebo" => "Placebo") as $rPreset => $rPresetName) { ?>
                                                                            <option <?php if ((isset($rProfileArr)) && ($rProfileOptions["-preset"] == $rPreset)) {
                                                                                        echo "selected ";
                                                                                    } ?>value="<?= $rPreset ?>"><?= $rPresetName ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="video_bitrate" name="video_bitrate" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="audio_bitrate" name="audio_bitrate" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="min_tolerance" name="min_tolerance" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="max_tolerance" name="max_tolerance" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="buffer_size" name="buffer_size" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="crf_value" name="crf_value" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="scaling" name="scaling" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="aspect_ratio" name="aspect_ratio" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="framerate" name="framerate" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="samplerate" name="samplerate" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="audio_channels" name="audio_channels" value="<?php if (isset($rProfileArr)) {
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" class="form-control" id="threads" name="threads" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="remove_parts" name="remove_parts" value="<?php if (isset($rProfileArr)) {
                                                            ...
                                                            <div class="form-group row mb-4">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" class="form-control" id="logo_path" name="logo_path" value="<?php if (isset($rProfileArr)) {
                                                    ...
                                                    <ul class="list-inline wizard mb-0">
                                                        <li class="next list-inline-item float-right">
                                                            <input name="submit_profile" type="submit" class="btn btn-primary" value="<?php if (isset($rProfileArr)) {
                                                                                                                                            echo $_["edit"];
                                                                                                                                        } else {
                                                                                                                                            echo $_["add"];
                                                                                                                                        } ?>" />
