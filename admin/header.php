            ...
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="notification-list username">
                        <a class="nav-link text-white waves-effect" href="./edit_profile" role="button"
                    ...
                    <?php if (($rServerError) && ($rPermissions["is_admin"]) && (hasPermissions("adv", "servers"))) { ?>
                        <li class="notification-list">
                            <a href="./servers" class="nav-link right-bar-toggle waves-effect text-warning">
                    ...
                    <li class="notification-list">
                        <a href="./logout" class="nav-link right-bar-toggle waves-effect text-white">
                ...
                <!-- LOGO -->
                <div class="logo-box">
                    <a href="<?php if ($rPermissions["is_admin"]) { ?>dashboard<?php } else { ?>reseller<?php } ?>"
                        ...
                        if (hasPermissions('adv', 'streams') || hasPermissions('adv', 'episodes') || hasPermissions('adv', 'series') || hasPermissions('adv', 'categories') || hasPermissions('adv', 'epg') || hasPermissions('adv', 'mng_groups') || hasPermissions('adv', 'mng_packages') || hasPermissions('adv', 'tprofiles') || hasPermissions('adv', 'folder_watch') || hasPermissions('adv', 'add_code') || hasPermissions('adv', 'block_asns') || hasPermissions('adv', 'block_ips') || hasPermissions('adv', 'block_isps') || hasPermissions('adv', 'block_uas') || hasPermissions('adv', 'rtmp') || hasPermissions('adv', 'channel_order') || hasPermissions('adv', 'fingerprint') || hasPermissions('adv', 'mass_delete') || hasPermissions('adv', 'stream_tools') || hasPermissions('adv', 'mass_edit_enigmas') || hasPermissions('adv', 'mass_edit_lines') || hasPermissions('adv', 'mass_edit_mags') || hasPermissions('adv', 'mass_sedits_vod') || hasPermissions('adv', 'mass_sedits') || hasPermissions('adv', 'mass_edit_radio') || hasPermissions('adv', 'mass_edit_streams') || hasPermissions('adv', 'mass_edit_users') || hasPermissions('adv', 'connection_logs') || hasPermissions('adv', 'client_request_log') || hasPermissions('adv', 'login_logs') || hasPermissions('adv', 'panel_logs') || hasPermissions('adv', 'credits_log') || hasPermissions('adv', 'live_connections') || hasPermissions('adv', 'manage_events') || hasPermissions('adv', 'reg_userlog') || hasPermissions('adv', 'stream_errors') || hasPermissions('adv', 'folder_watch') || hasPermissions('adv', 'quick_tools') || hasPermissions('adv', 'manage_tickets')): ?>
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <?php endif; ?>
                                    <?php if (hasPermissions('adv', 'block_asns') || hasPermissions('adv', 'block_ips') || hasPermissions('adv', 'block_isps') || hasPermissions('adv', 'block_uas') || hasPermissions('adv', 'rtmp')): ?>
                                        <li class="has-submenu">
                                    ...
                                    <?php endif; ?>
                                    <?php if (hasPermissions('adv', 'connection_logs') || hasPermissions('adv', 'client_request_log') || hasPermissions('adv', 'credits_log') || hasPermissions('adv', 'panel_logs') || hasPermissions('adv', 'live_connections') || hasPermissions('adv', 'manage_events') || hasPermissions('adv', 'reg_userlog') || hasPermissions('adv', 'stream_errors')): ?>
                                        <li class="has-submenu">
                                    ...
                                    <?php endif; ?>
                                    <?php if ($rPermissions['is_admin'] && hasPermissions('adv', 'manage_tickets')): ?>
                        ...
                        if (($rPermissions["is_admin"]) && (hasPermissions("adv", "manage_tickets"))) { ?>
                            <li class="has-submenu">
                                <a href="#"> <i class="mdi mdi-apps mdi-18px text-success"></i>Apps Iptv <div
                                        class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li><a href="./duplexplay.php"><span class="mdi mdi-account-star mdi-18px"> DUPLEX
                                                IPTV</a></li>
                                    <li><a href="./netiptv.php"><span class="mdi mdi-account-star mdi-18px"> NET
                                                IPTV</a></li>
                                    <li><a href="./siptv.php"><span class="mdi mdi-account-star mdi-18px"> SMART
                                                IPTV</a></li>
                                    <li><a href="./siptvextreme.php"><span class="mdi mdi-account-star mdi-18px"> IPTV
                                                EXTREME</a></li>
                                    <li><a href="./nanomid.php"><span class="mdi mdi-account-star mdi-18px"> NANOMID</a>
                                    </li>
                                    <li><a href="./ss-iptv.php"><span class="mdi mdi-account-star mdi-18px"> SS IPTV</a>
                                    </li>
                                </ul>
                            </li>
                        <?php }
