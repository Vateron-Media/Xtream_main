...
if (isset(CoreUtilities::$request["submit_stream"])) {
    $rArray = array();
    if (isset(CoreUtilities::$request["c_days_to_restart"])) {
        if ((isset(CoreUtilities::$request["days_to_restart"])) && (preg_match("/^(?:2[0-3]|[01][0-9]):[0-5][0-9]$/", CoreUtilities::$request["time_to_restart"]))) {
            $rTimeArray = array("days" => array(), "at" => CoreUtilities::$request["time_to_restart"]);
            foreach (CoreUtilities::$request["days_to_restart"] as $rID => $rDay) {
    ...
    if (isset(CoreUtilities::$request["c_gen_timestamps"])) {
        if (isset(CoreUtilities::$request["gen_timestamps"])) {
            $rArray["gen_timestamps"] = 1;
        } else {
            $rArray["gen_timestamps"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_allow_record"])) {
        if (isset(CoreUtilities::$request["allow_record"])) {
            $rArray["allow_record"] = 1;
        } else {
            $rArray["allow_record"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_rtmp_output"])) {
        if (isset(CoreUtilities::$request["rtmp_output"])) {
            $rArray["rtmp_output"] = 1;
        } else {
            $rArray["rtmp_output"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_stream_all"])) {
        if (isset(CoreUtilities::$request["stream_all"])) {
            $rArray["stream_all"] = 1;
        } else {
            $rArray["stream_all"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_direct_source"])) {
    ...
    if (isset(CoreUtilities::$request["c_read_native"])) {
    ...
    if (isset(CoreUtilities::$request["c_tv_archive_server_id"])) {
        if (isset(CoreUtilities::$request["tv_archive_server_id"])) {
            $rArray["tv_archive_server_id"] = intval(CoreUtilities::$request["tv_archive_server_id"]);
        } else {
            $rArray["tv_archive_server_id"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_tv_archive_duration"])) {
        if (isset(CoreUtilities::$request["tv_archive_duration"])) {
            $rArray["tv_archive_duration"] = intval(CoreUtilities::$request["tv_archive_duration"]);
        } else {
            $rArray["tv_archive_duration"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_delay_minutes"])) {
        if (isset(CoreUtilities::$request["delay_minutes"])) {
            $rArray["delay_minutes"] = intval(CoreUtilities::$request["delay_minutes"]);
        } else {
            $rArray["delay_minutes"] = 0;
        }
    }
    if (isset(CoreUtilities::$request["c_probesize_ondemand"])) {
        if (isset(CoreUtilities::$request["probesize_ondemand"])) {
            $rArray["probesize_ondemand"] = intval(CoreUtilities::$request["probesize_ondemand"]);
        } else {
    ...
    if (isset(CoreUtilities::$request["c_custom_sid"])) {
        $rArray["custom_sid"] = CoreUtilities::$request["custom_sid"];
    }
    if (isset(CoreUtilities::$request["c_custom_ffmpeg"])) {
        $rArray["custom_ffmpeg"] = CoreUtilities::$request["custom_ffmpeg"];
    }
    if (isset(CoreUtilities::$request["c_transcode_profile_id"])) {
    ...
    $rStreamIDs = json_decode(CoreUtilities::$request["streams"], true);
    if (count($rStreamIDs) > 0) {
        foreach ($rStreamIDs as $rStreamID) {
            ...
            if (isset(CoreUtilities::$request["c_server_tree"])) {
                $rOnDemandArray = array();
                if (isset(CoreUtilities::$request["on_demand"])) {
                    foreach (CoreUtilities::$request["on_demand"] as $rID) {
            ...
            if (isset(CoreUtilities::$request["c_user_agent"])) {
                $ipTV_db_admin->query("DELETE FROM `streams_options` WHERE `stream_id` = " . intval($rStreamID) . " AND `argument_id` = 1;");
                if ((isset(CoreUtilities::$request["user_agent"])) && (strlen(CoreUtilities::$request["user_agent"]) > 0)) {
                    $ipTV_db_admin->query("INSERT INTO `streams_options`(`stream_id`, `argument_id`, `value`) VALUES(" . intval($rStreamID) . ", 1, '" . CoreUtilities::$request["user_agent"] . "');");
                }
            }
            if (isset(CoreUtilities::$request["c_http_proxy"])) {
                $ipTV_db_admin->query("DELETE FROM `streams_options` WHERE `stream_id` = " . intval($rStreamID) . " AND `argument_id` = 2;");
                if ((isset(CoreUtilities::$request["http_proxy"])) && (strlen(CoreUtilities::$request["http_proxy"]) > 0)) {
                    $ipTV_db_admin->query("INSERT INTO `streams_options`(`stream_id`, `argument_id`, `value`) VALUES(" . intval($rStreamID) . ", 2, '" . CoreUtilities::$request["http_proxy"] . "');");
                }
            }
            if (isset(CoreUtilities::$request["c_cookie"])) {
                $ipTV_db_admin->query("DELETE FROM `streams_options` WHERE `stream_id` = " . intval($rStreamID) . " AND `argument_id` = 17;");
                if ((isset(CoreUtilities::$request["cookie"])) && (strlen(CoreUtilities::$request["cookie"]) > 0)) {
                    $ipTV_db_admin->query("INSERT INTO `streams_options`(`stream_id`, `argument_id`, `value`) VALUES(" . intval($rStreamID) . ", 17, '" . CoreUtilities::$request["cookie"] . "');");
                }
            }
            if (isset(CoreUtilities::$request["c_headers"])) {
                $ipTV_db_admin->query("DELETE FROM `streams_options` WHERE `stream_id` = " . intval($rStreamID) . " AND `argument_id` = 19;");
                if ((isset(CoreUtilities::$request["headers"])) && (strlen(CoreUtilities::$request["headers"]) > 0)) {
                    $ipTV_db_admin->query("INSERT INTO `streams_options`(`stream_id`, `argument_id`, `value`) VALUES(" . intval($rStreamID) . ", 19, '" . CoreUtilities::$request["headers"] . "');");
                }
            }
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><?= $_["mass_edit_streams"] ?> <small id="selected_count"></small></h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="read_native"
                                                            data-type="switch" name="c_read_native">
                                                        <label></label>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="stream_all"
                                                            data-type="switch" name="c_stream_all">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="allow_record"
                                                            data-type="switch" name="c_allow_record">
                                                        <label></label>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="rtmp_output"
                                                            data-type="switch" name="c_rtmp_output">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                ...
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="custom_sid"
                                                            name="c_custom_sid">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" disabled class="form-control" id="custom_sid"
                                                            name="custom_sid" value="">
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" disabled class="form-control"
                                                            id="delay_minutes" name="delay_minutes" value="0">
                                                    </div>
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate"
                                                            data-name="delay_minutes" name="c_delay_minutes">
                                                        <label></label>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate"
                                                            data-name="custom_ffmpeg" name="c_custom_ffmpeg">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" disabled class="form-control"
                                                            id="custom_ffmpeg" name="custom_ffmpeg" value="">
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate"
                                                            data-name="probesize_ondemand" name="c_probesize_ondemand">
                                                        <label></label>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="user_agent"
                                                            name="c_user_agent">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" disabled class="form-control" id="user_agent"
                                                            name="user_agent"
                                                ...
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="http_proxy"
                                                            name="c_http_proxy">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" disabled class="form-control" id="http_proxy"
                                                            name="http_proxy"
                                                ...
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="cookie"
                                                            name="c_cookie">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" disabled class="form-control" id="cookie"
                                                            name="cookie"
                                                ...
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate" data-name="headers"
                                                            name="c_headers">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" disabled class="form-control" id="headers"
                                                            name="headers"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" class="activate"
                                                            data-name="days_to_restart" name="c_days_to_restart">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <select disabled id="days_to_restart" name="days_to_restart[]"
                                                            class="form-control select2-multiple" data-toggle="select2"
                                                            multiple="multiple" data-placeholder="<?= $_["choose"] ?>">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group clockpicker" data-placement="top"
                                                            ...
                                                            <input disabled id="time_to_restart" name="time_to_restart"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <div
                                                        class="checkbox checkbox-single col-md-1 checkbox-offset checkbox-primary">
                                                        <input type="checkbox" data-name="on_demand" class="activate"
                                                            name="c_server_tree" id="c_server_tree">
                                                        <label></label>
                                                    </div>
                                                    <label class="col-md-3 col-form-label"
