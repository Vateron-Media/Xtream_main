                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <a href="./episodes.php"><li class="breadcrumb-item"><i class="mdi mdi-backspace"></i> <?=$_["back_to_episodes"]?></li></a>
                                </ol>
                            </div>
                                        ...
                                        <div class="tab-content b-0 mb-0 pt-0">
                                            <div class="tab-pane" id="stream-selection">
                                                <div class="row">
                                                    <div class="col-md-3 col-6">
                                                        <input type="text" class="form-control" id="stream_search" value="" placeholder="<?=$_["search_episodes"]?>...">
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
														...
														<div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="serie_name"><?=$_["series_name"]?></label>
                                                            <div class="col-md-8">
                                            ...
                                            <div class="tab-pane" id="load-balancing">
                                                ...
                                                <ul class="list-inline wizard mb-0">
                                                    ...
                                                    <li class="next list-inline-item float-right">
                                                        <input name="submit_stream" type="submit" class="btn btn-primary" value="<?=$_["edit_episodes"]?>" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div> <!-- tab-content -->
