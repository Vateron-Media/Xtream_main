...
$realIP = CD89785224751Cca8017139DaF9E891E::E1F75a50F74A8f4e2129ba474f45D670();
$type = !empty($_REQUEST["type"]) ? $_REQUEST["type"] : null;
$action = !empty($_REQUEST["action"]) ? $_REQUEST["action"] : null;
$magSn = !empty($_REQUEST["sn"]) ? $_REQUEST["sn"] : null;
$stbType = !empty($_REQUEST["stb_type"]) ? $_REQUEST["stb_type"] : null;
$mac = !empty($_REQUEST["mac"]) ? $_REQUEST["mac"] : $_COOKIE["mac"];
$ver = !empty($_REQUEST["ver"]) ? $_REQUEST["ver"] : null;
$userAgent = !empty($_SERVER["HTTP_X_USER_AGENT"]) ? $_SERVER["HTTP_X_USER_AGENT"] : null;
$imageVer = !empty($_REQUEST["image_version"]) ? $_REQUEST["image_version"] : null;
$deviceId = !empty($_REQUEST["device_id"]) ? $_REQUEST["device_id"] : null;
$deviceId2 = !empty($_REQUEST["device_id2"]) ? $_REQUEST["device_id2"] : null;
$hwVersion = !empty($_REQUEST["hw_version"]) ? $_REQUEST["hw_version"] : null;
...
$magDeviceProfile = array();
if (!($magDeviceProfile = getMagDeviceProfile($magSn, $mac, $ver, $stbType, $imageVer, $deviceId, $deviceId2, $hwVersion, $realIP, $A6dde9bd7afc06231a1481ec56fd5768, $type, $action))) {
...
if (!($type == "stb" && $action == "handshake")) {
    ...
    switch ($type) {
        case "stb":
            switch ($action) {
                ...
                case "get_storages":
                    die(json_encode(array("js" => array())));
                case "get_profile":
                    $A6f4ecc798bcb285eee6efb4467c6708 = $status ? array_merge($array2, $magDeviceProfile["get_profile_vars"]) : $array2;
                    $A6f4ecc798bcb285eee6efb4467c6708["status"] = intval(!$status);
        ...
        case "watchdog":
            $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `last_watchdog` = '%d' WHERE `mag_id` = '%d'", time(), $magDeviceProfile["mag_id"]);
            switch ($action) {
                case "get_events":
                    $f566700a43ee8e1f0412fe10fbdf03df->query("SELECT * FROM `mag_events` WHERE `mag_device_id` = '%d' AND `status` = 0 ORDER BY `id` ASC LIMIT 1", $magDeviceProfile["mag_id"]);
                    ...
                    $f566700a43ee8e1f0412fe10fbdf03df->query("SELECT count(*) FROM `mag_events` WHERE `mag_device_id` = '%d' AND `status` = 0 ", $magDeviceProfile["mag_id"]);
    ...
    if ($status) {
        $C3e422ab460a153e3477de0ff483d9e7 = !empty($magDeviceProfile["mag_player"]) ? $magDeviceProfile["mag_player"] . " " : "ffmpeg ";
        switch ($type) {
            case "stb":
                switch ($action) {
                    case "get_preload_images":
                        $C370fbca7449b2b4b2e363169656ee17 = is_numeric($gmode) ? "i_" . $gmode : "i";
                        $c4be797e5512579c392d632772cbd10b = array("template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/loading.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_6_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ico_info.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_pass_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_info.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_menu_act.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_2_cloudy.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_search.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_1a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/loading_bg.gif", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_11_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act01.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_11_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/tv_table.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/vol_1.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_prev_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_8_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_youtube.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_4_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/tv_table_arrows.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_9_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_10_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/1x1.gif", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_karaoke.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_video.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table05.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act02.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/tv_table_separator.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_icons.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_btn.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_5_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_audio.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_7_hail.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act05.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_9_snow.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_4.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_3_pasmurno.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/low_q.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_setting.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_context_borders.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input_episode_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act04.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_hor_bg3.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/black85.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/pause_btn.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ico_error26.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input_episode.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/epg_red_mark.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel_act.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_3_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_pass_input.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_bg2.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/epg_orange_mark.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_mb.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ears_arrow_l.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/hr_filminfo.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_rec.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_account.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_icon_rec.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_hor_left.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table04.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_player.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_search_act2.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input_channel_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_12_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_9_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_android.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_hor_right.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_quality.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table02.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/bg2.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_1_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_line_pos.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input_channel.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_7_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/arr_right.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_radio.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ico_confirm.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_btn.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_time.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_menu.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/volume_off.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/btn2.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_internet.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/volume_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_1_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_2b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_3_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_4_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_255_NA.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_1_sun_cl.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_10_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/25alfa_20.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act06.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/tv_table_focus.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/skip.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/epg_green_mark.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_vert_cell.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_1_moon_cl.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/modal_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_4_short_rain.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ears_arrow_r.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_default.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_line.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table07.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_usb.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_context_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel_r.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_2_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_1b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table03.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table_act03.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table01.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_dm.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_5_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_6_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel_l.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel_line.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_tv.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_table06.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_scroll_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_8_rain_swon.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_scroll.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_2a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_5.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_2_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_10_heavy_snow.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/aspect_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_0_moon.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/volume_bar.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/v_menu_3.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_hor_bg1.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_12_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_ex.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_sidepanel_arr.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mb_icon_scrambled.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ico_alert.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_ico_apps.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/input_act.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/ears.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_8_a.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/mm_hor_bg2.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/arr_left.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/horoscope_menu_button_1_7_b.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/footer_search_act.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_0_sun.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_6_lightning.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/osd_rec.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/tv_prev_bg.png", "template/{$stalkerTheme}/{$C370fbca7449b2b4b2e363169656ee17}/_5_rain.png");
                        die(json_encode(array("js" => $c4be797e5512579c392d632772cbd10b)));
                    case "get_settings_profile":
                        $f566700a43ee8e1f0412fe10fbdf03df->query("SELECT * FROM `mag_devices` WHERE `mag_id` = '%d'", $magDeviceProfile["mag_id"]);
                        ...
                        $Ba14412cc90b8eefb2a5a78fae3ffa84["js"]["pri_audio_lang"] = $array2["pri_audio_lang"];
                        $Ba14412cc90b8eefb2a5a78fae3ffa84["js"]["show_after_loading"] = $Ad51a25e8830a754308d0fcf7239425b["show_after_loading"];
                        $Ba14412cc90b8eefb2a5a78fae3ffa84["js"]["sec_audio_lang"] = $array2["sec_audio_lang"];
                        if (A78BF8D35765bE2408C50712cE7A43aD::$settings["always_enabled_subtitles"] == 1) {
                            $Ba14412cc90b8eefb2a5a78fae3ffa84["js"]["pri_subtitle_lang"] = $array2["pri_subtitle_lang"];
                            $Ba14412cc90b8eefb2a5a78fae3ffa84["js"]["sec_subtitle_lang"] = $array2["sec_subtitle_lang"];
                    ...
                    case "get_locales":
                        $f566700a43ee8e1f0412fe10fbdf03df->query("SELECT `locale` FROM `mag_devices` WHERE `mag_id` = '%d'", $magDeviceProfile["mag_id"]);
                        $Da49f0440d38d30deabb4d3fa41d1ae7 = $f566700a43ee8e1f0412fe10fbdf03df->f1Ed191d78470660EDFF4A007696BC1F();
                        $output = array();
                        foreach ($locales["get_locales"] as $a151dae784c52c6ba073f125d1949afe => $C8028ababe676a3ab15fe53b7a4cc161) {
                    ...
                    case "search_cities":
                        die(json_encode(array("js" => array())));
                    case "get_tv_aspects":
                        if (!empty($magDeviceProfile["aspect"])) {
                            die($magDeviceProfile["aspect"]);
                        }
                        die(json_encode($magDeviceProfile["aspect"]));
                    case "set_volume":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `volume` = '%d' WHERE `mag_id` = '%d'", $b6fbc6940572a4b6179d85a9eede771e, $magDeviceProfile["mag_id"]);
                        if (!($f566700a43ee8e1f0412fe10fbdf03df->E872Be457a7F493d774179C6bDF95B46() > 0)) {
                    ...
                    case "set_aspect":
                        ...
                        $d8e3d66bf231000bd757e5923159fa8f = $magDeviceProfile["aspect"];
                        if (empty($d8e3d66bf231000bd757e5923159fa8f)) {
                            $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `aspect` = '%s' WHERE mag_id = '%d'", json_encode(array("js" => array($A7386eca40c08bf499c3668f497f7653 => $e452199ba3dab31b943dff58d34047da))), $magDeviceProfile["mag_id"]);
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `aspect` = '%s' WHERE mag_id = '%d'", json_encode($d8e3d66bf231000bd757e5923159fa8f), $magDeviceProfile["mag_id"]);
                    ...
                    case "set_screensaver_delay":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `screensaver_delay` = '%d' WHERE `mag_id` = '%d'", $e50b36bfbe1ab40a7b84a3ac6d827159, $magDeviceProfile["mag_id"]);
                    ...
                    case "set_playback_buffer":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `playback_buffer_bytes` = '%d' , `playback_buffer_size` = '%d' WHERE `mag_id` = '%d'", $B4089f477d0edfc15e3d8d962a07aadf, $db581b3169d84efa33b6e6b040e5af09, $magDeviceProfile["mag_id"]);
                        e59cb6f4177f63a1cd5718df7f988db7:
                        die(json_encode(array("js" => true)));
                    case "set_plasma_saving":
                        $e720f242f850f63f3ca7da204d441fab = intval($_REQUEST["plasma_saving"]);
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `plasma_saving` = '%d' WHERE `mag_id` = '%d'", $e720f242f850f63f3ca7da204d441fab, $magDeviceProfile["mag_id"]);
                        die(json_encode(array("js" => true)));
                    case "set_parent_password":
                        if (isset($_REQUEST["parent_password"]) && isset($_REQUEST["pass"]) && isset($_REQUEST["repeat_pass"]) && $_REQUEST["pass"] == $_REQUEST["repeat_pass"]) {
                            $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `parent_password` = '%s' WHERE `mag_id` = '%d'", $_REQUEST["pass"], $magDeviceProfile["mag_id"]);
                            die(json_encode(array("js" => true)));
                        }
                        die(json_encode(array("js" => true)));
                    case "set_locale":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `locale` = '%s' WHERE `mag_id` = '%d'", a78bF8d35765Be2408C50712ce7A43aD::$request["locale"], $magDeviceProfile["mag_id"]);
                    ...
                    case "set_hdmi_reaction":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `hdmi_event_reaction` = '%s' WHERE `mag_id` = '%d'", $E9ca6897602dd4c8870714b6f8ec2e04, $magDeviceProfile["mag_id"]);
                ...
                switch ($action) {
                    case "create_link":
                        ...
                        if (empty($Faefd94a7363d43fe709e5aaa80f5fc7)) {
                            ...
                            $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `users` SET `play_token` = '%s' WHERE `id` = '%d'", $Cd2953f76721ad9589ab3d88c42b62b9 . ":" . (time() + 10) . ":" . $ba85d77d367dcebfcc2a3db9e83bb581, $magDeviceProfile["user_id"]);
                            if (!file_exists("TMP_DIRnew_rewrite") || A78BF8D35765be2408c50712cE7A43aD::$settings["mag_container"] == "m3u8") {
                                $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . a78BF8d35765bE2408C50712Ce7A43ad::$StreamingServers[SERVER_ID]["site_url"] . "live/{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$ba85d77d367dcebfcc2a3db9e83bb581}." . a78bF8D35765be2408c50712Ce7A43AD::$settings["mag_container"] . "?play_token=" . $Cd2953f76721ad9589ab3d88c42b62b9;
                                goto D37353af964e14c6c5bfd7e6387559d2;
                            }
                            $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . a78bf8D35765Be2408c50712Ce7a43AD::$StreamingServers[SERVER_ID]["site_url"] . "{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$ba85d77d367dcebfcc2a3db9e83bb581}?play_token={$Cd2953f76721ad9589ab3d88c42b62b9}";
                    ...
                    case "set_claim":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("INSERT INTO `mag_claims` (`stream_id`,`mag_id`,`real_type`,`date`) VALUES('%d','%d','%s','%s')", $b3c28ce8f38cc88b3954fadda9ca6553, $magDeviceProfile["mag_id"], $efcae6886919c2c7cc23cdd89cd7c056, $e309bb80a71b96ca2c0ff856446be219);
                    ...
                    case "set_fav":
                        ...
                        $magDeviceProfile["fav_channels"]["live"] = $d570fd4b0baf3fb34898da3935354f80;
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `fav_channels` = '%s' WHERE `mag_id` = '%d'", json_encode($magDeviceProfile["fav_channels"]), $magDeviceProfile["mag_id"]);
                        die(json_encode(array("js" => true)));
                    case "get_fav_ids":
                        echo json_encode(array("js" => $magDeviceProfile["fav_channels"]["live"]));
                        die;
                    ...
                    case "get_epg_info":
                        ...
                        $D465fc5085f41251c6fa7c77b8333b0f = c10FD9F04D9c5bAF2F685664A4Da5E9A($magDeviceProfile["user_id"], array("live", "created_live"));
                        $C1037d0090aa4e7d78973574b5b0c906 = array("js" => array());
                        $C1037d0090aa4e7d78973574b5b0c906["js"]["data"] = array();
                        $fc504d0185065e8ba8f4f217b7aba6e8 = A78bf8D35765BE2408c50712ce7A43aD::calculateTimeDifference($timezone);
                    ...
                    case "set_last_id":
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `last_itv_id` = '%d' WHERE `mag_id` = '%d'", $A7386eca40c08bf499c3668f497f7653, $magDeviceProfile["mag_id"]);
                    ...
                    case "get_genres":
                        ...
                        foreach ($F93ee1f4357cf2c3676871a1bc44af65 as $b10d12e0226d30efcf0ab5f1cb845a0a => $F444052f6fa1f23fa68ffcaea6bde218) {
                            if (cD89785224751cCa8017139Daf9E891E::bc358DB57d4903bFDdF6652560FAE708($b10d12e0226d30efcf0ab5f1cb845a0a, $magDeviceProfile["bouquet"])) {
            ...
            case "vod":
                switch ($action) {
                    ...
                    case "set_fav":
                        ...
                        if (in_array($f40e5c22ccecc0f85b94fa5eb4f609ef, $magDeviceProfile["fav_channels"]["movie"])) {
                            goto C7836a3ad60b16c3e29ade2ce95c8e05;
                        }
                        $magDeviceProfile["fav_channels"]["movie"][] = $f40e5c22ccecc0f85b94fa5eb4f609ef;
                    ...
                    case "del_fav":
                        ...
                        $f40e5c22ccecc0f85b94fa5eb4f609ef = intval($_REQUEST["video_id"]);
                        foreach ($magDeviceProfile["fav_channels"]["movie"] as $E7cca48cfca85fc445419a32d7d8f973 => $C5805ed257c09a3079ad7fa87c6d5bb2) {
                            if (!($C5805ed257c09a3079ad7fa87c6d5bb2 == $f40e5c22ccecc0f85b94fa5eb4f609ef)) {
                            }
                            unset($magDeviceProfile["fav_channels"]["movie"][$E7cca48cfca85fc445419a32d7d8f973]);
                    ...
                    case "get_categories":
                        ...
                        foreach ($bf8123e7819ab3cf51f138a1f50b5826 as $B51a7e937f03bda1f1e77ebf1bb5a96e => $f539cddc66ac9616d9c856aecf6efb62) {
                            if (cd89785224751CCA8017139dAf9E891e::BC358Db57d4903BfDdF6652560fAe708($B51a7e937f03bda1f1e77ebf1bb5a96e, $magDeviceProfile["bouquet"])) {
                                $output["js"][] = array("id" => $f539cddc66ac9616d9c856aecf6efb62["id"], "title" => $f539cddc66ac9616d9c856aecf6efb62["category_name"], "alias" => $f539cddc66ac9616d9c856aecf6efb62["category_name"], "censored" => stristr($f539cddc66ac9616d9c856aecf6efb62["category_name"], "adults") ? 1 : 0);
                    ...
                    case "get_genres_by_category_alias":
                        ...
                        die(json_encode($output, JSON_PARTIAL_OUTPUT_ON_ERROR));
                    case "get_years":
                        die(json_encode($array1["get_years"]));
                    case "get_ordered_list":
                    ...
                    case "create_link":
                        ...
                        switch ($bad7a63b7a82143384411c956ca1302b["type"]) {
                            case "movie":
                                ...
                                $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . a78bF8d35765be2408c50712ce7a43AD::$StreamingServers[SERVER_ID]["site_url"] . "{$bad7a63b7a82143384411c956ca1302b["type"]}/{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$bad7a63b7a82143384411c956ca1302b["stream_id"]}." . dC53AE228Df72d4c140fDA7fd5e7E0be($bad7a63b7a82143384411c956ca1302b["target_container"], true) . "?play_token=" . $Cd2953f76721ad9589ab3d88c42b62b9;
                            ...
                            case "series":
                                ...
                                if ($f566700a43ee8e1f0412fe10fbdf03df->getRowCount() > 0) {
                                    ...
                                    $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . A78bF8D35765BE2408c50712Ce7a43ad::$StreamingServers[SERVER_ID]["site_url"] . "{$bad7a63b7a82143384411c956ca1302b["type"]}/{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$bad7a63b7a82143384411c956ca1302b["stream_id"]}." . DC53AE228DF72D4c140fDA7fD5e7E0be($c72d66b481d02f854f0bef67db92a547["target_container"], true) . "?play_token=" . $Cd2953f76721ad9589ab3d88c42b62b9;
                        ...
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `users` SET `play_token` = '%s' WHERE `id` = '%d'", $Cd2953f76721ad9589ab3d88c42b62b9 . ":" . strtotime("+5 hours") . ":" . $bad7a63b7a82143384411c956ca1302b["stream_id"], $magDeviceProfile["user_id"]);
                    ...
                    case "get_abc":
                        die(json_encode($array1["get_abc"]));
                }
            ...
            case "series":
                switch ($action) {
                    ...
                    case "set_fav":
                        ...
                        $f40e5c22ccecc0f85b94fa5eb4f609ef = intval($_REQUEST["video_id"]);
                        if (in_array($f40e5c22ccecc0f85b94fa5eb4f609ef, $magDeviceProfile["fav_channels"]["series"])) {
                            goto bb0c4095f8ba4cc273ec48ebee9a5f9e;
                        }
                        $magDeviceProfile["fav_channels"]["series"][] = $f40e5c22ccecc0f85b94fa5eb4f609ef;
                    ...
                    case "del_fav":
                        ...
                        $f40e5c22ccecc0f85b94fa5eb4f609ef = intval($_REQUEST["video_id"]);
                        foreach ($magDeviceProfile["fav_channels"]["series"] as $E7cca48cfca85fc445419a32d7d8f973 => $C5805ed257c09a3079ad7fa87c6d5bb2) {
                            if (!($C5805ed257c09a3079ad7fa87c6d5bb2 == $f40e5c22ccecc0f85b94fa5eb4f609ef)) {
                            }
                            unset($magDeviceProfile["fav_channels"]["series"][$E7cca48cfca85fc445419a32d7d8f973]);
            ...
            case "radio":
                switch ($action) {
                    ...
                    case "set_fav":
                        ...
                        $magDeviceProfile["fav_channels"]["radio_streams"] = $a828b07e8eaa2884b37ec1b6ac498cbc;
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET `fav_channels` = '%s' WHERE `mag_id` = '%d'", json_encode($magDeviceProfile["fav_channels"]), $magDeviceProfile["mag_id"]);
                        die(json_encode(array("js" => true)));
                    case "get_fav_ids":
                        die(json_encode(array("js" => $magDeviceProfile["fav_channels"]["radio_streams"])));
                }
            ...
            case "tv_archive":
                switch ($action) {
                    ...
                    case "create_link":
                        ...
                        $fd08711a26bab44719872c7fff1f2dfb = intval((strtotime($c72d66b481d02f854f0bef67db92a547["end"]) - strtotime($c72d66b481d02f854f0bef67db92a547["start"])) / 60);
                        $Cd2953f76721ad9589ab3d88c42b62b9 = a78bF8D35765be2408c50712Ce7a43aD::E5182E3AFA58aC7ec5D69d56B28819CD();
                        $f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `users` SET `play_token` = '%s' WHERE `id` = '%d'", $Cd2953f76721ad9589ab3d88c42b62b9 . ":" . strtotime("+5 hours") . ":" . $ba85d77d367dcebfcc2a3db9e83bb581, $magDeviceProfile["user_id"]);
                    ...
                    case "get_link_for_channel":
                        ...
                        $start = date("Ymd-H");
                        $e3539ad64f4d9fc6c2e465986c622369 = $C3e422ab460a153e3477de0ff483d9e7 . A78Bf8d35765bE2408C50712Ce7a43ad::$StreamingServers[SERVER_ID]["site_url"] . "timeshifts/{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/60/{$A7386eca40c08bf499c3668f497f7653}/{$start}.ts position:" . (intval(date("i")) * 60 + intval(date("s"))) . " media_len:" . (intval(date("H")) * 3600 + intval(date("i")) * 60 + intval(date("s")));
            ...
            case "epg":
                switch ($action) {
                    case "get_week":
                        ...
                        if (!($Baee0c34e5755f1cfaa4159ea7e8702e < 10)) {
        ...
        function a4977163c2c5a8CC74F19596F616AEeE($Fe9028a70727ba5f6b7129f9352b020c = null, $B3703321da72313bacab05a2780df82e = null, $ac85ad47d31a0b7f8a0379f91cfc10f4 = null, $a06f7bfbee524373fb837e654c47359d = null, $c15ec50152cce77fa3e1f8d41d4792db = array()) {
            global $magDeviceProfile, $C3e422ab460a153e3477de0ff483d9e7, $A22f04f5efe932bdb34320e92642825a;
            ...
            $B720277fbc7d475b171528f01c76b143 = false;
            $D465fc5085f41251c6fa7c77b8333b0f = c10Fd9F04D9C5BAF2F685664A4Da5E9A($magDeviceProfile["user_id"], array("movie"), $Fe9028a70727ba5f6b7129f9352b020c, $B3703321da72313bacab05a2780df82e, $ac85ad47d31a0b7f8a0379f91cfc10f4, $a06f7bfbee524373fb837e654c47359d, $c15ec50152cce77fa3e1f8d41d4792db);
            ...
            foreach ($D465fc5085f41251c6fa7c77b8333b0f as $b7c504f559ac034e87cb43d0e37e3a75) {
                ...
                if (in_array($b7c504f559ac034e87cb43d0e37e3a75["id"], $magDeviceProfile["fav_channels"]["movie"])) {
        ...
        function e9967FbB02A1eBF83f92f22E140aEBf9($F7a698ce7b4f23bcbf193a6ae14b046e = null, $Fe9028a70727ba5f6b7129f9352b020c = null, $B3703321da72313bacab05a2780df82e = null, $ac85ad47d31a0b7f8a0379f91cfc10f4 = null, $a06f7bfbee524373fb837e654c47359d = null, $c15ec50152cce77fa3e1f8d41d4792db = array()) {
            global $magDeviceProfile, $C3e422ab460a153e3477de0ff483d9e7, $A22f04f5efe932bdb34320e92642825a, $f566700a43ee8e1f0412fe10fbdf03df;
            $Efbabdfbd20db2470efbf8a713287c36 = !empty(a78bF8D35765BE2408c50712ce7a43AD::$request["p"]) ? A78BF8D35765BE2408C50712Ce7A43AD::$request["p"] : 0;
            $c49477c19b27e562d36d18bc56a6ba8b = 14;
            $B720277fbc7d475b171528f01c76b143 = false;
            if (empty($F7a698ce7b4f23bcbf193a6ae14b046e)) {
                $Fc0cf310dd1b2294ab167a0658937ab5 = eA44215481573d77C59D844454c19797($magDeviceProfile["user_id"], $Fe9028a70727ba5f6b7129f9352b020c, $B3703321da72313bacab05a2780df82e, $ac85ad47d31a0b7f8a0379f91cfc10f4, $a06f7bfbee524373fb837e654c47359d, $c15ec50152cce77fa3e1f8d41d4792db);
            ...
            foreach ($Fc0cf310dd1b2294ab167a0658937ab5 as $E7cca48cfca85fc445419a32d7d8f973 => $b7c504f559ac034e87cb43d0e37e3a75) {
                ...
                if (in_array($b7c504f559ac034e87cb43d0e37e3a75["id"], $magDeviceProfile["fav_channels"]["series"])) {
        ...
        function EA44215481573D77c59D844454c19797($E38668abaa324e464e266fb7b7e784b1, $Fe9028a70727ba5f6b7129f9352b020c = null, $B3703321da72313bacab05a2780df82e = null, $ac85ad47d31a0b7f8a0379f91cfc10f4 = null, $a06f7bfbee524373fb837e654c47359d = null, $c15ec50152cce77fa3e1f8d41d4792db = array()) {
            global $magDeviceProfile, $f566700a43ee8e1f0412fe10fbdf03df;
                            ...
                            if (!(!empty($c15ec50152cce77fa3e1f8d41d4792db["abc"]) && $c15ec50152cce77fa3e1f8d41d4792db["abc"] != "*" && strtoupper(substr($a62676726d339eb8ed6d6c13795402f9["title"], 0, 1)) != $c15ec50152cce77fa3e1f8d41d4792db["abc"])) {
                                if (!(!empty($c15ec50152cce77fa3e1f8d41d4792db["genre"]) && $c15ec50152cce77fa3e1f8d41d4792db["genre"] != "*" && $a62676726d339eb8ed6d6c13795402f9["category_id"] != $c15ec50152cce77fa3e1f8d41d4792db["genre"])) {
                                    if (!(!empty($c15ec50152cce77fa3e1f8d41d4792db["years"]) && $c15ec50152cce77fa3e1f8d41d4792db["years"] != "*" && $a62676726d339eb8ed6d6c13795402f9["releaseDate"] != $c15ec50152cce77fa3e1f8d41d4792db["years"])) {
                                        if (!(!empty($B3703321da72313bacab05a2780df82e) && !in_array($acb1d10773fb0d1b6ac8cf2c16ecf1b5, $magDeviceProfile["fav_channels"]["series"]))) {
                            ...
                            if (!(!empty($c15ec50152cce77fa3e1f8d41d4792db["abc"]) && $c15ec50152cce77fa3e1f8d41d4792db["abc"] != "*" && strtoupper(substr($c3a18c26bfa971a25d2e6ada870ff735["stream_display_name"], 0, 1)) != $c15ec50152cce77fa3e1f8d41d4792db["abc"])) {
                                if (!(!empty($c15ec50152cce77fa3e1f8d41d4792db["genre"]) && $c15ec50152cce77fa3e1f8d41d4792db["genre"] != "*" && $c3a18c26bfa971a25d2e6ada870ff735["category_id"] != $c15ec50152cce77fa3e1f8d41d4792db["genre"])) {
                                    ...
                                    foreach ($e3a76043abaf369f5e7250f23baaf1bb as $a28758c1ab974badfc544e11aaf19a57) {
                                        if (!(!empty($magDeviceProfile["fav_channels"][$a28758c1ab974badfc544e11aaf19a57]) && in_array($c3a18c26bfa971a25d2e6ada870ff735["id"], $magDeviceProfile["fav_channels"][$a28758c1ab974badfc544e11aaf19a57]))) {
                                        }
        ...
        function C22100704F3F8811f51506Fb1ab116da($Fe9028a70727ba5f6b7129f9352b020c = null, $B3703321da72313bacab05a2780df82e = null, $ac85ad47d31a0b7f8a0379f91cfc10f4 = null) {
            global $magDeviceProfile, $C3e422ab460a153e3477de0ff483d9e7, $f566700a43ee8e1f0412fe10fbdf03df;
            $Efbabdfbd20db2470efbf8a713287c36 = isset($_REQUEST["p"]) ? intval($_REQUEST["p"]) : 0;
            $c49477c19b27e562d36d18bc56a6ba8b = 14;
            $B720277fbc7d475b171528f01c76b143 = false;
            $D465fc5085f41251c6fa7c77b8333b0f = c10fd9f04D9C5BaF2f685664A4da5E9a($magDeviceProfile["user_id"], array("radio_streams"), $Fe9028a70727ba5f6b7129f9352b020c, $B3703321da72313bacab05a2780df82e, $ac85ad47d31a0b7f8a0379f91cfc10f4);
            $A029b77634bf5f67a52c7d5b31aed706 = count($D465fc5085f41251c6fa7c77b8333b0f["streams"]);
            $D088deb147a371571653966bc924f301 = 0;
            if (!($Efbabdfbd20db2470efbf8a713287c36 == 0)) {
            ...
            foreach ($D465fc5085f41251c6fa7c77b8333b0f as $e2ed3b44381d63b5ea576aae3e88df98 => $c3a18c26bfa971a25d2e6ada870ff735) {
                if (A78BF8d35765be2408c50712Ce7a43aD::$settings["mag_security"] == 0) {
                    ...
                    if (!file_exists("TMP_DIRnew_rewrite") || a78Bf8D35765BE2408c50712cE7a43Ad::$settings["mag_container"] == "m3u8") {
                        $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . A78bF8D35765be2408C50712Ce7A43Ad::$StreamingServers[SERVER_ID]["site_url"] . "live/{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$c3a18c26bfa971a25d2e6ada870ff735["id"]}." . A78bF8d35765BE2408C50712cE7A43Ad::$settings["mag_container"];
                        goto D4f76a56d256ef3c51d2af4579b07d0b;
                    }
                    $F809fc2dad1887c28d3b55d1feaab6f8 = $C3e422ab460a153e3477de0ff483d9e7 . A78BF8d35765be2408C50712cE7A43Ad::$StreamingServers[SERVER_ID]["site_url"] . "{$magDeviceProfile["username"]}/{$magDeviceProfile["password"]}/{$c3a18c26bfa971a25d2e6ada870ff735["id"]}";
        ...
        function eca2a16CFBd94b2b895BcbC43eBd6e3d($Fe9028a70727ba5f6b7129f9352b020c = null, $F720b54e951bfeddce930cfae655a2ca = false, $B3703321da72313bacab05a2780df82e = null, $ac85ad47d31a0b7f8a0379f91cfc10f4 = null) {
            ...
            $D465fc5085f41251c6fa7c77b8333b0f = c10FD9F04D9C5BAF2f685664a4dA5E9a($magDeviceProfile["user_id"], array("live", "created_live"), $Fe9028a70727ba5f6b7129f9352b020c, $B3703321da72313bacab05a2780df82e, $ac85ad47d31a0b7f8a0379f91cfc10f4);
            if (!($B720277fbc7d475b171528f01c76b143 && array_key_exists($magDeviceProfile["last_itv_id"], $D465fc5085f41251c6fa7c77b8333b0f["streams"]))) {
                goto aa0249a10d8dc7d33464a774c36a7ad3;
            }
            $D088deb147a371571653966bc924f301 = array_search($magDeviceProfile["last_itv_id"], array_keys($D465fc5085f41251c6fa7c77b8333b0f["streams"])) + 1;
        ...
        function a495131b1Cf27A42FE0b0130e0ca3811() {
            global $magDeviceProfile, $f566700a43ee8e1f0412fe10fbdf03df, $timezone;
            $Efbabdfbd20db2470efbf8a713287c36 = intval($_REQUEST["p"]);
        ...
        function checkAuthorization($accessToken) {
            if (!empty($accessToken)) {
                if (function_exists("getallheaders")) {
                    $headers = getallheaders();
                    goto checkAuthorization;
                }
                $headers = df07Cb3e40dF776f703dB0f3F3529AC0();

                checkAuthorization:
                if ($headers) {
                    $authorizationHeader = !empty($headers["Authorization"]) ? $headers["Authorization"] : null;
                    if (!($authorizationHeader && preg_match("/Bearer\\s+(.*)\$/i", $authorizationHeader, $matches))) {
                        goto invalidAuthorization;
                    }
                    if (!($accessToken == trim($matches[1]))) {
        ...
        function DF07CB3E40Df776f703dB0f3F3529aC0() {
            ...
            foreach ($_SERVER as $Ef1ee3c519bc282c0258c5a79264005f => $a1daec950dd361ae639ad3a57dc018c0) {
                ...
                $headers[str_replace(" ", "-", ucwords(strtolower(str_replace("_", " ", substr($Ef1ee3c519bc282c0258c5a79264005f, 5)))))] = $a1daec950dd361ae639ad3a57dc018c0;
...
if (empty($magDeviceProfile)) {
    goto Fc207f634bf16b2e355d297d70aa09d1;
}
$f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `mag_devices` SET token = '%s' WHERE `mag_id` = '%d'", $accessToken, $magDeviceProfile["mag_id"]);
if (!(A78Bf8D35765BE2408c50712ce7A43aD::$settings["stb_change_pass"] == 1)) {
    goto C89ff47431a328afae709e49ec288ef8;
}
$f566700a43ee8e1f0412fe10fbdf03df->query("UPDATE `users` SET `password` = '%s' WHERE `id` = '%d'", A78bF8D35765BE2408c50712ce7A43AD::e5182E3AFa58ac7ec5d69D56b28819CD(10), $magDeviceProfile["user_id"]);
C89ff47431a328afae709e49ec288ef8:
Fc207f634bf16b2e355d297d70aa09d1:
die(json_encode(array("js" => array("token" => $accessToken))));
