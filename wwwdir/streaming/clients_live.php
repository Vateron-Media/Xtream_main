...
$ded15b7e9c47ec5a3dea3c69332153c8 = new Reader(GEOIP2_FILENAME);
$activity_id = 0;
...
if ($user_info = ipTV_streaming::GetUserInfo(null, $username, $password, true, false, true, array(), false, $user_ip, $user_agent, array(), $play_token, $stream_id)) {
    ...
    $A75f2436a5614184bfe3442ddd050ec5 = $ded15b7e9c47ec5a3dea3c69332153c8->getWithPrefixLen($user_ip)["registered_country"]["iso_code"];
    ...
    if ($ffb1e0970b62b01f46c2e57f2cded6c2 = ipTV_streaming::ChannelInfo($stream_id, $extension, $user_info, $user_ip, $A75f2436a5614184bfe3442ddd050ec5, $external_device, $user_info["con_isp_name"], 'live')) {
        ...
        if (!ipTV_streaming::ps_running($ffb1e0970b62b01f46c2e57f2cded6c2["pid"], FFMPEG_PATH)) {
            if ($ffb1e0970b62b01f46c2e57f2cded6c2["on_demand"] == 1) {
                if (!ipTV_streaming::CheckPidExist($ffb1e0970b62b01f46c2e57f2cded6c2["monitor_pid"], $stream_id)) {
                ...
                if (empty($C325d28e238c3a646bd7b095aa1ffa85)) {
                    ...
                    while (true) {
                        ...
                        if (file_exists(SIGNALS_PATH . $activity_id)) {
                            ...
                            switch ($d38a1c3d822bdbbd61f649f33212ebde["type"]) {
                                case 'signal':
                                    ...
                                    ipTV_streaming::startFFMPEGSegment($d38a1c3d822bdbbd61f649f33212ebde, $segment_file);
                        ...
                        if (ipTV_streaming::ps_running($ffb1e0970b62b01f46c2e57f2cded6c2["pid"], FFMPEG_PATH) && $c45cc215a073632a9e20d474ea91f7e3 <= $f065eccc0636f7fd92043c7118f7409b && file_exists(STREAMS_PATH . $segment_file) && is_resource($fp)) {
                            ...
                            while ($a88c8d86d7956601164a5f156d5df985 <= ipTV_lib::$SegmentsSettings["seg_time"] && !ipTV_streaming::CheckPidChannelM3U8Exist($ffb1e0970b62b01f46c2e57f2cded6c2["pid"], $stream_id)) {
                                sleep(1);
                            ...
                            if ($a88c8d86d7956601164a5f156d5df985 > ipTV_lib::$SegmentsSettings["seg_time"] || !ipTV_streaming::CheckPidChannelM3U8Exist($ffb1e0970b62b01f46c2e57f2cded6c2["pid"], $stream_id)) {
                                die;
                            }
...
function shutdown() {
    ...
    if ($activity_id != 0 && $close_connection) {
        ...
        ipTV_streaming::SaveClosedConnection(SERVER_ID, $user_info["id"], $stream_id, $date, $user_agent, $user_ip, $extension, $A75f2436a5614184bfe3442ddd050ec5, $user_info["con_isp_name"], $external_device);
